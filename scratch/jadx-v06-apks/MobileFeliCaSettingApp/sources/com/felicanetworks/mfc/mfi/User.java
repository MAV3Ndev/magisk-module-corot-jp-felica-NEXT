...
public class User {
    ...
    public synchronized void getCardAdditionalInfoList(String[] strArr, CardAdditionalInfoListEventCallback cardAdditionalInfoListEventCallback) throws IllegalArgumentException, MfiClientException {
        ...
        for (int i = 0; i < strArr.length; i++) {
            ...
            if (!strArr[i].matches(REGEX_ALPHANUMERIC)) {
    ...
    abstract class LocalIPipeEventCallback<T> extends IPipeEventCallback.Stub {
        ...
        public void onStart(final ParcelFileDescriptor parcelFileDescriptor) throws RemoteException {
            ...
            try {
                executorServiceNewSingleThreadExecutor.submit(new Runnable() { // from class: com.felicanetworks.mfc.mfi.User.LocalIPipeEventCallback.1
    ...
    class LocalICardAdditionalInfoListV2EventCallback extends LocalIPipeEventCallback<CardAdditionalInfo> {
        ...
        /*
            ...
            To view partially-correct add '--show-bad-code' argument
        */
        void onSuccess(java.util.List<com.felicanetworks.mfc.mfi.CardAdditionalInfo> r6) {
            /*
                r5 = this;
                r0 = 3
                ...
                r1 = 2
                r2 = 0
                com.felicanetworks.mfc.mfi.User r5 = com.felicanetworks.mfc.mfi.User.this     // Catch: java.lang.Exception -> L57
                com.felicanetworks.mfc.MfiClientAccess r5 = com.felicanetworks.mfc.mfi.User.access$100(r5)     // Catch: java.lang.Exception -> L57
                com.felicanetworks.mfc.mfi.BaseMfiEventCallback r5 = r5.stopOnline()     // Catch: java.lang.Exception -> L57
                r3 = 6
                if (r5 == 0) goto L4e
                boolean r4 = r5 instanceof com.felicanetworks.mfc.mfi.CardAdditionalInfoListEventCallback     // Catch: java.lang.Exception -> L54
                if (r4 == 0) goto L4e
                java.lang.String r4 = "001"
                com.felicanetworks.mfc.util.LogMgr.log(r3, r4)     // Catch: java.lang.Exception -> L54
                r3 = r5
                com.felicanetworks.mfc.mfi.CardAdditionalInfoListEventCallback r3 = (com.felicanetworks.mfc.mfi.CardAdditionalInfoListEventCallback) r3     // Catch: java.lang.Exception -> L54
                if (r6 == 0) goto L30
                int r2 = r6.size()     // Catch: java.lang.Exception -> L34
                ...
                java.lang.Object[] r6 = r6.toArray(r2)     // Catch: java.lang.Exception -> L34
                r2 = r6
            ...
            L30:
                r3.onSuccess(r2)     // Catch: java.lang.Exception -> L34
                goto L93
            L34:
                r6 = move-exception
                ...
                java.lang.String r6 = r6.getMessage()     // Catch: java.lang.Exception -> L54
                r2.append(r6)     // Catch: java.lang.Exception -> L54
                java.lang.String r6 = r2.toString()     // Catch: java.lang.Exception -> L54
                com.felicanetworks.mfc.util.LogMgr.log(r1, r6)     // Catch: java.lang.Exception -> L54
                goto L93
            L4e:
                java.lang.String r6 = "002"
                com.felicanetworks.mfc.util.LogMgr.log(r3, r6)     // Catch: java.lang.Exception -> L54
                goto L93
            L54:
                r6 = move-exception
                r2 = r5
            ...
            L58:
                ...
                com.felicanetworks.mfc.util.LogMgr.log(r5, r3)
                if (r2 == 0) goto L93
                r5 = 200(0xc8, float:2.8E-43)
                java.lang.String r3 = "Unknown error."
                r2.onError(r5, r3)     // Catch: java.lang.Exception -> L7b
                goto L93
            L7b:
                ...
                com.felicanetworks.mfc.util.LogMgr.log(r1, r5)
            L93:
                java.lang.String r5 = "999"
                com.felicanetworks.mfc.util.LogMgr.log(r0, r5)
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: com.felicanetworks.mfc.mfi.User.LocalICardAdditionalInfoListV2EventCallback.onSuccess(java.util.List):void");
        }
    }
    ...
    class LocalICardInfoListWithSpStatusEventCallback extends LocalIPipeEventCallback<CardInfo> {
        ...
        /*
            ...
            To view partially-correct add '--show-bad-code' argument
        */
        void onSuccess(java.util.List<com.felicanetworks.mfc.mfi.CardInfo> r6) {
            /*
                r5 = this;
                r0 = 3
                java.lang.String r1 = "000"
                ...
                r3 = 6
                if (r5 == 0) goto L4e
                boolean r4 = r5 instanceof com.felicanetworks.mfc.mfi.CardInfoListWithSpStatusEventCallback     // Catch: java.lang.Exception -> L54
                if (r4 == 0) goto L4e
                java.lang.String r4 = "002"
                com.felicanetworks.mfc.util.LogMgr.log(r3, r4)     // Catch: java.lang.Exception -> L54
                r3 = r5
                com.felicanetworks.mfc.mfi.CardInfoListWithSpStatusEventCallback r3 = (com.felicanetworks.mfc.mfi.CardInfoListWithSpStatusEventCallback) r3     // Catch: java.lang.Exception -> L54
                if (r6 == 0) goto L30
                int r2 = r6.size()     // Catch: java.lang.Exception -> L34
            ...
            L93:
                ...
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: com.felicanetworks.mfc.mfi.User.LocalICardInfoListWithSpStatusEventCallback.onSuccess(java.util.List):void");
        }
    }
    ...
    class LocalICardAdditionalInfoListV3EventCallback extends LocalIDataListEventCallback<CardAdditionalInfo> {
        ...
        /*
            ...
            To view partially-correct add '--show-bad-code' argument
        */
        public void onSuccess(java.util.List<com.felicanetworks.mfc.mfi.CardAdditionalInfo> r8) {
            /*
                r7 = this;
                ...
                r4 = 0
                com.felicanetworks.mfc.mfi.User r7 = com.felicanetworks.mfc.mfi.User.this     // Catch: java.lang.Exception -> L5e
                com.felicanetworks.mfc.MfiClientAccess r7 = com.felicanetworks.mfc.mfi.User.access$100(r7)     // Catch: java.lang.Exception -> L5e
                com.felicanetworks.mfc.mfi.BaseMfiEventCallback r7 = r7.stopOnline()     // Catch: java.lang.Exception -> L5e
                boolean r5 = r7 instanceof com.felicanetworks.mfc.mfi.CardAdditionalInfoListEventCallback     // Catch: java.lang.Exception -> L5b
                r6 = 6
                if (r5 == 0) goto L55
                java.lang.String r5 = "002"
                com.felicanetworks.mfc.util.LogMgr.log(r6, r5)     // Catch: java.lang.Exception -> L5b
                r5 = r7
                com.felicanetworks.mfc.mfi.CardAdditionalInfoListEventCallback r5 = (com.felicanetworks.mfc.mfi.CardAdditionalInfoListEventCallback) r5     // Catch: java.lang.Exception -> L5b
                if (r8 == 0) goto L32
                r4 = 0
                ...
                java.lang.Object[] r8 = r8.toArray(r4)     // Catch: java.lang.Exception -> L30
                r4 = r8
            ...
            L32:
                if (r4 == 0) goto L38
                r5.onSuccess(r4)     // Catch: java.lang.Exception -> L30
                goto L96
            L38:
                r7.onError(r3, r0)     // Catch: java.lang.Exception -> L30
                goto L96
            L3c:
                ...
                r4.append(r8)     // Catch: java.lang.Exception -> L5b
                java.lang.String r8 = r4.toString()     // Catch: java.lang.Exception -> L5b
                com.felicanetworks.mfc.util.LogMgr.log(r2, r8)     // Catch: java.lang.Exception -> L5b
                goto L96
            L55:
                java.lang.String r8 = "003"
                com.felicanetworks.mfc.util.LogMgr.log(r6, r8)     // Catch: java.lang.Exception -> L5b
                goto L96
            L5b:
                r8 = move-exception
                r4 = r7
            ...
            L5f:
                ...
                r5.append(r6)
                java.lang.String r5 = r5.toString()
                com.felicanetworks.mfc.util.LogMgr.log(r7, r5)
                if (r4 == 0) goto L96
            ...
            L96:
                ...
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: com.felicanetworks.mfc.mfi.User.LocalICardAdditionalInfoListV3EventCallback.onSuccess(java.util.List):void");
        }
    }
    ...
    class LocalICardInfoListWithSpStatusV3EventCallback extends LocalIDataListEventCallback<CardInfoWithSpStatus> {
        ...
        /*
            ...
            To view partially-correct add '--show-bad-code' argument
        */
        public void onSuccess(java.util.List<com.felicanetworks.mfc.mfi.CardInfoWithSpStatus> r8) {
            /*
                r7 = this;
                java.lang.String r0 = "Unknown error."
                r1 = 3
                ...
                com.felicanetworks.mfc.MfiClientAccess r7 = com.felicanetworks.mfc.mfi.User.access$100(r7)     // Catch: java.lang.Exception -> L5e
                com.felicanetworks.mfc.mfi.BaseMfiEventCallback r7 = r7.stopOnline()     // Catch: java.lang.Exception -> L5e
                boolean r5 = r7 instanceof com.felicanetworks.mfc.mfi.CardInfoListWithSpStatusEventCallback     // Catch: java.lang.Exception -> L5b
                r6 = 6
                if (r5 == 0) goto L55
                java.lang.String r5 = "002"
                com.felicanetworks.mfc.util.LogMgr.log(r6, r5)     // Catch: java.lang.Exception -> L5b
                r5 = r7
                com.felicanetworks.mfc.mfi.CardInfoListWithSpStatusEventCallback r5 = (com.felicanetworks.mfc.mfi.CardInfoListWithSpStatusEventCallback) r5     // Catch: java.lang.Exception -> L5b
                if (r8 == 0) goto L32
                r4 = 0
            ...
            L96:
                ...
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: com.felicanetworks.mfc.mfi.User.LocalICardInfoListWithSpStatusV3EventCallback.onSuccess(java.util.List):void");
        }
    }
}
