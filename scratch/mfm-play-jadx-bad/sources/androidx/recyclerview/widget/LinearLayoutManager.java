...
public class LinearLayoutManager extends RecyclerView.LayoutManager implements ItemTouchHelper.ViewDropHandler, RecyclerView.SmoothScroller.ScrollVectorProvider {
    ...
    public void onInitializeAccessibilityNodeInfo(RecyclerView.Recycler recycler, RecyclerView.State state, AccessibilityNodeInfoCompat accessibilityNodeInfoCompat) {
        ...
        if (this.mRecyclerView.mAdapter == null || this.mRecyclerView.mAdapter.getItemCount() <= 0) {
            return;
        }
    ...
    boolean performAccessibilityAction(int i, Bundle bundle) {
        ...
        if (i == 16908343 && bundle != null) {
            if (this.mOrientation == 1) {
                ...
                iMin = Math.min(i2, getRowCountForAccessibility(this.mRecyclerView.mRecycler, this.mRecyclerView.mState) - 1);
            } else {
                int i3 = bundle.getInt(AccessibilityNodeInfoCompat.ACTION_ARGUMENT_COLUMN_INT, -1);
                if (i3 < 0) {
                    return false;
                }
                iMin = Math.min(i3, getColumnCountForAccessibility(this.mRecyclerView.mRecycler, this.mRecyclerView.mState) - 1);
            }
            if (iMin >= 0) {
