...
public class SelectImplementation<R> extends CancelHandler implements SelectBuilder<R>, SelectInstanceInternal<R> {
    ...
    static final class C02281 extends ContinuationImpl {
        ...
        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        C02281(SelectImplementation<R> selectImplementation, Continuation<? super C02281> continuation) {
            super(continuation);
            this.this$0 = selectImplementation;
        }
    ...
    */
    public final Object processResultAndInvokeBlockRecoveringException(SelectImplementation<R>.ClauseData clauseData, Object obj, Continuation<? super R> continuation) throws Throwable {
        ...
        if (continuation instanceof C02281) {
            ...
            if ((c02281.label & Integer.MIN_VALUE) != 0) {
                ...
                c02281 = new C02281(this, continuation);
            }
        }
        Object obj2 = c02281.result;
        Object coroutine_suspended = IntrinsicsKt.getCOROUTINE_SUSPENDED();
        int i = c02281.label;
        try {
            if (i != 0) {
            ...
            c02281.label = 1;
            Object objInvokeBlock = clauseData.invokeBlock(objProcessResult, c02281);
            return objInvokeBlock == coroutine_suspended ? coroutine_suspended : objInvokeBlock;
        } catch (Throwable th) {
            if (DebugKt.getRECOVER_STACK_TRACES() && (c02281 instanceof CoroutineStackFrame)) {
                throw StackTraceRecoveryKt.recoverFromStackFrame(th, c02281);
            }
            throw th;
        }
    }
    ...
    public final class ClauseData {
        ...
        /* JADX DEBUG: Multi-variable search result rejected for r3v0, resolved type: kotlin.jvm.functions.Function3<java.lang.Object, ? super kotlinx.coroutines.selects.SelectInstance<?>, java.lang.Object, kotlin.Unit> */
        /* JADX DEBUG: Multi-variable search result rejected for r7v0, resolved type: kotlin.jvm.functions.Function3<? super kotlinx.coroutines.selects.SelectInstance<?>, java.lang.Object, java.lang.Object, ? extends kotlin.jvm.functions.Function1<? super java.lang.Throwable, kotlin.Unit>> */
