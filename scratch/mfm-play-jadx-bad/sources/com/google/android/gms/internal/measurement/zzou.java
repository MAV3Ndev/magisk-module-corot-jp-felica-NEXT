...
interface zzou {
    ...
    void zzM(int i, zznd zzndVar, Map map) throws IOException;
    ...
    void zzn(int i, zzlg zzlgVar) throws IOException;
    ...
    void zzr(int i, Object obj, zznw zznwVar) throws IOException;

    @Deprecated
    void zzs(int i, Object obj, zznw zznwVar) throws IOException;
