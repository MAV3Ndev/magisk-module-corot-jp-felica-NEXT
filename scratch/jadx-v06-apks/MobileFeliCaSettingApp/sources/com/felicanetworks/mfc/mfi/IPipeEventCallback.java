...
public interface IPipeEventCallback extends IInterface {
    ...
    void onStart(ParcelFileDescriptor parcelFileDescriptor) throws RemoteException;

    public static abstract class Stub extends Binder implements IPipeEventCallback {
        private static final String DESCRIPTOR = "com.felicanetworks.mfc.mfi.IPipeEventCallback";
        ...
        public static IPipeEventCallback asInterface(IBinder iBinder) {
            if (iBinder == null) {
                return null;
            }
        ...
        public boolean onTransact(int i, Parcel parcel, Parcel parcel2, int i2) throws RemoteException {
            if (i == 1) {
                ...
                onStart(parcel.readInt() != 0 ? (ParcelFileDescriptor) ParcelFileDescriptor.CREATOR.createFromParcel(parcel) : null);
                return true;
            }
            if (i == 2) {
                parcel.enforceInterface(DESCRIPTOR);
        ...
        private static class Proxy implements IPipeEventCallback {
            ...
            public void onStart(ParcelFileDescriptor parcelFileDescriptor) throws RemoteException {
