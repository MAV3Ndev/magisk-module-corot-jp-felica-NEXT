...
public class IdsUpdateCheckProtocol extends Protocol {
    ...
    public static class Parameter {
        ...
        public Parameter(String idm, String lud) {
            this.idm = idm;
            this.lud = lud;
        }
    ...
    public static class Result {
        ...
        private Result(String updateInterval, String updateNecessity) {
            this.updateInterval = updateInterval;
            this.updateNecessity = updateNecessity;
        }
    ...
    protected IdsUpdateCheckProtocol(NetworkExpert net) {
        super(net);
    }
}
