...
public class ServerMaintenanceErrorView extends CustomDialogFragment implements FunctionCodeInterface {
    ...
    public void onDialogButtonClick() {
        AnalysisManager.stamp(MfsStamp.Event.ACTION_WID_1_13_CLOSE, new Object[0]);
        try {
    ...
    protected void onSetupDialog() {
        AnalysisManager.stamp(MfsStamp.Event.SCREEN_WID_1_13, new Object[0]);
        setTitle(getString(R.string.dlg_title_012));
        setNegativeText(getString(R.string.btn_msg_013));
        setNegativeButtonListener(new CustomDialogFragment.OnClickListener() { // from class: com.felicanetworks.mfs.view.ServerMaintenanceErrorView.1
            @Override // com.felicanetworks.mfs.view.CustomDialogFragment.OnClickListener
            public boolean onClick() {
                ServerMaintenanceErrorView.this.onDialogButtonClick();
                return false;
            }
        });
        setText(getString(R.string.dlg_msg_013));
    }
}
