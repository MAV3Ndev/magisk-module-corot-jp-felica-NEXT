...
public final class CombineKt {
    ...
    static final class AnonymousClass2 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
        ...
        /* JADX DEBUG: Duplicate block (B:35:0x00eb) to fix multi-entry loop: BACK_EDGE: B:35:0x00eb -> B:44:0x012e */
        ...
        */
        public final Object invokeSuspend(Object obj) throws Throwable {
            ...
            if (i4 == 0) {
                ...
                this.I$1 = b;
                this.label = 1;
                holder = channel.mo2173receiveCatchingJP2dKIU(this);
            ...
            if (i4 != 1) {
                ...
                if (holder != coroutine_suspended) {
                    ...
                    objArr2 = objArr;
                    bArr2 = bArr3;
                    indexedValue = (IndexedValue) ChannelResult.m2184getOrNullimpl(holder);
                    ...
                    while (true) {
                        ...
                        if (bArr2[index] != i3) {
                            bArr2[index] = (byte) i3;
                            indexedValue = (IndexedValue) ChannelResult.m2184getOrNullimpl(channel.mo2174tryReceivePtdJZtk());
                            if (indexedValue == null) {
                                if (i2 == 0) {
                                }
                            }
        ...
        static final class AnonymousClass1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
            ...
            static final class C00791<T> implements FlowCollector {
                final /* synthetic */ int $i;
                final /* synthetic */ Channel<IndexedValue<Object>> $resultChannel;
