...
public final class TableInfo {
  ...
  (r2v0 java.util.Map)
  (r3v0 java.util.Set)
  (wrap:java.util.Set:?: TERNARY null = ((wrap:int:0x0000: ARITH (r5v0 int) & (8 int) A[WRAPPED]) != (0 int)) ? (null java.util.Set) : (r4v0 java.util.Set))
 A[MD:(java.lang.String, java.util.Map<java.lang.String, androidx.room.util.TableInfo$Column>, java.util.Set<androidx.room.util.TableInfo$ForeignKey>, java.util.Set<androidx.room.util.TableInfo$Index>):void (m)] (LINE:36) call: androidx.room.util.TableInfo.<init>(java.lang.String, java.util.Map, java.util.Set, java.util.Set):void type: THIS */
    ...
    public static final class Companion {
        /* JADX DEBUG: Can't inline method, not implemented redirect type for insn: 0x0000: CONSTRUCTOR  A[MD:():void (m)] call: androidx.room.util.TableInfo.Companion.<init>():void type: THIS */
    ...
    public static final class Column {
        ...
        public static final class Companion {
            /* JADX DEBUG: Can't inline method, not implemented redirect type for insn: 0x0000: CONSTRUCTOR  A[MD:():void (m)] call: androidx.room.util.TableInfo.Column.Companion.<init>():void type: THIS */
            public /* synthetic */ Companion(DefaultConstructorMarker defaultConstructorMarker) {
                this();
            }
