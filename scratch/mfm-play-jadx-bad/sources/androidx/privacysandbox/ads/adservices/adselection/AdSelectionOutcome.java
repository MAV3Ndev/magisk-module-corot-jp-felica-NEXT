...
public final class AdSelectionOutcome {
    ...
    public int hashCode() {
        return (UByte$$ExternalSyntheticBackport0.m(this.adSelectionId) * 31) + this.renderUri.hashCode();
    }
    ...
    public static final class Companion {
        /* JADX DEBUG: Can't inline method, not implemented redirect type for insn: 0x0000: CONSTRUCTOR  A[MD:():void (m)] call: androidx.privacysandbox.ads.adservices.adselection.AdSelectionOutcome.Companion.<init>():void type: THIS */
