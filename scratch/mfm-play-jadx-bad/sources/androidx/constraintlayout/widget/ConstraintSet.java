    ...
    */
                    ...
                    try {
                        ...
                        if (type == Integer.TYPE) {
                            ...
                            if (num.intValue() != -1) {
                                ...
                                sb.append(ServicePreference.ICCODE_DEFAULT);
                                sb.append(name);
                                sb.append(" = \"");
    ...
    public void clone(ConstraintSet constraintSet) {
        ...
        for (Integer num : constraintSet.mConstraints.keySet()) {
            Constraint constraint = constraintSet.mConstraints.get(num);
            if (constraint != null) {
                this.mConstraints.put(num, constraint.m71clone());
            }
        }
    }
    ...
    private String sideToString(int i) {
        switch (i) {
            ...
            case 5:
                return "baseline";
            case 6:
                return LogSender.EXTRA_VALUE_EVENT_NAME_START;
            case 7:
                return "end";
            default:
                return "undefined";
    ...
    */
    ...
    static String getDebugName(int i) {
        for (Field field : ConstraintSet.class.getDeclaredFields()) {
            if (field.getName().contains(CacheUtil.DELIMITER) && field.getType() == Integer.TYPE && Modifier.isStatic(field.getModifiers()) && Modifier.isFinal(field.getModifiers())) {
                try {
    ...
    class WriteXmlEngine {
        ...
        void writeLayout() throws IOException {
            ...
            for (Integer num : ConstraintSet.this.mConstraints.keySet()) {
                ...
                writeEnum("app:barrierDirection", layout.mBarrierDirection, new String[]{"left", "right", "top", "bottom", LogSender.EXTRA_VALUE_EVENT_NAME_START, "end"}, -1);
