...
public class MaskableFrameLayout extends FrameLayout implements Maskable, Shapeable {
    ...
    /* JADX DEBUG: Can't inline method, not implemented redirect type for insn: ?: TERNARY null = ((wrap:boolean:0x0000: INSTANCE_OF (r1v0 com.google.android.material.shape.CornerSize) A[WRAPPED] (LINE:104) com.google.android.material.shape.AbsoluteCornerSize) != false) ? (wrap:com.google.android.material.shape.ClampedCornerSize:0x0006: INVOKE 
  (wrap:com.google.android.material.shape.AbsoluteCornerSize:0x0004: CHECK_CAST (com.google.android.material.shape.AbsoluteCornerSize) (r1v0 com.google.android.material.shape.CornerSize))
 STATIC call: com.google.android.material.shape.ClampedCornerSize.createFromCornerSize(com.google.android.material.shape.AbsoluteCornerSize):com.google.android.material.shape.ClampedCornerSize A[MD:(com.google.android.material.shape.AbsoluteCornerSize):com.google.android.material.shape.ClampedCornerSize (m), WRAPPED] (LINE:108)) : (r1v0 com.google.android.material.shape.CornerSize) */
    ...
    protected void dispatchDraw(Canvas canvas) {
        this.shapeableDelegate.maybeClip(canvas, new CanvasCompat.CanvasOperation() { // from class: com.google.android.material.carousel.MaskableFrameLayout$$ExternalSyntheticLambda1
            ...
            public final void run(Canvas canvas2) {
                this.f$0.m458x418c47c0(canvas2);
            }
        });
    }
    ...
    /* synthetic */ void m458x418c47c0(Canvas canvas) {
