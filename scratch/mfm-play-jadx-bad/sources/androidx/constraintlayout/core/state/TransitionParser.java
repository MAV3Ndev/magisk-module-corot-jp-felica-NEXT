                ...
                if (cLKey.getValue() instanceof CLArray) {
                    ...
                    if (size3 != size || size3 <= 0) {
                        ...
                        if (cLArray.get(i10) instanceof CLNumber) {
                            ...
                            while (i12 < size) {
                                ...
                                if (colorString != -1) {
                                    i = i12;
                                    customVariableArr[i12][i9] = new CustomVariable(strContent, TypedValues.Custom.TYPE_COLOR, (int) colorString);
                                } else {
                                    i = i12;
                                }
                                i12 = i + 1;
                    ...
                    if (value instanceof CLNumber) {
                        ...
                        if (colorString2 != -1) {
                            int i14 = 0;
                            while (i14 < size) {
                                customVariableArr[i14][i9] = new CustomVariable(strContent, TypedValues.Custom.TYPE_COLOR, (int) colorString2);
                                i14++;
                                size2 = size2;
