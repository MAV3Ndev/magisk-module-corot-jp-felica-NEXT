...
/* JADX INFO: compiled from: SourceRegistrationRequest.kt */
...
public final class SourceRegistrationRequest {
  ...
  (r1v0 java.util.List)
  (wrap:android.view.InputEvent:?: TERNARY null = ((wrap:int:0x0000: ARITH (r3v0 int) & (2 int) A[WRAPPED]) != (0 int)) ? (null android.view.InputEvent) : (r2v0 android.view.InputEvent))
 A[MD:(java.util.List<? extends android.net.Uri>, android.view.InputEvent):void (m)] (LINE:32) call: androidx.privacysandbox.ads.adservices.measurement.SourceRegistrationRequest.<init>(java.util.List, android.view.InputEvent):void type: THIS */
