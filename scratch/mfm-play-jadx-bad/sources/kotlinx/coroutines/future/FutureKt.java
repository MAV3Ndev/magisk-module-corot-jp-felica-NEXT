...
public final class FutureKt {
    ...
    public static final <T> CompletableFuture<T> future(CoroutineScope coroutineScope, CoroutineContext coroutineContext, CoroutineStart coroutineStart, Function2<? super CoroutineScope, ? super Continuation<? super T>, ? extends Object> function2) {
        ...
        CompletableFuture<T> completableFutureM1971m = StreamsKt$$ExternalSyntheticApiModelOutline0.m1971m();
        CompletableFutureCoroutine completableFutureCoroutine = new CompletableFutureCoroutine(coroutineContextNewCoroutineContext, completableFutureM1971m);
        completableFutureM1971m.handle(StreamsKt$$ExternalSyntheticApiModelOutline0.m1973m((Object) completableFutureCoroutine));
        completableFutureCoroutine.start(coroutineStart, completableFutureCoroutine, function2);
        return completableFutureM1971m;
    }

    public static final <T> CompletableFuture<T> asCompletableFuture(final Deferred<? extends T> deferred) {
        final CompletableFuture<T> completableFutureM1971m = StreamsKt$$ExternalSyntheticApiModelOutline0.m1971m();
        setupCancellation(deferred, completableFutureM1971m);
        deferred.invokeOnCompletion(new Function1<Throwable, Unit>() { // from class: kotlinx.coroutines.future.FutureKt.asCompletableFuture.1
            ...
            public final void invoke2(Throwable th) {
                try {
                    completableFutureM1971m.complete(deferred.getCompleted());
                } catch (Throwable th2) {
                    completableFutureM1971m.completeExceptionally(th2);
                }
            }
        });
        return completableFutureM1971m;
    ...
    public static final CompletableFuture<Unit> asCompletableFuture(Job job) {
        final CompletableFuture<Unit> completableFutureM1971m = StreamsKt$$ExternalSyntheticApiModelOutline0.m1971m();
        setupCancellation(job, completableFutureM1971m);
        job.invokeOnCompletion(new Function1<Throwable, Unit>() { // from class: kotlinx.coroutines.future.FutureKt.asCompletableFuture.2
            ...
            public final void invoke2(Throwable th) {
                if (th == null) {
                    completableFutureM1971m.complete(Unit.INSTANCE);
                } else {
                    completableFutureM1971m.completeExceptionally(th);
                }
            }
        });
        return completableFutureM1971m;
            ...
            public final Object invoke(T t, Throwable th2) {
                ...
                try {
                    if (th2 == null) {
                        ...
                        CompletionException completionExceptionM1972m = StreamsKt$$ExternalSyntheticApiModelOutline0.m1976m((Object) th2) ? StreamsKt$$ExternalSyntheticApiModelOutline0.m1972m((Object) th2) : null;
                        if (completionExceptionM1972m != null && (cause2 = completionExceptionM1972m.getCause()) != null) {
                            th2 = cause2;
                        }
    ...
    public static final <T> Object await(CompletionStage<T> completionStage, Continuation<? super T> continuation) throws Throwable {
        ...
        completionStage.handle(StreamsKt$$ExternalSyntheticApiModelOutline0.m1973m((Object) continuationHandler));
