...
public class TransitionManager {
    ...
    private static void changeScene(Scene scene, Transition transition) {
        ...
        Transition transitionMo7clone = transition.mo7clone();
        transitionMo7clone.setSceneRoot(sceneRoot);
        if (currentScene != null && currentScene.isCreatedFromLayoutResource()) {
            transitionMo7clone.setCanRemoveViews(true);
        }
        sceneChangeSetup(sceneRoot, transitionMo7clone);
        scene.enter();
        sceneChangeRunTransition(sceneRoot, transitionMo7clone);
    }
    ...
    public static void beginDelayedTransition(ViewGroup viewGroup, Transition transition) {
        ...
        Transition transitionMo7clone = transition.mo7clone();
        sceneChangeSetup(viewGroup, transitionMo7clone);
        Scene.setCurrentScene(viewGroup, null);
        sceneChangeRunTransition(viewGroup, transitionMo7clone);
    }
