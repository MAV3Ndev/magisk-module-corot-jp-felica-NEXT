...
public class EdyBalanceReader extends BalanceReader {
    ...
    EdyBalanceReader(Boolean isHistory) {
    ...
    public MfcExpert.Asset getBalance(String serviceId) throws FelicaReaderException {
        ...
        boolean z;
        int iIntValue;
        MfcExpert.Asset balance = super.getBalance(serviceId);
            ...
            for (int i = 1; i < this.data.length; i++) {
                ...
                if (iIntValue2 == 2 || iIntValue2 == 4) {
                    ...
                    if (99999 < iIntValue && iIntValue >= 0) {
                        ...
                        stringBuffer.append(i2 + "." + String.format(TimeModel.ZERO_LEADING_NUMBER_FORMAT, Integer.valueOf(i3)) + "." + String.format(TimeModel.ZERO_LEADING_NUMBER_FORMAT, Integer.valueOf(i4)));
