...
public class WindowInsetsCompat {
    ...
    private static class BuilderImpl29 extends BuilderImpl {
        ...
        BuilderImpl29() {
            this.mPlatBuilder = HalfKt$$ExternalSyntheticApiModelOutline0.m143m();
        }

        BuilderImpl29(WindowInsetsCompat windowInsetsCompat) {
            WindowInsets.Builder builderM143m;
            super(windowInsetsCompat);
            WindowInsets windowInsets = windowInsetsCompat.toWindowInsets();
            if (windowInsets != null) {
                builderM143m = HalfKt$$ExternalSyntheticApiModelOutline0.m144m(windowInsets);
            } else {
                builderM143m = HalfKt$$ExternalSyntheticApiModelOutline0.m143m();
            }
            this.mPlatBuilder = builderM143m;
        }
