...
public class MotionLayout extends ConstraintLayout implements NestedScrollingParent3 {
    ...
    */
    ...
    class Model {
        ...
        /* JADX DEBUG: Multi-variable search result rejected for r0v10, resolved type: androidx.constraintlayout.core.widgets.ConstraintWidget */
        ...
        private void debugLayoutParam(String str, ConstraintLayout.LayoutParams layoutParams) {
            String strConcat = " ".concat(layoutParams.startToStart != -1 ? "SS" : "__");
            ...
            sb2.append(string);
            sb2.append(layoutParams.endToStart != -1 ? "|ES" : "|__");
            String string2 = sb2.toString();
            StringBuilder sb3 = new StringBuilder();
            sb3.append(string2);
            sb3.append(layoutParams.endToEnd != -1 ? "|EE" : "|__");
            String string3 = sb3.toString();
            StringBuilder sb4 = new StringBuilder();
            sb4.append(string3);
            sb4.append(layoutParams.leftToLeft != -1 ? "|LL" : "|__");
            String string4 = sb4.toString();
            StringBuilder sb5 = new StringBuilder();
            sb5.append(string4);
            sb5.append(layoutParams.leftToRight != -1 ? "|LR" : "|__");
            String string5 = sb5.toString();
            StringBuilder sb6 = new StringBuilder();
            sb6.append(string5);
            sb6.append(layoutParams.rightToLeft != -1 ? "|RL" : "|__");
            String string6 = sb6.toString();
            StringBuilder sb7 = new StringBuilder();
            sb7.append(string6);
            sb7.append(layoutParams.rightToRight != -1 ? "|RR" : "|__");
            String string7 = sb7.toString();
            StringBuilder sb8 = new StringBuilder();
            sb8.append(string7);
            sb8.append(layoutParams.topToTop != -1 ? "|TT" : "|__");
            String string8 = sb8.toString();
            StringBuilder sb9 = new StringBuilder();
            sb9.append(string8);
            sb9.append(layoutParams.topToBottom != -1 ? "|TB" : "|__");
            String string9 = sb9.toString();
            StringBuilder sb10 = new StringBuilder();
            sb10.append(string9);
            sb10.append(layoutParams.bottomToTop != -1 ? "|BT" : "|__");
            String string10 = sb10.toString();
            StringBuilder sb11 = new StringBuilder();
            sb11.append(string10);
            sb11.append(layoutParams.bottomToBottom != -1 ? "|BB" : "|__");
        ...
        private void debugWidget(String str, ConstraintWidget constraintWidget) {
            ...
            Log.v(MotionLayout.TAG, str + sb4.toString() + " ---  " + constraintWidget);
        }
        ...
        private void debugLayout(String str, ConstraintWidgetContainer constraintWidgetContainer) {
            ...
            for (int i = 0; i < size; i++) {
                ...
                String str4 = CacheUtil.DELIMITER;
                String str5 = constraintAnchor != null ? "T" : CacheUtil.DELIMITER;
                StringBuilder sb = new StringBuilder();
                sb.append(str5);
                sb.append(constraintWidget.mBottom.mTarget != null ? "B" : CacheUtil.DELIMITER);
                String string = sb.toString();
                StringBuilder sb2 = new StringBuilder();
                sb2.append(string);
                sb2.append(constraintWidget.mLeft.mTarget != null ? "L" : CacheUtil.DELIMITER);
                String string2 = sb2.toString();
                StringBuilder sb3 = new StringBuilder();
                sb3.append(string2);
                if (constraintWidget.mRight.mTarget != null) {
                ...
                Log.v(MotionLayout.TAG, str3 + "  " + name + " " + constraintWidget + " " + string3);
            }
