...
public class FelicaResultInfo extends ResultInfo {
    ...
    public FelicaResultInfo(int i, String str, int i2, int i3) {
        ...
        this.id = i2;
        this.type = i3;
        LogMgr.log(4, "%s : id = %d, type = %d", "999", Integer.valueOf(this.id), Integer.valueOf(this.type));
    }
    ...
    public FelicaResultInfo(int i, String str, int i2, int i3, int i4, int i5) {
        ...
        this.statusFlag1 = i4;
        this.statusFlag2 = i5;
        LogMgr.log(4, "%s : statusFlag1 = %d, statusFlag2 = %d", "999", Integer.valueOf(this.statusFlag1), Integer.valueOf(this.statusFlag2));
    }
    ...
    public FelicaResultInfo(int i, String str, int i2, int i3, AppInfo appInfo) {
        ...
        LogMgr.log(4, "%s : otherAppPID = %d", "999", this.otherAppInfo);
    }
