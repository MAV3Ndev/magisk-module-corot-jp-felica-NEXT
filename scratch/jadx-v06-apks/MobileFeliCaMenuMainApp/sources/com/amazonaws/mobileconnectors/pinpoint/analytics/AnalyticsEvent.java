...
public class AnalyticsEvent implements JSONSerializable {
    ...
    public static AnalyticsEvent translateToEvent(JSONObject jSONObject) throws JSONException {
        ...
        String string = jSONObject.getString(EventTable.COLUMN_ID);
        String string2 = jSONObject.getString("event_type");
        Long lValueOf3 = Long.valueOf(jSONObject.getLong("timestamp"));
        String string3 = jSONObject.getString("unique_id");
        JSONObject jSONObject2 = jSONObject.getJSONObject("session");
        Long l = null;
        if (jSONObject2 != null) {
            String string4 = jSONObject2.getString("id");
            Long lValueOf4 = Long.valueOf(jSONObject2.getLong("startTimestamp"));
            lValueOf2 = Long.valueOf(jSONObject2.optLong("stopTimestamp"));
            lValueOf = Long.valueOf(jSONObject2.optLong("duration"));
            str = string4;
            l = lValueOf4;
        } else {
            str = "";
        ...
        return newInstance(string, string2, map, map2, sDKInfo, str, l, lValueOf2, lValueOf, lValueOf3.longValue(), string3, androidAppDetails, androidDeviceDetails2);
    }
    ...
    public JSONObject toJSONObject() {
        ...
        try {
            ...
            if (this.session.getSessionDuration() != null) {
                jSONObject.put("duration", this.session.getSessionDuration().longValue());
            }
