...
final class AdjustedTimeMark implements TimeMark {
    ...
    /* JADX DEBUG: Can't inline method, not implemented redirect type for insn: 0x0000: CONSTRUCTOR (r1v0 kotlin.time.TimeMark), (r2v0 long) A[MD:(kotlin.time.TimeMark, long):void (m)] call: kotlin.time.AdjustedTimeMark.<init>(kotlin.time.TimeMark, long):void type: THIS */
    ...
    public TimeMark mo2012minusLRDsOJo(long j) {
        return TimeMark.DefaultImpls.m2128minusLRDsOJo(this, j);
    }

    @Override // kotlin.time.TimeMark
    /* JADX INFO: renamed from: elapsedNow-UwyO8pc */
    public long mo2011elapsedNowUwyO8pc() {
        return Duration.m2049minusLRDsOJo(this.mark.mo2011elapsedNowUwyO8pc(), this.adjustment);
    }

    @Override // kotlin.time.TimeMark
    /* JADX INFO: renamed from: plus-LRDsOJo */
    public TimeMark mo2014plusLRDsOJo(long duration) {
        return new AdjustedTimeMark(this.mark, Duration.m2050plusLRDsOJo(this.adjustment, duration), null);
    }
}
