...
public final class TickerChannelsKt {
    ...
    */
    public static final Object fixedPeriodTicker(long j, long j2, SendChannel<? super Unit> sendChannel, Continuation<? super Unit> continuation) throws Throwable {
        ...
        char c3;
        Unit unit;
        if (continuation instanceof C02051) {
            c02051 = (C02051) continuation;
            if ((c02051.label & Integer.MIN_VALUE) != 0) {
                c02051.label -= Integer.MIN_VALUE;
            } else {
                c02051 = new C02051(continuation);
            }
        }
        ...
        if (i == 0) {
            ...
            c02051.L$0 = sendChannel2;
            j3 = j;
            c02051.J$0 = j3;
            c02051.J$1 = jNanoTime;
            c02051.label = 1;
            if (DelayKt.delay(j2, c02051) != coroutine_suspended) {
                j4 = jNanoTime;
            }
        ...
        if (i != 1) {
            if (i == 2) {
                j6 = c02051.J$1;
                j7 = c02051.J$0;
                sendChannel3 = (SendChannel) c02051.L$0;
                ResultKt.throwOnFailure(obj);
                ...
                c02051.L$0 = sendChannel2;
                c02051.J$0 = j8;
                c02051.J$1 = jDelayToNanos;
                c02051.label = 2;
                if (sendChannel2.send(unit, c02051) != coroutine_suspended) {
                }
                return coroutine_suspended;
            }
            if (i == 3) {
        ...
        j4 = c02051.J$1;
        long j13 = c02051.J$0;
        SendChannel sendChannel4 = (SendChannel) c02051.L$0;
        ResultKt.throwOnFailure(obj);
