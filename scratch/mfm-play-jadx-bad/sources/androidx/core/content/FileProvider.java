...
public class FileProvider extends ContentProvider {
    ...
    public String getType(Uri uri) {
        ...
        if (iLastIndexOf >= 0) {
            ...
            return mimeTypeFromExtension != null ? mimeTypeFromExtension : AbstractHttpCommunicationAgent.FWS_CONTENT_TYPE_STREAM;
        }
        return AbstractHttpCommunicationAgent.FWS_CONTENT_TYPE_STREAM;
    }
    ...
    static class SimplePathStrategy implements PathStrategy {
        ...
        public Uri getUriForFile(File file) {
            ...
            try {
                ...
                return new Uri.Builder().scheme(FirebaseAnalytics.Param.CONTENT).authority(this.mAuthority).encodedPath(Uri.encode(entry.getKey()) + '/' + Uri.encode(strSubstring, DomExceptionUtils.SEPARATOR)).build();
