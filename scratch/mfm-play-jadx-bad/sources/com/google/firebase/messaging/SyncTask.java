...
class SyncTask implements Runnable {
    ...
    /* JADX DEBUG: Another duplicated slice has different insns count: {[INVOKE, INVOKE, INVOKE]}, finally: {[INVOKE, INVOKE, INVOKE, IGET, INVOKE, IF] complete} */
    /* JADX DEBUG: Don't trust debug lines info. Repeating lines: [106=5] */
