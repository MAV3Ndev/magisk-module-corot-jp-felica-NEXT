...
public interface ReceiveChannel<E> {
    ...
    Object mo2173receiveCatchingJP2dKIU(Continuation<? super ChannelResult<? extends E>> continuation);
    ...
    Object mo2174tryReceivePtdJZtk();
    ...
    public static final class DefaultImpls {
        ...
        public static <E> E poll(ReceiveChannel<? extends E> receiveChannel) throws Throwable {
            Object objMo2174tryReceivePtdJZtk = receiveChannel.mo2174tryReceivePtdJZtk();
            if (ChannelResult.m2189isSuccessimpl(objMo2174tryReceivePtdJZtk)) {
                return (E) ChannelResult.m2185getOrThrowimpl(objMo2174tryReceivePtdJZtk);
            }
            Throwable thM2183exceptionOrNullimpl = ChannelResult.m2183exceptionOrNullimpl(objMo2174tryReceivePtdJZtk);
            if (thM2183exceptionOrNullimpl == null) {
                return null;
            }
            throw StackTraceRecoveryKt.recoverStackTrace(thM2183exceptionOrNullimpl);
        }
        ...
        */
        public static <E> Object receiveOrNull(ReceiveChannel<? extends E> receiveChannel, Continuation<? super E> continuation) throws Throwable {
            ...
            if (i == 0) {
                ...
                objMo2173receiveCatchingJP2dKIU = receiveChannel.mo2173receiveCatchingJP2dKIU(anonymousClass1);
            ...
            return ChannelResult.m2184getOrNullimpl(objMo2173receiveCatchingJP2dKIU);
        }
