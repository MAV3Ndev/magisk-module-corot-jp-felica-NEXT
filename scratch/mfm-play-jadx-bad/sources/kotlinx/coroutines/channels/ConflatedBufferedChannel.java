...
public class ConflatedBufferedChannel<E> extends BufferedChannel<E> {
  ...
  (r1v0 int)
  (r2v0 kotlinx.coroutines.channels.BufferOverflow)
 ...
 A[MD:(int, kotlinx.coroutines.channels.BufferOverflow, kotlin.jvm.functions.Function1<? super E, kotlin.Unit>):void (m)] (LINE:22) call: kotlinx.coroutines.channels.ConflatedBufferedChannel.<init>(int, kotlinx.coroutines.channels.BufferOverflow, kotlin.jvm.functions.Function1):void type: THIS */
    ...
    static /* synthetic */ <E> Object send$suspendImpl(ConflatedBufferedChannel<E> conflatedBufferedChannel, E e, Continuation<? super Unit> continuation) throws Throwable {
        ...
        Object objM2197trySendImplMj0NB7M = conflatedBufferedChannel.m2197trySendImplMj0NB7M(e, true);
        if (objM2197trySendImplMj0NB7M instanceof ChannelResult.Closed) {
            ChannelResult.m2183exceptionOrNullimpl(objM2197trySendImplMj0NB7M);
    ...
    static /* synthetic */ <E> Object sendBroadcast$suspendImpl(ConflatedBufferedChannel<E> conflatedBufferedChannel, E e, Continuation<? super Boolean> continuation) {
        Object objM2197trySendImplMj0NB7M = conflatedBufferedChannel.m2197trySendImplMj0NB7M(e, true);
        if (!(objM2197trySendImplMj0NB7M instanceof ChannelResult.Failed)) {
    ...
    public Object mo2169trySendJP2dKIU(E element) {
        return m2197trySendImplMj0NB7M(element, false);
    }

    /* JADX INFO: renamed from: trySendImpl-Mj0NB7M, reason: not valid java name */
    private final Object m2197trySendImplMj0NB7M(E element, boolean isSendOp) {
        return this.onBufferOverflow == BufferOverflow.DROP_LATEST ? m2195trySendDropLatestMj0NB7M(element, isSendOp) : m2196trySendDropOldestJP2dKIU(element);
    }

    /* JADX INFO: renamed from: trySendDropLatest-Mj0NB7M, reason: not valid java name */
    private final Object m2195trySendDropLatestMj0NB7M(E element, boolean isSendOp) {
        Function1<E, Unit> function1;
        UndeliveredElementException undeliveredElementExceptionCallUndeliveredElementCatchingException$default;
        Object objMo2169trySendJP2dKIU = super.mo2169trySendJP2dKIU(element);
        if (ChannelResult.m2189isSuccessimpl(objMo2169trySendJP2dKIU) || ChannelResult.m2187isClosedimpl(objMo2169trySendJP2dKIU)) {
            return objMo2169trySendJP2dKIU;
        }
    ...
    private final Object m2196trySendDropOldestJP2dKIU(E element) {
    ...
    protected void registerSelectForSend(SelectInstance<?> select, Object element) {
        Object objMo2169trySendJP2dKIU = mo2169trySendJP2dKIU(element);
        if (!(objMo2169trySendJP2dKIU instanceof ChannelResult.Failed)) {
            select.selectInRegistrationPhase(Unit.INSTANCE);
        } else {
            if (!(objMo2169trySendJP2dKIU instanceof ChannelResult.Closed)) {
                throw new IllegalStateException("unreachable".toString());
            }
            ChannelResult.m2183exceptionOrNullimpl(objMo2169trySendJP2dKIU);
