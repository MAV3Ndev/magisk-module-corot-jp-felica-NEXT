...
public class MfiLoginReadyingDrawStructure extends CloseDrawStructure {
    ...
    public interface FailureObserver {
        ...
        void onMfiLoginReadyingFailureDetail(MfiLoginReadyingDrawStructure mfiLoginReadyingDrawStructure, Type type, ModelErrorInfo modelErrorInfo);
            ...
            public void run() {
                ...
                if (MfiLoginReadyingDrawStructure.this.observer != null) {
                    if (type != FailureObserver.Type.FAILURE) {
                        ...
                        MfiLoginReadyingDrawStructure.this.observer.onMfiLoginReadyingFailureDetail(MfiLoginReadyingDrawStructure.this, type, modelErrorInfo);
                        return;
                    }
                }
