...
public abstract class RoundedBitmapDrawable extends Drawable {
    ...
    private int mGravity = R.styleable.AppCompatTheme_windowFixedHeightMinor;
    ...
    public void setTargetDensity(int i) {
        if (this.mTargetDensity != i) {
            if (i == 0) {
                i = MfiClientException.TYPE_MFICLIENT_ALREADY_STARTED;
            }
    ...
    RoundedBitmapDrawable(Resources resources, Bitmap bitmap) {
        this.mTargetDensity = MfiClientException.TYPE_MFICLIENT_ALREADY_STARTED;
        if (resources != null) {
