    ...
    public static abstract class Stub extends Binder implements IMfiFelica {
        ...
        public boolean onTransact(int i, Parcel parcel, Parcel parcel2, int i2) throws RemoteException {
            ...
            switch (i) {
                ...
                case 81:
                    parcel.enforceInterface(DESCRIPTOR);
                    FelicaResultInfoBoolean felicaResultInfoBooleanIsLoginedAccount = isLoginedAccount(parcel.readString());
                    parcel2.writeNoException();
                    if (felicaResultInfoBooleanIsLoginedAccount != null) {
                        parcel2.writeInt(1);
                        felicaResultInfoBooleanIsLoginedAccount.writeToParcel(parcel2, 1);
                    } else {
                        parcel2.writeInt(0);
                    }
                    return true;
