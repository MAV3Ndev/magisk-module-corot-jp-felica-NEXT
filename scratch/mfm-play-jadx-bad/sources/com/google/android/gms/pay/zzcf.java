...
public final class zzcf extends AbstractSafeParcelable {
    ...
    public final boolean equals(Object obj) {
        ...
        if (obj instanceof zzcf) {
            ...
            if (Objects.equal(Integer.valueOf(this.zza), Integer.valueOf(zzcfVar.zza)) && Objects.equal(this.zzb, zzcfVar.zzb) && Objects.equal(this.zzc, zzcfVar.zzc)) {
                return true;
            }
        }
        return false;
    ...
    zzcf(int i, zzas zzasVar, zzch zzchVar) {
        this.zza = i;
        this.zzb = zzasVar;
        this.zzc = zzchVar;
    }
