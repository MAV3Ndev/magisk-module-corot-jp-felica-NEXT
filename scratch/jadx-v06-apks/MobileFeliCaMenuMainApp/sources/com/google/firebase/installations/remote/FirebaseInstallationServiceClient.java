...
public class FirebaseInstallationServiceClient {
    ...
    private static byte[] getJsonBytes(JSONObject jSONObject) throws IOException {
        return jSONObject.toString().getBytes(StringUtil.UTF_8);
    }
    ...
    public void deleteFirebaseInstallation(String str, String str2, String str3, String str4) throws FirebaseInstallationsException {
        ...
        while (i <= 1) {
            ...
            try {
                ...
                httpURLConnectionOpenHttpURLConnection.addRequestProperty(HttpHeader.AUTHORIZATION, "FIS_v2 " + str4);
                responseCode = httpURLConnectionOpenHttpURLConnection.getResponseCode();
            } catch (IOException unused) {
            } catch (Throwable th) {
                httpURLConnectionOpenHttpURLConnection.disconnect();
    ...
    private InstallationResponse readCreateResponse(HttpURLConnection httpURLConnection) throws IOException, AssertionError {
        ...
        while (jsonReader.hasNext()) {
            ...
            if (strNextName.equals(MfiContentProvider.Accounts.AccountsColumns.NAME)) {
                ...
                while (jsonReader.hasNext()) {
                    ...
                    if (strNextName2.equals(Protocol.CLIENT_TOKEN_KEY)) {
    ...
    private TokenResult readGenerateAuthTokenResponse(HttpURLConnection httpURLConnection) throws IOException, AssertionError {
        ...
        while (jsonReader.hasNext()) {
            String strNextName = jsonReader.nextName();
            if (strNextName.equals(Protocol.CLIENT_TOKEN_KEY)) {
                builder.setToken(jsonReader.nextString());
