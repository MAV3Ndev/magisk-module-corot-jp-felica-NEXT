...
public class GetContainerIssueInformationCommand extends Command {
    private static final byte CMD_CODE = 34;
    ...
    GetContainerIssueInformationCommand() {
        this.mAid = FlavorConst.MANAGEMENT_SYSTEM_AID;
    }

    void setIdm(byte[] bArr) {
        this.mIdm = bArr;
        this.mLen = (byte) (bArr.length + 2);
    }
