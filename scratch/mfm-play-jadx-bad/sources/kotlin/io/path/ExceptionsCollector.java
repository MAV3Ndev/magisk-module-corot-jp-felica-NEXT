...
final class ExceptionsCollector {
 ...
 A[MD:(int):void (m)] (LINE:319) call: kotlin.io.path.ExceptionsCollector.<init>(int):void type: THIS */
    ...
    public final void collect(Exception exception) {
        ...
        if (this.collectedExceptions.size() < this.limit) {
            if (this.path != null) {
                ...
                exception = PathTreeWalk$$ExternalSyntheticApiModelOutline0.m1841m((Object) thInitCause);
            }
