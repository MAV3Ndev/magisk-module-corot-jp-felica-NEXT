...
public class ReaderModeManager {
    ...
    public void enableForegroundDispatch(Activity activity) {
        ...
        if (defaultAdapter != null) {
            try {
                defaultAdapter.enableForegroundDispatch(activity, PendingIntent.getActivity(this.mContext.getApplicationContext(), 2000, new Intent(activity.getApplicationContext(), activity.getClass()), Build.VERSION.SDK_INT >= 31 ? 301989888 : 268435456), null, null);
            } catch (Exception e) {
    ...
    public void disableForegroundDispatch(Activity activity) {
        ...
        if (defaultAdapter != null) {
            try {
                ...
                EnableForegroundDispatchWaitTimer enableForegroundDispatchWaitTimer = this.mEnableForegroundDispatchWaitTimer;
                if (enableForegroundDispatchWaitTimer != null) {
                    enableForegroundDispatchWaitTimer.cancel();
    ...
    public void enableReaderMode(Activity activity) {
        ...
        try {
            ...
            readerModeAutoDisableTimer.schedule(new ReaderModeAutoDisableTimerTask(), WorkRequest.DEFAULT_BACKOFF_DELAY_MILLIS);
        } catch (Exception e) {
    ...
    public void disableReaderMode(Activity activity) {
        ...
        try {
            ...
            MfmException mfmException = new MfmException(ReaderModeManager.class, 401, e);
            LogUtil.error(mfmException);
            StateController.postStateEvent(StateMachine.Event.EI_FATAL_ERROR, mfmException);
        }
    }
