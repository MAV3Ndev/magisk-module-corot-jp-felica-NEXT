...
public class ExtIcCardFuncAgent {
    ...
    public interface OrderPromotionImageListener {
        void onCompletePromotionImage(Bitmap bitmap);
    }
    ...
    public void orderPromotionImage(String str, final OrderPromotionImageListener orderPromotionImageListener) {
        try {
            this._client.orderPromotionImage(str, new ExtIcCardFunc.OrderPromotionImageListener() { // from class: com.felicanetworks.mfm.main.presenter.agent.ExtIcCardFuncAgent.2
                ...
                public void onSuccess(final Bitmap bitmap) {
                    try {
                        AgentUtil.runMainThread(new Runnable() { // from class: com.felicanetworks.mfm.main.presenter.agent.ExtIcCardFuncAgent.2.1
                            ...
                            public void run() {
                                try {
                                    orderPromotionImageListener.onCompletePromotionImage(bitmap);
                                } catch (Exception e) {
    ...
    public void notifyResolved(final ExtIcCardInfoAgent extIcCardInfoAgent) {
        AgentUtil.runMainThread(new Runnable() { // from class: com.felicanetworks.mfm.main.presenter.agent.ExtIcCardFuncAgent.4
            ...
            public void run() {
                ...
                synchronized (this) {
                    if (ExtIcCardFuncAgent.this._listener != null) {
                        if (extIcCardInfoAgent.hasAsset()) {
                        ...
                        ExtIcCardFuncAgent.this._listener.onResolved(extIcCardInfoAgent, completeState);
                    }
