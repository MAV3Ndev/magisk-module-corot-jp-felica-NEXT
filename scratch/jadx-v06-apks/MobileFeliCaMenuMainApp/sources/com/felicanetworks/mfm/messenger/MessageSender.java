...
class MessageSender {
    ...
    private enum Addressee {
        ...
        static Addressee resolve(Map<String, String> map) {
            String str = map.get(PAYLOAD_KEY_ADDRESS);
            if (TextUtils.equals(str, MENU.addressKey)) {
                return MENU;
            }
            if (TextUtils.equals(str, MFIC.addressKey)) {
                return MFIC;
            }
            return UNKNOWN;
        }
    ...
    static /* synthetic */ class AnonymousClass1 {
        ...
        static {
            ...
            try {
                $SwitchMap$com$felicanetworks$mfm$messenger$MessageSender$Addressee[Addressee.UNKNOWN.ordinal()] = 3;
