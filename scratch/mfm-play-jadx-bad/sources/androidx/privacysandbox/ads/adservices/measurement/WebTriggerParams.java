...
public final class WebTriggerParams {
    ...
    public static final class Companion {
        /* JADX DEBUG: Can't inline method, not implemented redirect type for insn: 0x0000: CONSTRUCTOR  A[MD:():void (m)] call: androidx.privacysandbox.ads.adservices.measurement.WebTriggerParams.Companion.<init>():void type: THIS */
        ...
        public final List<android.adservices.measurement.WebTriggerParams> convertWebTriggerParams$ads_adservices_release(List<WebTriggerParams> request) {
            ...
            for (WebTriggerParams webTriggerParams : request) {
                ...
                android.adservices.measurement.WebTriggerParams webTriggerParamsBuild = Transition$Impl26$$ExternalSyntheticApiModelOutline0.m340m(webTriggerParams.getRegistrationUri()).setDebugKeyAllowed(webTriggerParams.getDebugKeyAllowed()).build();
