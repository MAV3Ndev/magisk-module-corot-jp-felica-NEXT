...
public class CLContainer extends CLElement {
    ...
    /* JADX DEBUG: Method merged with bridge method: clone()Landroidx/constraintlayout/core/parser/CLElement; */
    /* JADX DEBUG: Method merged with bridge method: clone()Ljava/lang/Object; */
    @Override // androidx.constraintlayout.core.parser.CLElement
    /* JADX INFO: renamed from: clone */
    public CLContainer mo66clone() {
        CLContainer cLContainer = (CLContainer) super.mo66clone();
        ArrayList<CLElement> arrayList = new ArrayList<>(this.mElements.size());
        Iterator<CLElement> it = this.mElements.iterator();
        while (it.hasNext()) {
            CLElement cLElementMo66clone = it.next().mo66clone();
            cLElementMo66clone.setContainer(cLContainer);
            arrayList.add(cLElementMo66clone);
        }
