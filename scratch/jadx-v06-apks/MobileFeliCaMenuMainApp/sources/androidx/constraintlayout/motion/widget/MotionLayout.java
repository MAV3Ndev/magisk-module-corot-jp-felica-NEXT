    ...
    */
    ...
    class Model {
        ...
        private void debugLayout(String title, ConstraintWidgetContainer c) {
            ...
            for (int i = 0; i < size; i++) {
                ...
                String str3 = CacheUtil.DELIMITER;
                sb.append(constraintAnchor != null ? "T" : CacheUtil.DELIMITER);
                String string = sb.toString();
                StringBuilder sb2 = new StringBuilder();
                sb2.append(string);
                sb2.append(constraintWidget.mBottom.mTarget != null ? "B" : CacheUtil.DELIMITER);
                String string2 = sb2.toString();
                StringBuilder sb3 = new StringBuilder();
                sb3.append(string2);
                sb3.append(constraintWidget.mLeft.mTarget != null ? "L" : CacheUtil.DELIMITER);
                String string3 = sb3.toString();
                StringBuilder sb4 = new StringBuilder();
                sb4.append(string3);
    ...
    public void onNestedPreScroll(final View target, int dx, int dy, int[] consumed, int type) {
        ...
        if (!transition.isEnabled() || (touchResponse = transition.getTouchResponse()) == null || (touchRegionId = touchResponse.getTouchRegionId()) == -1 || target.getId() == touchRegionId) {
            ...
            motionScene.processScrollMove(f3, f4);
    ...
    /* JADX WARN: Removed duplicated region for block: B:62:0x00ec A[PHI: r2
  0x00ec: PHI (r2v48 float) = (r2v47 float), (r2v49 float), (r2v49 float) binds: [B:47:0x00b4, B:58:0x00e0, B:60:0x00e4] A[DONT_GENERATE, DONT_INLINE]] */
    ...
    */
    ...
    void getAnchorDpDt(int mTouchAnchorId, float pos, float locationX, float locationY, float[] mAnchorDpDt) {
        ...
        if (motionController != null) {
            ...
            int i = ((pos - this.lastPos) > 0.0f ? 1 : ((pos - this.lastPos) == 0.0f ? 0 : -1));
            this.lastPos = pos;
            this.lastY = y;
            return;
        }
