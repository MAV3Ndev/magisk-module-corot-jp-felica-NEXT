    ...
    static class Token {
        ...
        static String encode(String str, String str2, long j) {
            try {
                ...
                jSONObject.put(Protocol.CLIENT_TOKEN_KEY, str);
        ...
        static Token parse(String str) {
            ...
            try {
                ...
                return new Token(jSONObject.getString(Protocol.CLIENT_TOKEN_KEY), jSONObject.getString("appVersion"), jSONObject.getLong("timestamp"));
            } catch (JSONException e) {
                String strValueOf = String.valueOf(e);
