...
public class OAuth2Client {
    ...
    public OAuth2Client(Context context, AWSMobileClient aWSMobileClient) {
        ...
        if (CustomTabsClient.bindCustomTabsService(this.mContext, CUSTOM_TABS_PACKAGE_NAME, customTabsServiceConnection)) {
            return;
        }
    ...
    public void authorize(Uri uri, Callback<AuthorizeResponse> callback) {
        ...
        try {
            ...
            String queryParameter = uriBuild.getQueryParameter("client_id");
