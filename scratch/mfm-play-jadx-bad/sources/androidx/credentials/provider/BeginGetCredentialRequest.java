...
public final class BeginGetCredentialRequest {
    ...
    /* JADX DEBUG: Multi-variable search result rejected for r2v0, resolved type: java.util.List<? extends androidx.credentials.provider.BeginGetCredentialOption> */
    /* JADX WARN: Multi-variable type inference failed */
  ...
  (r1v0 java.util.List)
  (wrap:androidx.credentials.provider.CallingAppInfo:?: TERNARY null = ((wrap:int:0x0000: ARITH (r3v0 int) & (2 int) A[WRAPPED]) != (0 int)) ? (null androidx.credentials.provider.CallingAppInfo) : (r2v0 androidx.credentials.provider.CallingAppInfo))
 A[MD:(java.util.List<? extends androidx.credentials.provider.BeginGetCredentialOption>, androidx.credentials.provider.CallingAppInfo):void (m)] (LINE:44) call: androidx.credentials.provider.BeginGetCredentialRequest.<init>(java.util.List, androidx.credentials.provider.CallingAppInfo):void type: THIS */
    ...
    public static final class Companion {
        /* JADX DEBUG: Can't inline method, not implemented redirect type for insn: 0x0000: CONSTRUCTOR  A[MD:():void (m)] call: androidx.credentials.provider.BeginGetCredentialRequest.Companion.<init>():void type: THIS */
