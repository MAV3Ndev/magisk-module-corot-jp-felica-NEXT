...
public class ExtIcCardReadResultFragment extends BaseFragment implements ExtIcCardFuncAgent.OrderPromotionImageListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        View viewInflate = inflater.inflate(R.layout.fragment_card_read_result, container, false);
        try {
            ...
            if (FeliCaParams.SERVICE_ID_SUICA.equals(id)) {
                ...
                str = "SV000011".equals(id) ? (String) Sg.getValue(Sg.Key.NET_OSAIFULIFE_PLUS_IMAGE_WAON_URL) : null;
            }
            if (str != null) {
            ...
            ((Button) viewInflate.findViewById(R.id.button_guide_card_reader_announce)).setOnClickListener(new View.OnClickListener() { // from class: com.felicanetworks.mfm.main.view.views.ExtIcCardReadResultFragment.4
                @Override // android.view.View.OnClickListener
                public void onClick(View v) {
                    AnalysisManager.stamp(MfmStamp.Event.ACTION_MENU_SETTINGS, new Object[0]);
                    Structure structure2 = ExtIcCardReadResultFragment.this.getStructure();
                    if (structure2 instanceof ExtIcCardDrawStructure) {
                        ((ExtIcCardDrawStructure) structure2).actSetting();
                    }
                }
            });
            adjustViewToNavigationBar(viewInflate.findViewById(R.id.ll_guide_card_reader_announce), false);
            return viewInflate;
        } catch (Exception e) {
            notifyException(e);
            return viewInflate;
    ...
    public void onConfigurationChanged(Configuration newConfig) {
        ...
        View view = getView();
        if (view != null) {
            adjustViewToNavigationBar(view.findViewById(R.id.ll_guide_card_reader_announce), false);
        }
    }

    @Override // com.felicanetworks.mfm.main.presenter.agent.ExtIcCardFuncAgent.OrderPromotionImageListener
    public void onCompletePromotionImage(Bitmap image) {
        ImageView imageView;
        if (image == null || !this.isForeground || (imageView = this.promotionImageView) == null || this.promotionButtonBackground == null || this.promotionButton == null) {
            return;
        }
    ...
    public void setCardInfoAgent(ExtIcCardInfoAgent info) {
        this.mCardInfoAgent = info;
    }
