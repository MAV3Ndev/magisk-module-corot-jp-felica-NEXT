...
class TopicsSyncTask implements Runnable {
    ...
    private static boolean hasAccessNetworkStatePermission(Context context) {
        ...
        synchronized (TOPIC_SYNC_TASK_LOCK) {
            Boolean boolValueOf = Boolean.valueOf(hasAccessNetworkStatePermission == null ? hasPermission(context, "android.permission.ACCESS_NETWORK_STATE", hasAccessNetworkStatePermission) : hasAccessNetworkStatePermission.booleanValue());
    ...
    private static boolean hasWakeLockPermission(Context context) {
        boolean zBooleanValue;
        synchronized (TOPIC_SYNC_TASK_LOCK) {
            Boolean boolValueOf = Boolean.valueOf(hasWakeLockPermission == null ? hasPermission(context, "android.permission.WAKE_LOCK", hasWakeLockPermission) : hasWakeLockPermission.booleanValue());
