...
/* JADX INFO: compiled from: CustomAudienceManagerImplCommon.kt */
...
public class CustomAudienceManagerImplCommon extends CustomAudienceManager {
    ...
    public final android.adservices.customaudience.JoinCustomAudienceRequest convertJoinRequest(JoinCustomAudienceRequest request) {
        android.adservices.customaudience.JoinCustomAudienceRequest joinCustomAudienceRequestBuild = AdFilters$$ExternalSyntheticApiModelOutline0.m295m().setCustomAudience(convertCustomAudience(request.getCustomAudience())).build();
    ...
    public final android.adservices.customaudience.LeaveCustomAudienceRequest convertLeaveRequest(LeaveCustomAudienceRequest request) {
        android.adservices.customaudience.LeaveCustomAudienceRequest leaveCustomAudienceRequestBuild = AdFilters$$ExternalSyntheticApiModelOutline0.m296m().setBuyer(request.getBuyer().convertToAdServices$ads_adservices_release()).setName(request.getName()).build();
    ...
    private final android.adservices.customaudience.CustomAudience convertCustomAudience(CustomAudience request) {
        CustomAudience.Builder trustedBiddingData = AdFilters$$ExternalSyntheticApiModelOutline0.m292m().setActivationTime(request.getActivationTime()).setAds(convertAds(request.getAds())).setBiddingLogicUri(request.getBiddingLogicUri()).setBuyer(request.getBuyer().convertToAdServices$ads_adservices_release()).setDailyUpdateUri(request.getDailyUpdateUri()).setExpirationTime(request.getExpirationTime()).setName(request.getName()).setTrustedBiddingData(convertTrustedSignals(request.getTrustedBiddingSignals()));
    ...
    private final android.adservices.customaudience.TrustedBiddingData convertTrustedSignals(TrustedBiddingData input) {
        ...
        return AdFilters$$ExternalSyntheticApiModelOutline0.m297m().setTrustedBiddingKeys(input.getTrustedBiddingKeys()).setTrustedBiddingUri(input.getTrustedBiddingUri()).build();
    }
    ...
    private static final class Ext10Impl {
        ...
        public static final class Companion {
            /* JADX DEBUG: Can't inline method, not implemented redirect type for insn: 0x0000: CONSTRUCTOR  A[MD:():void (m)] call: androidx.privacysandbox.ads.adservices.customaudience.CustomAudienceManagerImplCommon.Ext10Impl.Companion.<init>():void type: THIS */
