...
public class LinkageDataResponseJson extends GetScriptResponseJson {
    ...
    private static final String PERMANENT_DELETE_CARDS = "PermanentDeleteCards";
    private static final String RESET_CHIP = "ResetChip";
    private static final String[] VALID_ACTION_TYPE_LIST = {INITIALIZE_CHIP, REISSUE_CARDS, "DeleteCards", DELETE_SYSTEM, PERMANENT_DELETE_CARDS, RESET_CHIP};

    public LinkageDataResponseJson(String json) throws JSONException {
        super(json);
    }
