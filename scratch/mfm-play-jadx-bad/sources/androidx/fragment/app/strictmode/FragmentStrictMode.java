...
public final class FragmentStrictMode {
    ...
    /* JADX DEBUG: Multi-variable search result rejected for r5v1, resolved type: androidx.fragment.app.strictmode.FragmentStrictMode */
    ...
    /* JADX DEBUG: Multi-variable search result rejected for r1v0, resolved type: androidx.fragment.app.strictmode.FragmentStrictMode */
    /* JADX WARN: Multi-variable type inference failed */
    @JvmStatic
    ...
    /* JADX DEBUG: Multi-variable search result rejected for r4v1, resolved type: androidx.fragment.app.strictmode.FragmentStrictMode */
    /* JADX WARN: Multi-variable type inference failed */
    @JvmStatic
    ...
    /* JADX DEBUG: Multi-variable search result rejected for r3v0, resolved type: androidx.fragment.app.strictmode.FragmentStrictMode */
    /* JADX WARN: Multi-variable type inference failed */
    ...
    private final void handlePolicyViolation(final Policy policy, final Violation violation) {
        ...
        if (policy.getListener() != null) {
            runOnHostThread(fragment, new Runnable() { // from class: androidx.fragment.app.strictmode.FragmentStrictMode$$ExternalSyntheticLambda0
                ...
                public final void run() {
                    FragmentStrictMode.m274handlePolicyViolation$lambda0(policy, violation);
                }
            });
        }
        if (policy.getFlags$fragment_release().contains(Flag.PENALTY_DEATH)) {
            runOnHostThread(fragment, new Runnable() { // from class: androidx.fragment.app.strictmode.FragmentStrictMode$$ExternalSyntheticLambda1
                ...
                @Override // java.lang.Runnable
                public final void run() {
                    FragmentStrictMode.m275handlePolicyViolation$lambda1(name, violation);
                }
            });
        }
    }
    ...
    public static final void m274handlePolicyViolation$lambda0(Policy policy, Violation violation) {
    ...
    public static final void m275handlePolicyViolation$lambda1(String str, Violation violation) {
        Intrinsics.checkNotNullParameter(violation, "$violation");
    ...
    public static final class Policy {
        ...
        /* JADX DEBUG: Multi-variable search result rejected for r2v0, resolved type: java.util.Set<? extends androidx.fragment.app.strictmode.FragmentStrictMode$Flag> */
        /* JADX WARN: Multi-variable type inference failed */
