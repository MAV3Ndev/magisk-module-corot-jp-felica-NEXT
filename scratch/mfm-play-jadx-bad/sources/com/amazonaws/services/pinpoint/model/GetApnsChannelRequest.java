...
public class GetApnsChannelRequest extends AmazonWebServiceRequest implements Serializable {
    ...
    public GetApnsChannelRequest withApplicationId(String str) {
        this.applicationId = str;
        return this;
    }
    ...
    public boolean equals(Object obj) {
        ...
        if ((getApnsChannelRequest.getApplicationId() == null) ^ (getApplicationId() == null)) {
            return false;
        }
        return getApnsChannelRequest.getApplicationId() == null || getApnsChannelRequest.getApplicationId().equals(getApplicationId());
    }
}
