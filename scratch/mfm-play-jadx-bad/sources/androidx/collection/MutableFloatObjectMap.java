...
public final class MutableFloatObjectMap<V> extends FloatObjectMap<V> {
 ...
 A[MD:(int):void (m)] (LINE:678) call: androidx.collection.MutableFloatObjectMap.<init>(int):void type: THIS */
    ...
    */
    ...
    /* JADX DEBUG: Multi-variable search result rejected for r14v0, resolved type: androidx.collection.MutableFloatObjectMap<V> */
