...
public interface ICardEnableEventCallback extends IInterface {
    ...
    void onSuccess(CardInfo cardInfo, CardInfo cardInfo2) throws RemoteException;
    ...
    public static abstract class Stub extends Binder implements ICardEnableEventCallback {
        ...
        public boolean onTransact(int i, Parcel parcel, Parcel parcel2, int i2) throws RemoteException {
            if (i == 1) {
                ...
                onSuccess(parcel.readInt() != 0 ? CardInfo.CREATOR.createFromParcel(parcel) : null, parcel.readInt() != 0 ? CardInfo.CREATOR.createFromParcel(parcel) : null);
                return true;
            }
            if (i == 2) {
                parcel.enforceInterface(DESCRIPTOR);
        ...
        private static class Proxy implements ICardEnableEventCallback {
            ...
            public void onSuccess(CardInfo cardInfo, CardInfo cardInfo2) throws RemoteException {
                ...
                try {
                    ...
                    if (cardInfo2 != null) {
                        parcelObtain.writeInt(1);
                        cardInfo2.writeToParcel(parcelObtain, 0);
                    } else {
                        parcelObtain.writeInt(0);
                    }
