...
public class RecyclerView extends ViewGroup implements ScrollingView, NestedScrollingChild2, NestedScrollingChild3 {
    ...
    private boolean fling(int i, int i2, int i3, int i4) {
        ...
        if (!dispatchNestedPreFling(f, f2)) {
            ...
            if (onFlingListener != null && onFlingListener.onFling(i, i5)) {
                return true;
            }
            if (z) {
                startNestedScrollForType(1);
                int i9 = -i4;
                this.mViewFlinger.fling(Math.max(i9, Math.min(i, i4)), Math.max(i9, Math.min(i5, i4)));
                return true;
            }
        }
        return false;
    ...
    */
    public View focusSearch(View view, int i) {
        ...
        if (z2 && (i == 2 || i == 1)) {
            if (this.mLayout.canScrollVertically()) {
                if (focusFinder.findNextFocus(this, view, i == 2 ? FeliCaParams.BLOCK_NO_FELICAPOCKET_LITE_DATA_FORMAT_CODE : 33) == null) {
                    z = true;
                }
                if (!z) {
    ...
    public boolean onInterceptTouchEvent(MotionEvent motionEvent) {
        ...
        if (actionMasked == 0) {
            ...
            if (this.mScrollState != 1) {
                ...
                if (!zCanScrollHorizontally || Math.abs(i) <= this.mTouchSlop) {
                    z = false;
                } else {
                    this.mLastTouchX = x2;
                    z = true;
                }
                if (zCanScrollVertically && Math.abs(i2) > this.mTouchSlop) {
                    this.mLastTouchY = y2;
                    z = true;
                }
                if (z) {
  ...
  0x00dc: PHI (r1v46 int) = (r1v26 int), (r1v50 int) binds: [B:41:0x00c5, B:45:0x00d8] A[DONT_GENERATE, DONT_INLINE]] */
    ...
    */
    ...
    /* JADX DEBUG: Move duplicate insns, count: 1 to block B:17:0x0031 */
    ...
    */
    ...
    public final class Recycler {
        ...
        /* JADX WARN: Removed duplicated region for block: B:117:0x0267 A[ADDED_TO_REGION] */
    ...
    public static abstract class Adapter<VH extends ViewHolder> {
        ...
        /* JADX DEBUG: Multi-variable search result rejected for r5v0, resolved type: androidx.recyclerview.widget.RecyclerView$Adapter<VH extends androidx.recyclerview.widget.RecyclerView$ViewHolder> */
        /* JADX WARN: Multi-variable type inference failed */
  ...
  0x0011: PHI (r3v3 int) = (r3v0 int), (r3v2 int), (r3v0 int) binds: [B:7:0x000f, B:11:0x0016, B:4:0x000a] A[DONT_GENERATE, DONT_INLINE]] */
        ...
        */
        ...
        /* JADX WARN: Removed duplicated region for block: B:28:0x008c A[PHI: r11
