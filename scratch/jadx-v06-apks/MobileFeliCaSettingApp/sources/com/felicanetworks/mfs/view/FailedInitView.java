...
public class FailedInitView extends CustomDialogFragment implements FunctionCodeInterface {
    ...
    public void onDialogButtonClick() {
        AnalysisManager.stamp(MfsStamp.Event.ACTION_WID_1_10_CLOSE, new Object[0]);
        try {
    ...
    protected void onSetupDialog() {
        AnalysisManager.stamp(MfsStamp.Event.SCREEN_WID_1_10, new Object[0]);
        setTitle(getString(R.string.dlg_title_009));
        setNegativeText(getString(R.string.btn_msg_010));
        setNegativeButtonListener(new CustomDialogFragment.OnClickListener() { // from class: com.felicanetworks.mfs.view.FailedInitView.1
            @Override // com.felicanetworks.mfs.view.CustomDialogFragment.OnClickListener
            public boolean onClick() {
                FailedInitView.this.onDialogButtonClick();
                return false;
            }
        });
        setText(getString(R.string.dlg_msg_010));
    }
}
