...
public interface IFelicaPushAppNotificationListener extends IInterface {
    void pushAppNotified(PushNotifyAppSegment pushNotifyAppSegment) throws RemoteException;
    ...
    public static abstract class Stub extends Binder implements IFelicaPushAppNotificationListener {
        ...
        public boolean onTransact(int i, Parcel parcel, Parcel parcel2, int i2) throws RemoteException {
            if (i == 1) {
                ...
                pushAppNotified(parcel.readInt() != 0 ? PushNotifyAppSegment.CREATOR.createFromParcel(parcel) : null);
                return true;
            }
            if (i == 1598968902) {
            ...
            public void pushAppNotified(PushNotifyAppSegment pushNotifyAppSegment) throws RemoteException {
                ...
                try {
                    ...
                    if (pushNotifyAppSegment != null) {
                        ...
                        pushNotifyAppSegment.writeToParcel(parcelObtain, 0);
                    } else {
