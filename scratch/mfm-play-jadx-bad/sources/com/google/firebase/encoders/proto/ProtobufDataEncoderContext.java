...
final class ProtobufDataEncoderContext implements ObjectEncoderContext {
    ...
    private static final Charset UTF_8 = Charset.forName(StringUtil.UTF_8);
    private static final FieldDescriptor MAP_KEY_DESC = FieldDescriptor.builder(TransitPassInfoAgent.OPTIONAL_INFO_KEY).withProperty(AtProtobuf.builder().tag(1).build()).build();
    ...
    /* JADX DEBUG: Method merged with bridge method: add(Lcom/google/firebase/encoders/FieldDescriptor;I)Lcom/google/firebase/encoders/ObjectEncoderContext; */
    @Override // com.google.firebase.encoders.ObjectEncoderContext
    ...
    /* JADX DEBUG: Method merged with bridge method: add(Lcom/google/firebase/encoders/FieldDescriptor;J)Lcom/google/firebase/encoders/ObjectEncoderContext; */
    @Override // com.google.firebase.encoders.ObjectEncoderContext
    ...
    /* JADX DEBUG: Method merged with bridge method: add(Lcom/google/firebase/encoders/FieldDescriptor;Z)Lcom/google/firebase/encoders/ObjectEncoderContext; */
    @Override // com.google.firebase.encoders.ObjectEncoderContext
