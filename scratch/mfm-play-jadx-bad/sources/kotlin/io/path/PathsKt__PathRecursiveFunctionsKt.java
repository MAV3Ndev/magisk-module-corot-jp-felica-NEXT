...
class PathsKt__PathRecursiveFunctionsKt extends PathsKt__PathReadWriteKt {
        ...
        if ((i & 2) != 0) {
            function3 = new Function3() { // from class: kotlin.io.path.PathsKt__PathRecursiveFunctionsKt.copyToRecursively.1
                ...
                public /* bridge */ /* synthetic */ Object invoke(Object obj2, Object obj3, Object obj4) {
                    return invoke(PathTreeWalk$$ExternalSyntheticApiModelOutline0.m1849m(obj2), PathTreeWalk$$ExternalSyntheticApiModelOutline0.m1849m(obj3), (Exception) obj4);
                }
    ...
    public static final Path copyToRecursively(final Path path, final Path target, final Function3<? super Path, ? super Path, ? super Exception, ? extends OnErrorResult> onError, boolean z, final Function3<? super CopyActionContext, ? super Path, ? super Path, ? extends CopyActionResult> copyAction) throws FileSystemException {
        ...
        if (!Files.exists(path, (LinkOption[]) Arrays.copyOf(linkOptionArr, linkOptionArr.length))) {
            PathTreeWalk$$ExternalSyntheticApiModelOutline0.m1875m$2();
            throw PathTreeWalk$$ExternalSyntheticApiModelOutline0.m1848m(path.toString(), target.toString(), "The source file doesn't exist.");
        }
        ...
        if (Files.exists(path, (LinkOption[]) Arrays.copyOf(new LinkOption[0], 0)) && (z || !Files.isSymbolicLink(path))) {
            ...
            if (!z2 || !Files.isSameFile(path, target)) {
                ...
                if (zStartsWith) {
                    PathTreeWalk$$ExternalSyntheticApiModelOutline0.m1863m();
    ...
    public static final FileVisitResult copyToRecursively$copy$PathsKt__PathRecursiveFunctionsKt(ArrayList<Path> arrayList, Function3<? super CopyActionContext, ? super Path, ? super Path, ? extends CopyActionResult> function3, Path path, Path path2, Path path3, Function3<? super Path, ? super Path, ? super Exception, ? extends OnErrorResult> function32, Path path4, BasicFileAttributes basicFileAttributes) {
        try {
            if (!arrayList.isEmpty()) {
                ...
                checkNotSameAs$PathsKt__PathRecursiveFunctionsKt(path4, PathTreeWalk$$ExternalSyntheticApiModelOutline0.m1849m(objLast));
            }
        ...
        if (parent != null) {
            ...
            if (directoryStreamNewDirectoryStream != null) {
                ...
                try {
                    ...
                    if (PathTreeWalk$$ExternalSyntheticApiModelOutline0.m$1(directoryStreamM)) {
                        exceptionsCollector.setPath(parent);
                        SecureDirectoryStream secureDirectoryStreamM1852m = PathTreeWalk$$ExternalSyntheticApiModelOutline0.m1852m((Object) directoryStreamM);
                        Path fileName = path.getFileName();
                        Intrinsics.checkNotNullExpressionValue(fileName, "getFileName(...)");
                        handleEntry$PathsKt__PathRecursiveFunctionsKt(secureDirectoryStreamM1852m, fileName, null, exceptionsCollector);
                    } else {
                        z = true;
                    }
    ...
    */
    ...
    private static final void enterDirectory$PathsKt__PathRecursiveFunctionsKt(SecureDirectoryStream<Path> secureDirectoryStream, Path path, ExceptionsCollector exceptionsCollector) {
        ...
        try {
            SecureDirectoryStream secureDirectoryStreamM1852m = PathTreeWalk$$ExternalSyntheticApiModelOutline0.m1852m((Object) secureDirectoryStream2);
            Iterator it = secureDirectoryStreamM1852m.iterator();
            Intrinsics.checkNotNullExpressionValue(it, "iterator(...)");
            while (it.hasNext()) {
                Path fileName = PathTreeWalk$$ExternalSyntheticApiModelOutline0.m1849m(it.next()).getFileName();
                Intrinsics.checkNotNullExpressionValue(fileName, "getFileName(...)");
                handleEntry$PathsKt__PathRecursiveFunctionsKt(secureDirectoryStreamM1852m, fileName, exceptionsCollector.getPath(), exceptionsCollector);
            }
            Unit unit = Unit.INSTANCE;
    ...
    private static final boolean isDirectory$PathsKt__PathRecursiveFunctionsKt(SecureDirectoryStream<Path> secureDirectoryStream, Path path, LinkOption... linkOptionArr) {
        Boolean boolValueOf;
        try {
            boolValueOf = Boolean.valueOf(PathTreeWalk$$ExternalSyntheticApiModelOutline0.m1855m((Object) secureDirectoryStream.getFileAttributeView(path, PathTreeWalk$$ExternalSyntheticApiModelOutline0.m$1(), (LinkOption[]) Arrays.copyOf(linkOptionArr, linkOptionArr.length))).readAttributes().isDirectory());
        } catch (NoSuchFileException unused) {
            boolValueOf = null;
        }
        if (boolValueOf != null) {
    ...
    private static final void insecureEnterDirectory$PathsKt__PathRecursiveFunctionsKt(Path path, ExceptionsCollector exceptionsCollector) {
        ...
        try {
            ...
            Intrinsics.checkNotNullExpressionValue(it, "iterator(...)");
            while (it.hasNext()) {
                Path pathM1849m = PathTreeWalk$$ExternalSyntheticApiModelOutline0.m1849m(it.next());
                Intrinsics.checkNotNull(pathM1849m);
                insecureHandleEntry$PathsKt__PathRecursiveFunctionsKt(pathM1849m, path, exceptionsCollector);
            }
            Unit unit = Unit.INSTANCE;
            CloseableKt.closeFinally(directoryStream, null);
        } finally {
    ...
    private static final void checkNotSameAs$PathsKt__PathRecursiveFunctionsKt(Path path, Path path2) throws FileSystemLoopException {
        ...
        PathTreeWalk$$ExternalSyntheticApiModelOutline0.m1872m$1();
        throw PathTreeWalk$$ExternalSyntheticApiModelOutline0.m1842m(path.toString());
    }
}
