    ...
    void buildPath(float[] points, int pointCount) {
        ...
        while (i < pointCount) {
            ...
            if (viewOscillator != null) {
                points[i2] = points[i2] + viewOscillator.get(f4);
            } else if (viewSpline != null) {
                points[i2] = points[i2] + viewSpline.get(f4);
            }
            if (viewOscillator2 != null) {
                int i4 = i2 + 1;
                points[i4] = points[i4] + viewOscillator2.get(f4);
            } else if (viewSpline2 != null) {
                int i5 = i2 + 1;
                points[i5] = points[i5] + viewSpline2.get(f4);
            }
            i = i3 + 1;
            f = 1.0f;
        }
    ...
    public void setup(int parentWidth, int parentHeight, float transitionDuration, long currentTime) {
        ...
        while (true) {
            ...
            while (true) {
                ...
                if (motionPathsArr[i4].attributes.containsKey(str8) && (constraintAttribute = motionPathsArr[i4].attributes.get(str8)) != null) {
        ...
        for (int i10 = 0; i10 < size; i10++) {
            motionPathsArr[i10].fillStandard(dArr[i10], this.mInterpolateVariables);
            dArr2[i10] = motionPathsArr[i10].time;
        }
        int i11 = 0;
        while (true) {
            ...
            if (iArr2[i11] < MotionPaths.names.length) {
                String str9 = MotionPaths.names[this.mInterpolateVariables[i11]] + " [";
                for (int i12 = 0; i12 < size; i12++) {
                    str9 = str9 + dArr[i12][i11];
                }
            }
            i11++;
        }
        ...
        while (true) {
            ...
            double[][] dArr4 = null;
            while (i14 < size) {
                if (motionPathsArr[i14].hasCustomData(str10)) {
                    if (dArr4 == null) {
                        dArr3 = new double[size];
                        int[] iArr3 = new int[i];
                        iArr3[1] = motionPathsArr[i14].getCustomDataCount(str10);
                        iArr3[c] = size;
                        dArr4 = (double[][]) Array.newInstance((Class<?>) double.class, iArr3);
                    }
                    dArr3[i15] = motionPathsArr[i14].time;
                    motionPathsArr[i14].getCustomData(str10, dArr4[i15], 0);
                    i15++;
                }
                i14++;
                i = 2;
            ...
            i13++;
            this.mSpline[i13] = CurveFit.get(this.mCurveFitType, Arrays.copyOf(dArr3, i15), (double[][]) Arrays.copyOf(dArr4, i15));
            i = 2;
            c = 0;
        }
        ...
        if (motionPathsArr[0].mPathMotionArc != Key.UNSET) {
            ...
            for (int i16 = 0; i16 < size; i16++) {
                iArr4[i16] = motionPathsArr[i16].mPathMotionArc;
                dArr5[i16] = motionPathsArr[i16].time;
                dArr6[i16][0] = motionPathsArr[i16].x;
                dArr6[i16][1] = motionPathsArr[i16].y;
            }
    ...
    private float getAdjustedPosition(float position, float[] velocity) {
        ...
        if (velocity != null) {
            ...
            if (position > f2 && position < 1.0d) {
                position = Math.min((position - f2) * this.mStaggerScale, 1.0f);
            }
        }
        Easing easing = this.mStartMotionPath.mKeyFrameEasing;
        float f3 = Float.NaN;
        ...
        if (easing != null) {
            float f4 = (Float.isNaN(f3) ? 1.0f : f3) - f;
            double d = (position - f) / f4;
            position = (((float) easing.get(d)) * f4) + f;
            if (velocity != null) {
    ...
    boolean interpolate(View child, float global_position, long time, KeyCache keyCache) {
        ...
        if (curveFitArr != null) {
            ...
            if (this.mNoMovement) {
                ...
                d = d2;
                this.mStartMotionPath.setView(f3, child, this.mInterpolateVariables, this.mInterpolateData, this.mInterpolateVelocity, null);
            }
            ...
            if (this.mKeyTriggers != null) {
                ...
                while (true) {
                    ...
                    keyTriggerArr[i2].conditionallyFire(f3, child);
                    i2++;
                }
            }
        } else {
            ...
            int i4 = (int) f6;
            int i5 = (int) (f5 + this.mStartMotionPath.width + ((this.mEndMotionPath.width - this.mStartMotionPath.width) * f3));
            int i6 = (int) (f6 + this.mStartMotionPath.height + ((this.mEndMotionPath.height - this.mStartMotionPath.height) * f3));
            int i7 = i5 - i3;
            int i8 = i6 - i4;
        ...
        if (map4 != null) {
            for (ViewOscillator viewOscillator : map4.values()) {
                if (viewOscillator instanceof ViewOscillator.PathRotateSet) {
                    ...
                    ((ViewOscillator.PathRotateSet) viewOscillator).setPathRotate(child, f3, dArr4[0], dArr4[c]);
                } else {
