...
public final class ViewModelLazy<VM extends ViewModel> implements Lazy<VM> {
    ...
    /* JADX DEBUG: Multi-variable search result rejected for r5v0, resolved type: kotlin.jvm.functions.Function0<? extends androidx.lifecycle.viewmodel.CreationExtras> */
  ...
  (r1v0 kotlin.reflect.KClass)
  (r2v0 kotlin.jvm.functions.Function0)
  (r3v0 kotlin.jvm.functions.Function0)
  (wrap:kotlin.jvm.functions.Function0:?: TERNARY null = ((wrap:int:0x0000: ARITH (r5v0 int) & (8 int) A[WRAPPED]) != (0 int)) ? (wrap:androidx.lifecycle.ViewModelLazy$1:0x0006: SGET  A[WRAPPED] (LINE:39) androidx.lifecycle.ViewModelLazy.1.INSTANCE androidx.lifecycle.ViewModelLazy$1) : (r4v0 kotlin.jvm.functions.Function0))
 A[MD:(kotlin.reflect.KClass<VM extends androidx.lifecycle.ViewModel>, kotlin.jvm.functions.Function0<? extends androidx.lifecycle.ViewModelStore>, kotlin.jvm.functions.Function0<? extends androidx.lifecycle.ViewModelProvider$Factory>, kotlin.jvm.functions.Function0<? extends androidx.lifecycle.viewmodel.CreationExtras>):void (m)] (LINE:35) call: androidx.lifecycle.ViewModelLazy.<init>(kotlin.reflect.KClass, kotlin.jvm.functions.Function0, kotlin.jvm.functions.Function0, kotlin.jvm.functions.Function0):void type: THIS */
