                ...
                try {
                    try {
                        if (this.fsc == null) {
                            ...
                            LogMgr.performanceIn(LogMgr.PERFORMANCE_MFC, "FSC", LogSender.EXTRA_VALUE_EVENT_NAME_START, "url = " + str);
                        ...
                        LogMgr.log(2, "%s %s msg:%s", "711", "IllegalArgumentException", e.getMessage());
                        throw e;
                    }
                } catch (FelicaException e2) {
                    LogMgr.log(2, "%s %s id:%s type:%s", "710", "FelicaException", Integer.valueOf(e2.getID()), Integer.valueOf(e2.getType()));
                    throw e2;
                } catch (Exception e3) {
                    LogMgr.log(2, "%s %s msg:%s", "799", "Exception", e3.getMessage());
