...
public class FeliCaInUseView extends CustomDialogFragment implements FunctionCodeInterface {
    ...
    public void onDialogButtonClick() {
        AnalysisManager.stamp(MfsStamp.Event.ACTION_WID_1_6_CLOSE, new Object[0]);
        try {
    ...
    protected void onSetupDialog() {
        AnalysisManager.stamp(MfsStamp.Event.SCREEN_WID_1_6, new Object[0]);
        setTitle(getString(R.string.dlg_title_005));
        setNegativeText(getString(R.string.btn_msg_006));
        setNegativeButtonListener(new CustomDialogFragment.OnClickListener() { // from class: com.felicanetworks.mfs.view.FeliCaInUseView.1
            @Override // com.felicanetworks.mfs.view.CustomDialogFragment.OnClickListener
            public boolean onClick() {
                FeliCaInUseView.this.onDialogButtonClick();
                return false;
            }
        });
        setText(getString(R.string.dlg_msg_006));
    }
}
