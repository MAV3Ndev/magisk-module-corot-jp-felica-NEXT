...
public final class MutableObjectIntMap<K> extends ObjectIntMap<K> {
 ...
 A[MD:(int):void (m)] (LINE:693) call: androidx.collection.MutableObjectIntMap.<init>(int):void type: THIS */
    ...
    /* JADX DEBUG: Multi-variable search result rejected for r14v0, resolved type: androidx.collection.MutableObjectIntMap<K> */
    ...
    /* JADX DEBUG: Multi-variable search result rejected for r13v0, resolved type: androidx.collection.MutableObjectIntMap<K> */
    /* JADX WARN: Multi-variable type inference failed */
