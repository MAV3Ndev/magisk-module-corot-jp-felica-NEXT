...
public abstract class BaseEncoding {
                ...
                public int read() throws IOException {
                    while (true) {
                        ...
                        if (StandardBaseEncoding.this.paddingChar != null && StandardBaseEncoding.this.paddingChar.charValue() == c) {
                            ...
                            int i4 = this.bitBuffer << StandardBaseEncoding.this.alphabet.bitsPerChar;
                            this.bitBuffer = i4;
                            this.bitBuffer = StandardBaseEncoding.this.alphabet.decode(c) | i4;
                            int i5 = this.bitBufferLength + StandardBaseEncoding.this.alphabet.bitsPerChar;
                            this.bitBufferLength = i5;
                            if (i5 >= 8) {
                                int i6 = i5 - 8;
                                this.bitBufferLength = i6;
                                return (this.bitBuffer >> i6) & 255;
                            }
                        }
                    }
                }
    ...
    static final class SeparatedBaseEncoding extends BaseEncoding {
        ...
        public String toString() {
            ...
            StringBuilder sb = new StringBuilder(String.valueOf(strValueOf).length() + 31 + String.valueOf(str).length());
