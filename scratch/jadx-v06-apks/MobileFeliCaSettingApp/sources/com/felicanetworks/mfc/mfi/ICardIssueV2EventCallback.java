...
public interface ICardIssueV2EventCallback extends IInterface {
    ...
    public static abstract class Stub extends Binder implements ICardIssueV2EventCallback {
        private static final String DESCRIPTOR = "com.felicanetworks.mfc.mfi.ICardIssueV2EventCallback";
        ...
        public static ICardIssueV2EventCallback asInterface(IBinder iBinder) {
            if (iBinder == null) {
                return null;
            }
