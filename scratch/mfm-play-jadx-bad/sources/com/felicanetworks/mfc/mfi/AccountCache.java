...
public class AccountCache {
    ...
    public synchronized void cacheLoginData(LoginTokenJws loginToken, String accountIssuer, String accountName) {
        LogMgr.log(5, "000");
        this.mLoginToken = loginToken;
        this.mAccountIssuer = accountIssuer;
        this.mAccountName = accountName;
        if (loginToken != null) {
            this.mAccountId = loginToken.optAccountId();
        }
        writeCacheFile();
        LogMgr.log(5, "999");
    }
    ...
    public synchronized LoginTokenJws getLoginTokenCache(String accountIssuer, String accountName) {
        LogMgr.log(5, "000");
        LoginTokenJws loginTokenCache = null;
        if (accountIssuer != null && accountName != null) {
            loadCacheFile();
            if (accountIssuer.equals(this.mAccountIssuer) && accountName.equals(this.mAccountName)) {
    ...
    public synchronized LoginTokenJws getLoginTokenCache() {
        ...
        LogMgr.log(5, "000");
        LoginTokenJws loginTokenJws2 = this.mLoginToken;
        if (loginTokenJws2 != null) {
            if (loginTokenJws2.checkExpirationTime(EXPIRATION_TIME_SPARE_SEC)) {
    ...
    public synchronized String getAccountHashCache(String appIdInfo) {
        String strBytesToHexString;
        LogMgr.log(5, "000");
        loadCacheFile();
        LogMgr.log(6, "%s app=%s, id=%s", "001", appIdInfo, this.mAccountId);
        ...
        if (this.mAccountId != null) {
            ...
            messageDigest.update(appIdInfo.getBytes("UTF-8"));
    ...
    private void writeCacheFile() {
        ...
        try {
            ...
            if (str3 != null) {
                jSONObject.put(JSON_ACCOUNT_ID, str3);
            }
