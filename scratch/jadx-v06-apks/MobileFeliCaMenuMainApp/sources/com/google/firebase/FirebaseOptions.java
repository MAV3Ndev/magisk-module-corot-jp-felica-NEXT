...
public final class FirebaseOptions {
    ...
    public String toString() {
        return Objects.toStringHelper(this).add(Protocol.CLIENT_APPID_KEY, this.applicationId).add("apiKey", this.apiKey).add("databaseUrl", this.databaseUrl).add("gcmSenderId", this.gcmSenderId).add("storageBucket", this.storageBucket).add("projectId", this.projectId).toString();
    }
}
