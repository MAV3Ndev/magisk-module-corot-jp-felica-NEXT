...
class UserPoolTypeJsonMarshaller {
    ...
    public void marshall(UserPoolType userPoolType, AwsJsonWriter awsJsonWriter) throws Exception {
        ...
        if (userPoolType.getDeletionProtection() != null) {
            ...
            awsJsonWriter.name("DeletionProtection");
            awsJsonWriter.value(deletionProtection);
        }
        ...
        if (userPoolType.getUserAttributeUpdateSettings() != null) {
            ...
            awsJsonWriter.name("UserAttributeUpdateSettings");
            UserAttributeUpdateSettingsTypeJsonMarshaller.getInstance().marshall(userAttributeUpdateSettings, awsJsonWriter);
        }
