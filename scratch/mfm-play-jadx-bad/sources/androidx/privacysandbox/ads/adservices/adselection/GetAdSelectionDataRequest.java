...
/* JADX INFO: compiled from: GetAdSelectionDataRequest.kt */
...
public final class GetAdSelectionDataRequest {
  ...
  (r1v0 androidx.privacysandbox.ads.adservices.common.AdTechIdentifier)
  (wrap:android.net.Uri:?: TERNARY null = ((wrap:int:0x0000: ARITH (r3v0 int) & (2 int) A[WRAPPED]) != (0 int)) ? (null android.net.Uri) : (r2v0 android.net.Uri))
 A[MD:(androidx.privacysandbox.ads.adservices.common.AdTechIdentifier, android.net.Uri):void (m)] (LINE:46) call: androidx.privacysandbox.ads.adservices.adselection.GetAdSelectionDataRequest.<init>(androidx.privacysandbox.ads.adservices.common.AdTechIdentifier, android.net.Uri):void type: THIS */
    ...
    private static final class Ext12Impl {
        ...
        public static final class Companion {
            /* JADX DEBUG: Can't inline method, not implemented redirect type for insn: 0x0000: CONSTRUCTOR  A[MD:():void (m)] call: androidx.privacysandbox.ads.adservices.adselection.GetAdSelectionDataRequest.Ext12Impl.Companion.<init>():void type: THIS */
            ...
            public final android.adservices.adselection.GetAdSelectionDataRequest convertGetAdSelectionDataRequest(GetAdSelectionDataRequest request) {
                ...
                android.adservices.adselection.GetAdSelectionDataRequest getAdSelectionDataRequestBuild = AdFilters$$ExternalSyntheticApiModelOutline0.m283m().setSeller(request.getSeller().convertToAdServices$ads_adservices_release()).setCoordinatorOriginUri(request.getCoordinatorOriginUri()).build();
    ...
    private static final class Ext10Impl {
        ...
        public static final class Companion {
            /* JADX DEBUG: Can't inline method, not implemented redirect type for insn: 0x0000: CONSTRUCTOR  A[MD:():void (m)] call: androidx.privacysandbox.ads.adservices.adselection.GetAdSelectionDataRequest.Ext10Impl.Companion.<init>():void type: THIS */
            public /* synthetic */ Companion(DefaultConstructorMarker defaultConstructorMarker) {
                this();
            }
            ...
            public final android.adservices.adselection.GetAdSelectionDataRequest convertGetAdSelectionDataRequest(GetAdSelectionDataRequest request) {
                Intrinsics.checkNotNullParameter(request, "request");
                android.adservices.adselection.GetAdSelectionDataRequest getAdSelectionDataRequestBuild = AdFilters$$ExternalSyntheticApiModelOutline0.m283m().setSeller(request.getSeller().convertToAdServices$ads_adservices_release()).build();
                Intrinsics.checkNotNullExpressionValue(getAdSelectionDataRequestBuild, "Builder()\n              …                 .build()");
                return getAdSelectionDataRequestBuild;
            }
        }
