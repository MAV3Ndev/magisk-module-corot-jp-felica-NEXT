...
public final class SystemBarStyle {
    ...
    /* JADX DEBUG: Can't inline method, not implemented redirect type for insn: 0x0000: CONSTRUCTOR (r1v0 int), (r2v0 int), (r3v0 int), (r4v0 kotlin.jvm.functions.Function1) A[MD:(int, int, int, kotlin.jvm.functions.Function1<? super android.content.res.Resources, java.lang.Boolean>):void (m)] call: androidx.activity.SystemBarStyle.<init>(int, int, int, kotlin.jvm.functions.Function1):void type: THIS */
    ...
    /* JADX DEBUG: Multi-variable search result rejected for r4v0, resolved type: kotlin.jvm.functions.Function1<? super android.content.res.Resources, java.lang.Boolean> */
    ...
    public static final class Companion {
        /* JADX DEBUG: Can't inline method, not implemented redirect type for insn: 0x0000: CONSTRUCTOR  A[MD:():void (m)] call: androidx.activity.SystemBarStyle.Companion.<init>():void type: THIS */
        ...
        /* JADX DEBUG: Multi-variable search result rejected for r0v0, resolved type: androidx.activity.SystemBarStyle$Companion */
        /* JADX WARN: Multi-variable type inference failed */
