...
public class BufferedChannel<E> implements Channel<E> {
    ...
    public Object mo2173receiveCatchingJP2dKIU(Continuation<? super ChannelResult<? extends E>> continuation) {
        return m2171receiveCatchingJP2dKIU$suspendImpl(this, continuation);
    }
    ...
    /* JADX DEBUG: Multi-variable search result rejected for r10v0, resolved type: kotlin.jvm.functions.Function1<? super E, kotlin.Unit> */
 ...
 A[MD:(int, kotlin.jvm.functions.Function1<? super E, kotlin.Unit>):void (m)] (LINE:36) call: kotlinx.coroutines.channels.BufferedChannel.<init>(int, kotlin.jvm.functions.Function1):void type: THIS */
    ...
    public final void onClosedSendOnNoWaiterSuspend(E element, CancellableContinuation<? super Unit> cont) {
        ...
        cancellableContinuation.resumeWith(Result.m613constructorimpl(ResultKt.createFailure(sendException)));
    }

    @Override // kotlinx.coroutines.channels.SendChannel
    /* JADX INFO: renamed from: trySend-JP2dKIU */
    public Object mo2169trySendJP2dKIU(E element) {
        ChannelSegment channelSegmentFindSegmentSend;
        int i;
        BufferedChannel<E> bufferedChannel;
        if (shouldSendSuspend(sendersAndCloseStatus$FU.get(this))) {
            return ChannelResult.INSTANCE.m2193failurePtdJZtk();
        }
        ...
        while (true) {
            ...
            if (channelSegment.id != j2) {
                ...
                if (channelSegmentFindSegmentSend != null) {
                    ...
                    return ChannelResult.INSTANCE.m2192closedJP2dKIU(getSendException());
                }
            } else {
            ...
            if (iUpdateCellSend == 0) {
                channelSegment.cleanPrev();
                return ChannelResult.INSTANCE.m2194successJP2dKIU(Unit.INSTANCE);
            }
            if (iUpdateCellSend == 1) {
                return ChannelResult.INSTANCE.m2194successJP2dKIU(Unit.INSTANCE);
            }
    ...
    private final boolean tryResumeReceiver(Object obj, E e) {
        ...
        if (obj instanceof ReceiveCatching) {
            ...
            ChannelResult channelResultM2179boximpl = ChannelResult.m2179boximpl(ChannelResult.INSTANCE.m2194successJP2dKIU(e));
            Function1<E, Unit> function1 = this.onUndeliveredElement;
            return BufferedChannelKt.tryResume0(cancellableContinuationImpl, channelResultM2179boximpl, function1 != null ? OnUndeliveredElementKt.bindCancellationFun(function1, e, receiveCatching.cont.getContext()) : null);
        }
    ...
    public final void onClosedReceiveOnNoWaiterSuspend(CancellableContinuation<? super E> cont) {
        Result.Companion companion = Result.INSTANCE;
        cont.resumeWith(Result.m613constructorimpl(ResultKt.createFailure(getReceiveException())));
    }

    /* JADX DEBUG: Multi-variable search result rejected for r14v13, resolved type: kotlinx.coroutines.channels.ChannelResult$Companion */
    /* JADX WARN: Multi-variable type inference failed */
    ...
    */
    static /* synthetic */ <E> Object m2171receiveCatchingJP2dKIU$suspendImpl(BufferedChannel<E> bufferedChannel, Continuation<? super ChannelResult<? extends E>> continuation) throws Throwable {
            ...
            if (objUpdateCellReceive != BufferedChannelKt.SUSPEND) {
                if (objUpdateCellReceive != BufferedChannelKt.FAILED) {
                    if (objUpdateCellReceive == BufferedChannelKt.SUSPEND_NO_WAITER) {
                        ...
                        Object objM2172receiveCatchingOnNoWaiterSuspendGKJJFZk = bufferedChannel2.m2172receiveCatchingOnNoWaiterSuspendGKJJFZk(channelSegment, i2, andIncrement, bufferedChannel$receiveCatching$12);
                        return objM2172receiveCatchingOnNoWaiterSuspendGKJJFZk == coroutine_suspended ? coroutine_suspended : objM2172receiveCatchingOnNoWaiterSuspendGKJJFZk;
                    }
                    channelSegment.cleanPrev();
                    return ChannelResult.INSTANCE.m2194successJP2dKIU(objUpdateCellReceive);
                }
                if (andIncrement < bufferedChannel2.getSendersCounter$kotlinx_coroutines_core()) {
                    channelSegment.cleanPrev();
                }
        ...
        return ChannelResult.INSTANCE.m2192closedJP2dKIU(bufferedChannel.getCloseCause());
    }

    /* JADX DEBUG: Multi-variable search result rejected for r12v17, resolved type: kotlinx.coroutines.channels.ChannelResult$Companion */
    /* JADX DEBUG: Multi-variable search result rejected for r12v3, resolved type: kotlinx.coroutines.channels.ChannelResult$Companion */
    /* JADX INFO: Access modifiers changed from: private */
    /* JADX WARN: Multi-variable type inference failed */
    /* JADX WARN: Removed duplicated region for block: B:7:0x0014  */
    ...
    /*
        Code decompiled incorrectly, please refer to instructions dump.
    */
    public final Object m2172receiveCatchingOnNoWaiterSuspendGKJJFZk(ChannelSegment<E> channelSegment, int i, long j, Continuation<? super ChannelResult<? extends E>> continuation) throws Throwable {
        BufferedChannel$receiveCatchingOnNoWaiterSuspend$1 bufferedChannel$receiveCatchingOnNoWaiterSuspend$1;
        ChannelResult channelResultM2179boximpl;
        ChannelSegment channelSegment2;
                    ...
                    try {
                        if (objUpdateCellReceive != BufferedChannelKt.SUSPEND) {
                            ...
                            if (objUpdateCellReceive == BufferedChannelKt.FAILED) {
                                ...
                                while (true) {
                                    ...
                                    if (objUpdateCellReceive2 != BufferedChannelKt.SUSPEND) {
                                        if (objUpdateCellReceive2 == BufferedChannelKt.FAILED) {
                                            ...
                                            channelSegment2.cleanPrev();
                                            channelResultM2179boximpl = ChannelResult.m2179boximpl(ChannelResult.INSTANCE.m2194successJP2dKIU(objUpdateCellReceive2));
                                            Function1<E, Unit> function1 = this.onUndeliveredElement;
                                            if (function1 != null) {
                                ...
                                channelSegment.cleanPrev();
                                channelResultM2179boximpl = ChannelResult.m2179boximpl(ChannelResult.INSTANCE.m2194successJP2dKIU(objUpdateCellReceive));
                                Function1<E, Unit> function12 = this.onUndeliveredElement;
                                if (function12 != null) {
                            ...
                            orCreateCancellableContinuation.resume(channelResultM2179boximpl, function1BindCancellationFun);
                        } else {
    ...
    public final void onClosedReceiveCatchingOnNoWaiterSuspend(CancellableContinuation<? super ChannelResult<? extends E>> cont) {
        Result.Companion companion = Result.INSTANCE;
        cont.resumeWith(Result.m613constructorimpl(ChannelResult.m2179boximpl(ChannelResult.INSTANCE.m2192closedJP2dKIU(getCloseCause()))));
    }

    /* JADX DEBUG: Multi-variable search result rejected for r1v10, resolved type: kotlinx.coroutines.channels.ChannelResult$Companion */
    /* JADX WARN: Multi-variable type inference failed */
    @Override // kotlinx.coroutines.channels.ReceiveChannel
    /* JADX INFO: renamed from: tryReceive-PtdJZtk, reason: not valid java name */
    public Object mo2174tryReceivePtdJZtk() {
        ChannelSegment channelSegment;
        long j = receivers$FU.get(this);
        long j2 = sendersAndCloseStatus$FU.get(this);
        if (isClosedForReceive0(j2)) {
            return ChannelResult.INSTANCE.m2192closedJP2dKIU(getCloseCause());
        }
    ...
    public final Object processResultSelectReceiveCatching(Object ignoredParam, Object selectResult) {
        return ChannelResult.m2179boximpl(selectResult == BufferedChannelKt.getCHANNEL_CLOSED() ? ChannelResult.INSTANCE.m2192closedJP2dKIU(getCloseCause()) : ChannelResult.INSTANCE.m2194successJP2dKIU(selectResult));
    }
    ...
    private final class BufferedChannelIterator implements ChannelIterator<E>, Waiter {
        ...
        public final void onClosedHasNextNoWaiterSuspend() {
            ...
            if (closeCause == null) {
                Result.Companion companion = Result.INSTANCE;
                cancellableContinuationImpl.resumeWith(Result.m613constructorimpl(false));
                return;
            }
            ...
            cancellableContinuationImpl2.resumeWith(Result.m613constructorimpl(ResultKt.createFailure(closeCause)));
        }
    ...
    */
    ...
    /* JADX DEBUG: Multi-variable search result rejected for r12v2, resolved type: S */
    ...
    */
    private final void removeUnprocessedElements(ChannelSegment<E> lastSegment) {
        ...
        Object objM2216constructorimpl$default = InlineList.m2216constructorimpl$default(null, 1, null);
        loop0: do {
                    ...
                    if (state$kotlinx_coroutines_core != BufferedChannelKt.BUFFERED) {
                        if (state$kotlinx_coroutines_core == BufferedChannelKt.IN_BUFFER || state$kotlinx_coroutines_core == null) {
                            ...
                            if (lastSegment.casState$kotlinx_coroutines_core(i, state$kotlinx_coroutines_core, BufferedChannelKt.getCHANNEL_CLOSED())) {
                                ...
                                objM2216constructorimpl$default = InlineList.m2221plusFjFbRPM(objM2216constructorimpl$default, waiter);
        ...
        if (objM2216constructorimpl$default != null) {
            if (!(objM2216constructorimpl$default instanceof ArrayList)) {
                resumeSenderOnCancelledChannel((Waiter) objM2216constructorimpl$default);
            } else {
                Intrinsics.checkNotNull(objM2216constructorimpl$default, "null cannot be cast to non-null type java.util.ArrayList<E of kotlinx.coroutines.internal.InlineList>{ kotlin.collections.TypeAliasesKt.ArrayList<E of kotlinx.coroutines.internal.InlineList> }");
                ArrayList arrayList = (ArrayList) objM2216constructorimpl$default;
    ...
    /* JADX DEBUG: Multi-variable search result rejected for r9v8, resolved type: S */
    /* JADX WARN: Multi-variable type inference failed */
    private final void cancelSuspendedReceiveRequests(ChannelSegment<E> lastSegment, long sendersCounter) {
            ...
            for (int i = BufferedChannelKt.SEGMENT_SIZE - 1; -1 < i; i--) {
                ...
                while (true) {
                    ...
                    if (state$kotlinx_coroutines_core == null || state$kotlinx_coroutines_core == BufferedChannelKt.IN_BUFFER) {
                        ...
                        if (lastSegment.casState$kotlinx_coroutines_core(i, state$kotlinx_coroutines_core, BufferedChannelKt.getCHANNEL_CLOSED())) {
                            objM2216constructorimpl$default = InlineList.m2221plusFjFbRPM(objM2216constructorimpl$default, ((WaiterEB) state$kotlinx_coroutines_core).waiter);
                        ...
                        if (lastSegment.casState$kotlinx_coroutines_core(i, state$kotlinx_coroutines_core, BufferedChannelKt.getCHANNEL_CLOSED())) {
                            objM2216constructorimpl$default = InlineList.m2221plusFjFbRPM(objM2216constructorimpl$default, state$kotlinx_coroutines_core);
                            lastSegment.onCancelledRequest(i, true);
                            break;
                        }
                    }
        ...
        if (objM2216constructorimpl$default != null) {
            if (!(objM2216constructorimpl$default instanceof ArrayList)) {
                resumeReceiverOnClosedChannel((Waiter) objM2216constructorimpl$default);
                return;
            }
            Intrinsics.checkNotNull(objM2216constructorimpl$default, "null cannot be cast to non-null type java.util.ArrayList<E of kotlinx.coroutines.internal.InlineList>{ kotlin.collections.TypeAliasesKt.ArrayList<E of kotlinx.coroutines.internal.InlineList> }");
            ArrayList arrayList = (ArrayList) objM2216constructorimpl$default;
    ...
    private final void resumeWaiterOnClosedChannel(Waiter waiter, boolean z) {
        if (waiter instanceof SendBroadcast) {
            ...
            Result.Companion companion = Result.INSTANCE;
            cont.resumeWith(Result.m613constructorimpl(false));
            return;
        }
        if (waiter instanceof CancellableContinuation) {
            Continuation continuation = (Continuation) waiter;
            Result.Companion companion2 = Result.INSTANCE;
            continuation.resumeWith(Result.m613constructorimpl(ResultKt.createFailure(z ? getReceiveException() : getSendException())));
            ...
            cancellableContinuationImpl.resumeWith(Result.m613constructorimpl(ChannelResult.m2179boximpl(ChannelResult.INSTANCE.m2192closedJP2dKIU(getCloseCause()))));
    ...
    public final ChannelSegment<E> findSegmentSend(long id, ChannelSegment<E> startFrom) {
        ...
        loop0: while (true) {
            ...
            if (!SegmentOrClosed.m2233isClosedimpl(objFindSegmentInternal)) {
                Segment segmentM2231getSegmentimpl = SegmentOrClosed.m2231getSegmentimpl(objFindSegmentInternal);
                while (true) {
                    Segment segment = (Segment) atomicReferenceFieldUpdater.get(this);
                    if (segment.id >= segmentM2231getSegmentimpl.id) {
                        break loop0;
                    }
                    if (!segmentM2231getSegmentimpl.tryIncPointers$kotlinx_coroutines_core()) {
                        break;
                    }
                    if (AbstractResolvableFuture$SafeAtomicHelper$$ExternalSyntheticBackportWithForwarding0.m(atomicReferenceFieldUpdater, this, segment, segmentM2231getSegmentimpl)) {
                        if (segment.decPointers$kotlinx_coroutines_core()) {
                            segment.remove();
                        }
                    } else if (segmentM2231getSegmentimpl.decPointers$kotlinx_coroutines_core()) {
                        segmentM2231getSegmentimpl.remove();
                    }
                }
            } else {
                break;
        ...
        ChannelSegment<E> channelSegment = (ChannelSegment) SegmentOrClosed.m2231getSegmentimpl(objFindSegmentInternal);
    ...
    /* JADX DEBUG: Multi-variable search result rejected for r6v4, resolved type: S */
    ...
    */
    ...
    /* JADX DEBUG: Multi-variable search result rejected for r2v14, resolved type: S */
    /* JADX DEBUG: Multi-variable search result rejected for r2v8, resolved type: kotlinx.coroutines.channels.ChannelSegment[] */
    /* JADX DEBUG: Multi-variable search result rejected for r3v8, resolved type: java.util.ArrayList */
    ...
    */
    ...
    /* JADX DEBUG: Multi-variable search result rejected for r1v10, resolved type: kotlinx.coroutines.channels.ChannelSegment[] */
    /* JADX DEBUG: Multi-variable search result rejected for r1v20, resolved type: S */
    /* JADX DEBUG: Multi-variable search result rejected for r2v17, resolved type: java.util.ArrayList */
    /* JADX DEBUG: Multi-variable search result rejected for r4v10, resolved type: S */
    /* JADX DEBUG: Multi-variable search result rejected for r4v17, resolved type: S */
    /* JADX WARN: Multi-variable type inference failed */
    ...
    /* JADX DEBUG: Multi-variable search result rejected for r0v10, resolved type: kotlinx.coroutines.channels.ChannelSegment[] */
    /* JADX DEBUG: Multi-variable search result rejected for r0v21, resolved type: S */
    /* JADX DEBUG: Multi-variable search result rejected for r0v26, resolved type: S */
    /* JADX DEBUG: Multi-variable search result rejected for r0v39, resolved type: S */
    /* JADX DEBUG: Multi-variable search result rejected for r1v9, resolved type: java.util.ArrayList */
    /* JADX WARN: Multi-variable type inference failed */
    ...
    public final Object onClosedSend(E e, Continuation<? super Unit> continuation) {
        ...
        if (function1 != null && (undeliveredElementExceptionCallUndeliveredElementCatchingException$default = OnUndeliveredElementKt.callUndeliveredElementCatchingException$default(function1, e, null, 2, null)) != null) {
            ...
            cancellableContinuationImpl3.resumeWith(Result.m613constructorimpl(ResultKt.createFailure(undeliveredElementExceptionRecoverFromStackFrame)));
        } else {
            ...
            cancellableContinuationImpl4.resumeWith(Result.m613constructorimpl(ResultKt.createFailure(sendException)));
        }
    ...
    /* JADX DEBUG: Don't trust debug lines info. Repeating lines: [162=4, 165=4] */
    /* JADX INFO: Access modifiers changed from: private */
    ...
    */
    public final Object sendOnNoWaiterSuspend(ChannelSegment<E> channelSegment, int i, E e, long j, Continuation<? super Unit> continuation) throws Throwable {
        ...
        try {
            try {
                ...
                cancellableContinuationImpl.resumeWith(objM613constructorimpl);
                result = orCreateCancellableContinuation.getResult();
                if (result == IntrinsicsKt.getCOROUTINE_SUSPENDED()) {
                }
                if (result != IntrinsicsKt.getCOROUTINE_SUSPENDED()) {
    ...
    /* JADX WARN: Code restructure failed: missing block: B:42:0x00b1, code lost:
        ...
        r1.resumeWith(kotlin.Result.m613constructorimpl(kotlin.coroutines.jvm.internal.Boxing.boxBoolean(true)));
     */
    /*
        Code decompiled incorrectly, please refer to instructions dump.
    */
    static /* synthetic */ <E> Object sendBroadcast$suspendImpl(BufferedChannel<E> bufferedChannel, E e, Continuation<? super Boolean> continuation) {
        ...
        Result.Companion companion = Result.INSTANCE;
        cancellableContinuationImpl2.resumeWith(Result.m613constructorimpl(Boxing.boxBoolean(false)));
        Object result = cancellableContinuationImpl.getResult();
        if (result == IntrinsicsKt.getCOROUTINE_SUSPENDED()) {
            DebugProbesKt.probeCoroutineSuspended(continuation);
        }
    ...
    /* JADX DEBUG: Multi-variable search result rejected for r13v0, resolved type: kotlinx.coroutines.channels.BufferedChannel<E> */
    /* JADX WARN: Multi-variable type inference failed */
