...
public final class CreatePasswordResponse extends CreateCredentialResponse {
    ...
    /* JADX DEBUG: Can't inline method, not implemented redirect type for insn: 0x0000: CONSTRUCTOR (r1v0 android.os.Bundle) A[MD:(android.os.Bundle):void (m)] call: androidx.credentials.CreatePasswordResponse.<init>(android.os.Bundle):void type: THIS */
    ...
    public static final class Companion {
        /* JADX DEBUG: Can't inline method, not implemented redirect type for insn: 0x0000: CONSTRUCTOR  A[MD:():void (m)] call: androidx.credentials.CreatePasswordResponse.Companion.<init>():void type: THIS */
