...
public interface IServerOperationEventCallback extends IInterface {
    ...
    public static abstract class Stub extends Binder implements IServerOperationEventCallback {
        private static final String DESCRIPTOR = "com.felicanetworks.mfc.mfi.IServerOperationEventCallback";
        ...
        public static IServerOperationEventCallback asInterface(IBinder iBinder) {
            if (iBinder == null) {
                return null;
            }
