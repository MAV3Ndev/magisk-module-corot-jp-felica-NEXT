...
public abstract class FloatFloatMap {
    ...
    /* JADX DEBUG: Can't inline method, not implemented redirect type for insn: 0x0000: CONSTRUCTOR  A[MD:():void (m)] call: androidx.collection.FloatFloatMap.<init>():void type: THIS */
            ...
            if ((((~j) << 7) & j & (-9187201950435737472L)) != -9187201950435737472L) {
                ...
                for (int i3 = 0; i3 < i2; i3++) {
                    if ((255 & j) < 128) {
                        int i4 = (i << 3) + i3;
                        float f = fArr[i4];
                        iFloatToIntBits += Float.floatToIntBits(fArr2[i4]) ^ Float.floatToIntBits(f);
                    }
                    j >>= 8;
                }
                if (i2 != 8) {
