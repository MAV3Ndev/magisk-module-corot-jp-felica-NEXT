...
public class MyWaonInfo extends MyServiceInfo implements ServiceInfo.PrepaidEmoney, ServiceInfo.Point, ServiceInfo.History {
    ...
    public MyWaonInfo(MyServiceInfo service, AssetInfo assetInfo) {
        super(service);
        this._balance = -1;
    ...
    public static int getValidPoint(List<ServiceInfo.Point.PointData> points) {
        Iterator<ServiceInfo.Point.PointData> it = points.iterator();
        boolean z = false;
        int point = 0;
        while (it.hasNext()) {
