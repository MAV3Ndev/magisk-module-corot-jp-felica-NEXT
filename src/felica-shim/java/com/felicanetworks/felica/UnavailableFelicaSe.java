...
final class UnavailableFelicaSe extends Binder implements IFelicaSe {
    private static final int TYPE_NFC_GENERIC_ERROR = -99;
    private static final String SERVICE_UNAVAILABLE = "FeliCa SE service is not available on this module";
    ...
    @Override
    public int connect(String packageName, int handle) throws RemoteException {
