    ...
    */
    ...
    LocaleListCompat calculateApplicationLocales(Context context) {
        ...
        if (Build.VERSION.SDK_INT >= 24) {
            ...
            localeListCompatForLanguageTags = LocaleListCompat.forLanguageTags(Api21Impl.toLanguageTag(requestedAppLocales.get(0)));
        }
    ...
    */
    ...
    static class Api33Impl {
        ...
        static OnBackInvokedCallback registerOnBackPressedCallback(Object obj, final AppCompatDelegateImpl appCompatDelegateImpl) {
            ...
            ComponentDialog$$ExternalSyntheticApiModelOutline0.m18m(obj).registerOnBackInvokedCallback(DurationKt.NANOS_IN_MILLIS, onBackInvokedCallback);
            return onBackInvokedCallback;
        }

        static void unregisterOnBackInvokedCallback(Object obj, Object obj2) {
            ComponentDialog$$ExternalSyntheticApiModelOutline0.m18m(obj).unregisterOnBackInvokedCallback(ComponentDialog$$ExternalSyntheticApiModelOutline0.m17m(obj2));
        }
