...
public final class HandlerDispatcherKt {
    ...
    static {
        ...
        try {
            ...
            objM613constructorimpl = Result.m613constructorimpl(new HandlerContext(asHandler(Looper.getMainLooper(), true), null, 2, null));
        } catch (Throwable th) {
            Result.Companion companion2 = Result.INSTANCE;
            objM613constructorimpl = Result.m613constructorimpl(ResultKt.createFailure(th));
        }
        Main = (HandlerDispatcher) (Result.m619isFailureimpl(objM613constructorimpl) ? null : objM613constructorimpl);
    }
    ...
    public static final Object awaitFrameSlowPath(Continuation<? super Long> continuation) {
        ...
        if (Looper.myLooper() == Looper.getMainLooper()) {
            ...
            Dispatchers.getMain().mo2225dispatch(cancellableContinuationImpl2.getContext(), new Runnable() { // from class: kotlinx.coroutines.android.HandlerDispatcherKt$awaitFrameSlowPath$lambda$3$$inlined$Runnable$1
