...
public final class UpdateAdCounterHistogramRequest {
    ...
    public int hashCode() {
        return (((UByte$$ExternalSyntheticBackport0.m(this.adSelectionId) * 31) + this.adEventType) * 31) + this.callerAdTech.hashCode();
    }
    ...
    public final android.adservices.adselection.UpdateAdCounterHistogramRequest convertToAdServices$ads_adservices_release() {
        AdFilters$$ExternalSyntheticApiModelOutline0.m304m$2();
        android.adservices.adselection.UpdateAdCounterHistogramRequest updateAdCounterHistogramRequestBuild = AdFilters$$ExternalSyntheticApiModelOutline0.m(this.adSelectionId, this.adEventType, this.callerAdTech.convertToAdServices$ads_adservices_release()).build();
