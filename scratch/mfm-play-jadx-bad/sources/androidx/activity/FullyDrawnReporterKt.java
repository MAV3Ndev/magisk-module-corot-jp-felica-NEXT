...
public final class FullyDrawnReporterKt {
    ...
    @DebugMetadata(c = "androidx.activity.FullyDrawnReporterKt", f = "FullyDrawnReporter.kt", i = {0}, l = {MfiClientException.TYPE_EXIST_EMPTY_SLOT_FAILED}, m = "reportWhenComplete", n = {"$this$reportWhenComplete"}, s = {"L$0"})
    ...
    /* JADX DEBUG: Failed to insert an additional move for type inference into block B:28:0x0022 */
    /* JADX DEBUG: Multi-variable search result rejected for r4v0, resolved type: androidx.activity.FullyDrawnReporter */
    /* JADX DEBUG: Multi-variable search result rejected for r4v1, resolved type: androidx.activity.FullyDrawnReporter */
