...
public interface ICardDeleteEventCallback extends IInterface {
    ...
    public static abstract class Stub extends Binder implements ICardDeleteEventCallback {
        private static final String DESCRIPTOR = "com.felicanetworks.mfc.mfi.ICardDeleteEventCallback";
        ...
        public static ICardDeleteEventCallback asInterface(IBinder iBinder) {
            if (iBinder == null) {
                return null;
            }
