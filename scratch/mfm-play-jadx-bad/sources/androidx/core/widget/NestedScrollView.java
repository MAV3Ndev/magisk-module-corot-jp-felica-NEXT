...
public class NestedScrollView extends FrameLayout implements NestedScrollingParent3, NestedScrollingChild3, ScrollingView {
    ...
    public boolean executeKeyEvent(KeyEvent keyEvent) {
        ...
        int i = FeliCaParams.BLOCK_NO_FELICAPOCKET_LITE_DATA_FORMAT_CODE;
        if (!zCanScroll) {
            if (isFocused() && keyEvent.getKeyCode() != 4) {
                ...
                View viewFindNextFocus = FocusFinder.getInstance().findNextFocus(this, viewFindFocus, FeliCaParams.BLOCK_NO_FELICAPOCKET_LITE_DATA_FORMAT_CODE);
                if (viewFindNextFocus != null && viewFindNextFocus != this && viewFindNextFocus.requestFocus(FeliCaParams.BLOCK_NO_FELICAPOCKET_LITE_DATA_FORMAT_CODE)) {
                    return true;
                }
            }
            return false;
        ...
        if (keyEvent.getAction() == 0) {
            ...
            if (keyCode == 20) {
                if (keyEvent.isAltPressed()) {
                    return fullScroll(FeliCaParams.BLOCK_NO_FELICAPOCKET_LITE_DATA_FORMAT_CODE);
                }
                return arrowScroll(FeliCaParams.BLOCK_NO_FELICAPOCKET_LITE_DATA_FORMAT_CODE);
            }
            if (keyCode == 62) {
            ...
            if (keyCode == 123) {
                pageScroll(FeliCaParams.BLOCK_NO_FELICAPOCKET_LITE_DATA_FORMAT_CODE);
                return false;
            }
        }
        return false;
    ...
    */
    ...
    protected boolean onRequestFocusInDescendants(int i, Rect rect) {
        ...
        if (i == 2) {
            i = FeliCaParams.BLOCK_NO_FELICAPOCKET_LITE_DATA_FORMAT_CODE;
        } else if (i == 1) {
            i = 33;
        }
        if (rect == null) {
