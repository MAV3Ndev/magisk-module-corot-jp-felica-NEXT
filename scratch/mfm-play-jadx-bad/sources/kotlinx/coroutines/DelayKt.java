...
public final class DelayKt {
    ...
    @DebugMetadata(c = "kotlinx.coroutines.DelayKt", f = "Delay.kt", i = {}, l = {MfiClientException.TYPE_NOT_SUPPORTED}, m = "awaitCancellation", n = {}, s = {})
    ...
    */
    ...
    public static final Object delay(long j, Continuation<? super Unit> continuation) {
        ...
        if (j < Long.MAX_VALUE) {
            getDelay(cancellableContinuationImpl2.getContext()).mo2226scheduleResumeAfterDelay(j, cancellableContinuationImpl2);
        }
        Object result = cancellableContinuationImpl.getResult();
        if (result == IntrinsicsKt.getCOROUTINE_SUSPENDED()) {
    ...
    public static final Object m2157delayVtjQ1oo(long j, Continuation<? super Unit> continuation) {
        Object objDelay = delay(m2158toDelayMillisLRDsOJo(j), continuation);
    ...
    public static final long m2158toDelayMillisLRDsOJo(long j) {
        if (Duration.m2020compareToLRDsOJo(j, Duration.INSTANCE.m2112getZEROUwyO8pc()) > 0) {
            return RangesKt.coerceAtLeast(Duration.m2032getInWholeMillisecondsimpl(j), 1L);
        }
        return 0L;
    }
}
