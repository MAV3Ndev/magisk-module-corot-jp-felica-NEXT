...
public class HiddenUnregisteredServiceTable {
    private static final int LIMIT = 1000;
    public static final int SINCE_MYSERVICE_DB_VERSION = 1;
    public static final String TABLE_NAME = "HiddenUnregisteredService";

    public static class Statement {
        public static final String CREATE = StatementUtils.create(HiddenUnregisteredServiceTable.TABLE_NAME, Column.values(), String.format("CONSTRAINT pky PRIMARY KEY(%s)", Column.SERVICE_ID.title));
        public static final String SELECT_ALL = String.format(Locale.US, "SELECT * FROM %s LIMIT %d", HiddenUnregisteredServiceTable.TABLE_NAME, 1000);
    }
    ...
    public static class RecordBuilder {
        ...
        public RecordBuilder setServiceId(String str) {
            this.record.put(Column.SERVICE_ID, str);
            return this;
        }
    }

    public static class Selector {
        public static String findServiceId(Cursor cursor) {
