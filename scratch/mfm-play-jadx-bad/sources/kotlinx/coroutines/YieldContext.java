...
public final class YieldContext extends AbstractCoroutineContextElement {
    ...
    public static final class Companion implements CoroutineContext.Key<YieldContext> {
        /* JADX DEBUG: Can't inline method, not implemented redirect type for insn: 0x0000: CONSTRUCTOR  A[MD:():void (m)] call: kotlinx.coroutines.YieldContext.Key.<init>():void type: THIS */
