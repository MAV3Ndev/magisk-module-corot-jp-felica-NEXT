...
final class zzab implements ObjectEncoderContext {
    private static final Charset zza = Charset.forName(StringUtil.UTF_8);
    ...
    static {
        FieldDescriptor.Builder builder = FieldDescriptor.builder(TransitPassInfoAgent.OPTIONAL_INFO_KEY);
        zzv zzvVar = new zzv();
        zzvVar.zza(1);
        zzg = builder.withProperty(zzvVar.zzb()).build();
        FieldDescriptor.Builder builder2 = FieldDescriptor.builder(TransitPassInfoAgent.OPTIONAL_INFO_VALUE);
        zzv zzvVar2 = new zzv();
        zzvVar2.zza(2);
