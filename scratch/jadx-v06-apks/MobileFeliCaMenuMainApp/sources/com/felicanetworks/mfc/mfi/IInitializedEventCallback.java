...
public interface IInitializedEventCallback extends IInterface {
    ...
    public static abstract class Stub extends Binder implements IInitializedEventCallback {
        private static final String DESCRIPTOR = "com.felicanetworks.mfc.mfi.IInitializedEventCallback";
        ...
        public static IInitializedEventCallback asInterface(IBinder iBinder) {
            if (iBinder == null) {
                return null;
            }
