...
public final class WebTriggerRegistrationRequest {
    ...
    public final android.adservices.measurement.WebTriggerRegistrationRequest convertToAdServices$ads_adservices_release() {
        Transition$Impl26$$ExternalSyntheticApiModelOutline0.m$4();
        android.adservices.measurement.WebTriggerRegistrationRequest webTriggerRegistrationRequestBuild = Transition$Impl26$$ExternalSyntheticApiModelOutline0.m341m((List) WebTriggerParams.INSTANCE.convertWebTriggerParams$ads_adservices_release(this.webTriggerParams), this.destination).build();
