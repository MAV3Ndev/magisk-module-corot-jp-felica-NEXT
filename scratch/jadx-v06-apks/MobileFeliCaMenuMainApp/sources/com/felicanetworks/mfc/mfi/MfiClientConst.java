...
public class MfiClientConst {
    ...
    public static final int EVENT_TYPE_ERROR_SERVER_RESULT = 101;
    public static final int EVENT_TYPE_HTTP_ERROR = 102;
    ...
    public static final String EXC_MAX_SIZE_PERMIT_LIST = "The size of permit list exceeds the maximum value.";
    public static final String EXC_RUNTIME = "java.lang.RuntimeException: A runtime exception was thrown within .";
    ...
    public static final int INVALID_AREA_CODE = 65535;
