...
public class CreateSegmentRequestMarshaller implements Marshaller<Request<CreateSegmentRequest>, CreateSegmentRequest> {
    ...
    public Request<CreateSegmentRequest> marshall(CreateSegmentRequest createSegmentRequest) {
        ...
        defaultRequest.setResourcePath("/v1/apps/{application-id}/segments".replace("{application-id}", createSegmentRequest.getApplicationId() == null ? "" : StringUtils.fromString(createSegmentRequest.getApplicationId())));
        try {
            StringWriter stringWriter = new StringWriter();
            AwsJsonWriter jsonWriter = JsonUtils.getJsonWriter(stringWriter);
            if (createSegmentRequest.getWriteSegmentRequest() != null) {
                WriteSegmentRequestJsonMarshaller.getInstance().marshall(createSegmentRequest.getWriteSegmentRequest(), jsonWriter);
            }
            jsonWriter.close();
