...
public final class HexExtensionsKt {
    ...
    private static final int checkFormatLength(long j) {
        ...
        throw new IllegalArgumentException("The resulting string length is too big: " + ((Object) ULong.m838toStringimpl(ULong.m792constructorimpl(j))));
    }
            ...
            if (i8 == bytesPerLine) {
                ...
                if (str4.length() == 0) {
                    ...
                    while (i10 < length2) {
                        ...
                        if (!CharsKt.equals(groupSeparator.charAt(i10), str.charAt(length + i10), ignoreCase$kotlin_stdlib)) {
                ...
                if (i9 != 0) {
                    ...
                    if (str5.length() != 0) {
                        ...
                        while (i13 < length3) {
                            int i14 = length3;
                            if (!CharsKt.equals(byteSeparator.charAt(i13), str.charAt(length + i13), ignoreCase$kotlin_stdlib)) {
                ...
                if (str2.length() != 0) {
                    ...
                    while (i15 < length4) {
                        int i16 = length4;
                        if (!CharsKt.equals(bytePrefix.charAt(i15), str.charAt(length + i15), ignoreCase$kotlin_stdlib)) {
                ...
                if (i2 - 2 < length) {
                    throwInvalidNumberOfDigits(str, length, i2, "exactly", 2);
                }
                int i17 = i7 + 1;
                ...
                if (str3.length() != 0) {
                    ...
                    while (i18 < length5) {
                        int i19 = i17;
                        if (!CharsKt.equals(byteSuffix.charAt(i18), str.charAt(length + i18), ignoreCase$kotlin_stdlib)) {
