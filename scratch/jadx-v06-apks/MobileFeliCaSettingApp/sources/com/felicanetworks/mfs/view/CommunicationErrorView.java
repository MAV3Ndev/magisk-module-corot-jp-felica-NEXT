...
public class CommunicationErrorView extends CustomDialogFragment implements FunctionCodeInterface {
    ...
    public void onDialogButtonClick() {
        AnalysisManager.stamp(MfsStamp.Event.ACTION_WID_1_11_CLOSE, new Object[0]);
        try {
    ...
    protected void onSetupDialog() {
        AnalysisManager.stamp(MfsStamp.Event.SCREEN_WID_1_11, new Object[0]);
        setTitle(getString(R.string.dlg_title_010));
        setNegativeText(getString(R.string.btn_msg_011));
        setNegativeButtonListener(new CustomDialogFragment.OnClickListener() { // from class: com.felicanetworks.mfs.view.CommunicationErrorView.1
            @Override // com.felicanetworks.mfs.view.CustomDialogFragment.OnClickListener
            public boolean onClick() {
                CommunicationErrorView.this.onDialogButtonClick();
                return false;
            }
        });
        setText(getString(R.string.dlg_msg_011));
    }
}
