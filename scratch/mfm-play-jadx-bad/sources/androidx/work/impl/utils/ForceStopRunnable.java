            ...
            if (multiProcessChecks()) {
                while (true) {
                    try {
                        ...
                        long j2 = ((long) i) * BACKOFF_DURATION_MS;
            ...
            if (Build.VERSION.SDK_INT >= 30) {
                ...
                if (historicalProcessExitReasons != null && !historicalProcessExitReasons.isEmpty()) {
                    ...
                    for (int i = 0; i < historicalProcessExitReasons.size(); i++) {
                        ApplicationExitInfo applicationExitInfoM350m = Transition$Impl26$$ExternalSyntheticApiModelOutline0.m350m(historicalProcessExitReasons.get(i));
                        if (applicationExitInfoM350m.getReason() == 10 && applicationExitInfoM350m.getTimestamp() >= lastForceStopEventMillis) {
                            return true;
                        }
                    }
                }
