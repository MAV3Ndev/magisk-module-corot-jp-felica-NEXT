    ...
    private static final class LegacyServiceMapHolder {
        ...
        static {
            ...
            if (Build.VERSION.SDK_INT >= 17) {
                SERVICES.put(DisplayManager.class, Constants.ScionAnalytics.MessageType.DISPLAY_NOTIFICATION);
            ...
            SERVICES.put(AccountManager.class, MfiContentProvider.Accounts.PATH);
