...
public final class DebugProbesImpl {
    ...
    private final Function1<Boolean, Unit> getDynamicAttach() {
        ...
        try {
            ...
            objM613constructorimpl = Result.m613constructorimpl((Function1) TypeIntrinsics.beforeCheckcastToFunctionOfArity(objNewInstance, 1));
        } catch (Throwable th) {
            Result.Companion companion2 = Result.INSTANCE;
            objM613constructorimpl = Result.m613constructorimpl(ResultKt.createFailure(th));
        }
        return (Function1) (Result.m619isFailureimpl(objM613constructorimpl) ? null : objM613constructorimpl);
    }
    ...
    private final <R> List<R> dumpCoroutinesInfoImpl(final Function2<? super CoroutineOwner<?>, ? super CoroutineContext, ? extends R> create) {
        ...
        return SequencesKt.toList(SequencesKt.mapNotNull(SequencesKt.sortedWith(CollectionsKt.asSequence(getCapturedCoroutines()), new DebugProbesImpl$dumpCoroutinesInfoImpl$$inlined$sortedBy$1()), new Function1<CoroutineOwner<?>, R>() { // from class: kotlinx.coroutines.debug.internal.DebugProbesImpl.dumpCoroutinesInfoImpl.3
            /* JADX DEBUG: Multi-variable search result rejected for r1v0, resolved type: kotlin.jvm.functions.Function2<? super kotlinx.coroutines.debug.internal.DebugProbesImpl$CoroutineOwner<?>, ? super kotlin.coroutines.CoroutineContext, ? extends R> */
    ...
    /* JADX DEBUG: Don't trust debug lines info. Repeating lines: [195=9] */
    ...
    private final List<StackTraceElement> enhanceStackTraceWithThreadDumpImpl(String state, Thread thread, List<StackTraceElement> coroutineTrace) {
        ...
        if (Intrinsics.areEqual(state, DebugCoroutineInfoImplKt.RUNNING) && thread != null) {
            try {
                Result.Companion companion = Result.INSTANCE;
                DebugProbesImpl debugProbesImpl = this;
                objM613constructorimpl = Result.m613constructorimpl(thread.getStackTrace());
            } catch (Throwable th) {
                Result.Companion companion2 = Result.INSTANCE;
                objM613constructorimpl = Result.m613constructorimpl(ResultKt.createFailure(th));
            }
            if (Result.m619isFailureimpl(objM613constructorimpl)) {
                objM613constructorimpl = null;
            }
            StackTraceElement[] stackTraceElementArr = (StackTraceElement[]) objM613constructorimpl;
