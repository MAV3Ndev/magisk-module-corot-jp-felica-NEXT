...
public class GpException extends Exception {
    ...
    public GpException(int type, String message, String fwsMessage) {
        this.mResponse = null;
        LogMgr.log(5, "000");
        LogMgr.log(6, "001 : type = " + type);
        LogMgr.log(6, "002 : message = " + message);
        LogMgr.log(6, "003 : fwsMessage = " + fwsMessage);
        this.mType = type;
        this.mErrorMessage = message;
        this.mFwsMessage = fwsMessage;
        LogMgr.log(5, "999");
    }

    public GpException(int type, String message, String fwsMessage, byte[] response) {
        this.mResponse = null;
        LogMgr.log(5, "000");
        LogMgr.log(6, "001 : type = " + type);
        LogMgr.log(6, "002 : message = " + message);
