...
public final class FrameworkSQLiteOpenHelper implements SupportSQLiteOpenHelper {
  ...
  (r4v0 androidx.sqlite.db.SupportSQLiteOpenHelper$Callback)
  (wrap:boolean:?: TERNARY null = ((wrap:int:0x0000: ARITH (r7v0 int) & (8 int) A[WRAPPED]) != (0 int)) ? false : (r5v0 boolean))
  (wrap:boolean:?: TERNARY null = ((wrap:int:0x0006: ARITH (r7v0 int) & (16 int) A[WRAPPED]) != (0 int)) ? false : (r6v0 boolean))
 A[MD:(android.content.Context, java.lang.String, androidx.sqlite.db.SupportSQLiteOpenHelper$Callback, boolean, boolean):void (m)] (LINE:33) call: androidx.sqlite.db.framework.FrameworkSQLiteOpenHelper.<init>(android.content.Context, java.lang.String, androidx.sqlite.db.SupportSQLiteOpenHelper$Callback, boolean, boolean):void type: THIS */
    ...
    static final class OpenHelper extends SQLiteOpenHelper {
        ...
        /* JADX DEBUG: Finally have unexpected throw blocks count: 8, expect 1 */
        ...
        public static final class Companion {
            /* JADX DEBUG: Can't inline method, not implemented redirect type for insn: 0x0000: CONSTRUCTOR  A[MD:():void (m)] call: androidx.sqlite.db.framework.FrameworkSQLiteOpenHelper.OpenHelper.Companion.<init>():void type: THIS */
