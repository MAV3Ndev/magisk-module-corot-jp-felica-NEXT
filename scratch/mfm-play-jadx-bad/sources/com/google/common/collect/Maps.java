...
public final class Maps {
    ...
    static <K, V> Iterator<K> keyIterator(Iterator<Map.Entry<K, V>> it) {
        return new TransformedIterator<Map.Entry<K, V>, K>(it) { // from class: com.google.common.collect.Maps.1
            /* JADX DEBUG: Method merged with bridge method: transform(Ljava/lang/Object;)Ljava/lang/Object; */
    ...
    /* JADX DEBUG: Multi-variable search result rejected for r0v3, resolved type: android.R$anim */
    ...
    static class SortedMapDifferenceImpl<K, V> extends MapDifferenceImpl<K, V> implements SortedMapDifference<K, V> {
        ...
        /* JADX DEBUG: Method merged with bridge method: entriesDiffering()Ljava/util/Map; */
        @Override // com.google.common.collect.Maps.MapDifferenceImpl, com.google.common.collect.MapDifference
        public SortedMap<K, MapDifference.ValueDifference<V>> entriesDiffering() {
            return (SortedMap) super.entriesDiffering();
        }

        /* JADX DEBUG: Method merged with bridge method: entriesInCommon()Ljava/util/Map; */
        @Override // com.google.common.collect.Maps.MapDifferenceImpl, com.google.common.collect.MapDifference
        public SortedMap<K, V> entriesInCommon() {
            return (SortedMap) super.entriesInCommon();
        }

        /* JADX DEBUG: Method merged with bridge method: entriesOnlyOnLeft()Ljava/util/Map; */
        @Override // com.google.common.collect.Maps.MapDifferenceImpl, com.google.common.collect.MapDifference
        public SortedMap<K, V> entriesOnlyOnLeft() {
            return (SortedMap) super.entriesOnlyOnLeft();
        }

        /* JADX DEBUG: Method merged with bridge method: entriesOnlyOnRight()Ljava/util/Map; */
        @Override // com.google.common.collect.Maps.MapDifferenceImpl, com.google.common.collect.MapDifference
    ...
    private static class SortedAsMapView<K, V> extends AsMapView<K, V> implements SortedMap<K, V> {
        ...
        /* JADX DEBUG: Method merged with bridge method: backingSet()Ljava/util/Set; */
        /* JADX INFO: Access modifiers changed from: package-private */
    ...
    static <V2, K, V1> Map.Entry<K, V2> transformEntry(final EntryTransformer<? super K, ? super V1, V2> entryTransformer, final Map.Entry<K, V1> entry) {
        ...
        return new AbstractMapEntry<K, V2>() { // from class: com.google.common.collect.Maps.12
            ...
            /* JADX DEBUG: Multi-variable search result rejected for r0v0, resolved type: com.google.common.collect.Maps$EntryTransformer */
            /* JADX WARN: Multi-variable type inference failed */
            @Override // com.google.common.collect.AbstractMapEntry, java.util.Map.Entry
            @ParametricNullness
            public V2 getValue() {
    ...
    private static class TransformedEntriesNavigableMap<K, V1, V2> extends TransformedEntriesSortedMap<K, V1, V2> implements NavigableMap<K, V2> {
        ...
        /* JADX DEBUG: Method merged with bridge method: fromMap()Ljava/util/SortedMap; */
        /* JADX INFO: Access modifiers changed from: protected */
    ...
    /* JADX DEBUG: Multi-variable search result rejected for r6v0, resolved type: java.util.NavigableMap<K extends java.lang.Comparable<? super K>, V> */
    /* JADX WARN: Multi-variable type inference failed */
