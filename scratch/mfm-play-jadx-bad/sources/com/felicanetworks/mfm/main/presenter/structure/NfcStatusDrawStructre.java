...
public class NfcStatusDrawStructre extends PrimaryDrawStructure {
    protected NfcStatusDrawStructre(StructureType type, boolean isLock, boolean isEnoughExtCardServiceInfo, boolean hasNeverLoggedIn, String mfiAccountName) {
        super(type, isLock, isEnoughExtCardServiceInfo, hasNeverLoggedIn, mfiAccountName);
    }
