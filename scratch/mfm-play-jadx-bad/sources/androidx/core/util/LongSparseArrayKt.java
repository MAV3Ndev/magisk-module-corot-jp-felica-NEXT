...
public final class LongSparseArrayKt {
    ...
    public static final class C00871<T> implements Iterator<T>, KMappedMarker {
        ...
        C00871(LongSparseArray<T> longSparseArray) {
    ...
    public static final <T> Iterator<T> valueIterator(LongSparseArray<T> longSparseArray) {
        return new C00871(longSparseArray);
    }
