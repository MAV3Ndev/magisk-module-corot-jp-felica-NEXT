...
This module installs Mobile FeliCa Client, FeliCa configuration files, Japanese model properties, and Android hardware feature declarations required for Osaifu-Keitai device support and initialization checks.
