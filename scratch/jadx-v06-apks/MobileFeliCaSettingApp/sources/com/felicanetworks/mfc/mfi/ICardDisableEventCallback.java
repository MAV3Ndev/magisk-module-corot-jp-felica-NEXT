...
public interface ICardDisableEventCallback extends IInterface {
    ...
    public static abstract class Stub extends Binder implements ICardDisableEventCallback {
        private static final String DESCRIPTOR = "com.felicanetworks.mfc.mfi.ICardDisableEventCallback";
        ...
        public static ICardDisableEventCallback asInterface(IBinder iBinder) {
            if (iBinder == null) {
                return null;
            }
        ...
        public boolean onTransact(int i, Parcel parcel, Parcel parcel2, int i2) throws RemoteException {
            if (i == 1) {
                ...
                onSuccess(parcel.readInt() != 0 ? CardInfo.CREATOR.createFromParcel(parcel) : null);
                return true;
            }
            if (i == 2) {
                parcel.enforceInterface(DESCRIPTOR);
