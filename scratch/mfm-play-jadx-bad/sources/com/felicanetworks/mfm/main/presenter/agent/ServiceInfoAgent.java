...
public abstract class ServiceInfoAgent extends InfoAgent implements ServiceIdPolicy.ServiceIdHolder {
    ...
    public ServiceInfoAgent(ServiceInfo client) {
        if (client == null) {
            throw new IllegalArgumentException("client is null");
        }
        this._client = client;
        this._linkage = new LinkageAgent(this._client.getLinkage());
    }
    ...
    public static class Point {
        ...
        Point(ServiceInfo.Point client) {
            this._client = client;
        }
        ...
        public static class PointData {
            ...
            PointData(ServiceInfo.Point.PointData client) {
                this._client = client;
            }
    ...
    public static class PostpayEmoney {
        ...
        PostpayEmoney(ServiceInfo.PostpayEmoney client) {
            this._client = client;
        }
    ...
    public static class PrepaidEmoney {
        ...
        PrepaidEmoney(ServiceInfo.PrepaidEmoney client) {
            this._client = client;
        }
