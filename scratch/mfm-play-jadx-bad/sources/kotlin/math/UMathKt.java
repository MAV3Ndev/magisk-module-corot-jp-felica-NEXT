...
public final class UMathKt {
    ...
    private static final int m1881minJ1ME1BU(int i, int i2) {
        return UComparisonsKt.m1817minOfJ1ME1BU(i, i2);
    }

    /* JADX INFO: renamed from: min-eb3DHEI, reason: not valid java name */
    private static final long m1882mineb3DHEI(long j, long j2) {
        return UComparisonsKt.m1825minOfeb3DHEI(j, j2);
    }

    /* JADX INFO: renamed from: max-J1ME1BU, reason: not valid java name */
    private static final int m1879maxJ1ME1BU(int i, int i2) {
        return UComparisonsKt.m1805maxOfJ1ME1BU(i, i2);
    }

    /* JADX INFO: renamed from: max-eb3DHEI, reason: not valid java name */
    private static final long m1880maxeb3DHEI(long j, long j2) {
        return UComparisonsKt.m1813maxOfeb3DHEI(j, j2);
    }
}
