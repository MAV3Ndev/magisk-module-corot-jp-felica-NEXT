...
public interface IUnsupportMfiService1CardExistEventCallback extends IInterface {
    ...
    public static abstract class Stub extends Binder implements IUnsupportMfiService1CardExistEventCallback {
        private static final String DESCRIPTOR = "com.felicanetworks.mfc.mfi.IUnsupportMfiService1CardExistEventCallback";
        ...
        public static IUnsupportMfiService1CardExistEventCallback asInterface(IBinder iBinder) {
            if (iBinder == null) {
                return null;
            }
