...
public final class AWSMobileClient implements AWSCredentialsProvider {
    ...
    class AnonymousClass2 implements Runnable {
        ...
        /* JADX WARN: Removed duplicated region for block: B:30:0x015b A[Catch: all -> 0x02cc, TRY_LEAVE, TryCatch #4 {, blocks: (B:4:0x000b, B:6:0x0012, B:7:0x001d, B:9:0x001f, B:10:0x0023, B:12:0x002d, B:14:0x003d, B:15:0x004f, B:17:0x00a4, B:19:0x00b4, B:21:0x00f8, B:22:0x00ff, B:24:0x013f, B:27:0x014c, B:28:0x0158, B:30:0x015b, B:32:0x0165, B:36:0x018c, B:38:0x01b2, B:39:0x01b9, B:45:0x0237, B:47:0x0241, B:49:0x0249, B:50:0x0278, B:54:0x028b, B:56:0x0291, B:58:0x0297, B:59:0x02a3, B:61:0x02a5, B:62:0x02bb, B:53:0x027f, B:42:0x0228, B:43:0x0234, B:65:0x02be, B:66:0x02ca), top: B:80:0x000b, inners: #0, #1, #2, #3 }] */
        /* JADX WARN: Removed duplicated region for block: B:45:0x0237 A[Catch: all -> 0x02cc, TRY_LEAVE, TryCatch #4 {, blocks: (B:4:0x000b, B:6:0x0012, B:7:0x001d, B:9:0x001f, B:10:0x0023, B:12:0x002d, B:14:0x003d, B:15:0x004f, B:17:0x00a4, B:19:0x00b4, B:21:0x00f8, B:22:0x00ff, B:24:0x013f, B:27:0x014c, B:28:0x0158, B:30:0x015b, B:32:0x0165, B:36:0x018c, B:38:0x01b2, B:39:0x01b9, B:45:0x0237, B:47:0x0241, B:49:0x0249, B:50:0x0278, B:54:0x028b, B:56:0x0291, B:58:0x0297, B:59:0x02a3, B:61:0x02a5, B:62:0x02bb, B:53:0x027f, B:42:0x0228, B:43:0x0234, B:65:0x02be, B:66:0x02ca), top: B:80:0x000b, inners: #0, #1, #2, #3 }] */
        /* JADX WARN: Removed duplicated region for block: B:72:0x0241 A[EXC_TOP_SPLITTER, SYNTHETIC] */
            ...
            synchronized (AWSMobileClient.this.initLockObject) {
                ...
                try {
                    if (this.val$awsConfiguration.optJsonObject(AWSMobileClient.AUTH_KEY) != null && this.val$awsConfiguration.optJsonObject(AWSMobileClient.AUTH_KEY).has("Persistence")) {
                        ...
                        if (this.val$awsConfiguration.optJsonObject("CredentialsProvider") == null) {
                            jSONObjectOptJsonObject = this.val$awsConfiguration.optJsonObject(AWSMobileClient.USER_POOLS);
                        ...
                        AWSMobileClient.this.mContext = this.val$context.getApplicationContext();
                        AWSMobileClient.this.mStore = new AWSMobileClientStore(AWSMobileClient.this);
                        final IdentityManager identityManager2 = new IdentityManager(AWSMobileClient.this.mContext);
                        identityManager2.enableFederation(false);
                        identityManager2.setConfiguration(this.val$awsConfiguration);
                        identityManager2.setPersistenceEnabled(AWSMobileClient.this.mIsPersistenceEnabled);
                        IdentityManager.setDefaultIdentityManager(identityManager2);
                        AWSMobileClient.this.registerConfigSignInProviders(this.val$awsConfiguration);
                        identityManager2.addSignInStateChangeListener(new SignInStateChangeListener() { // from class: com.amazonaws.mobile.client.AWSMobileClient.2.1
                            @Override // com.amazonaws.mobile.auth.core.SignInStateChangeListener
                            public void onUserSignedIn() {
                                Log.d(AWSMobileClient.TAG, "onUserSignedIn: Updating user state from drop-in UI");
                                AWSMobileClient.this.signInState = SignInState.DONE;
                                com.amazonaws.mobile.auth.core.IdentityProvider currentIdentityProvider = identityManager2.getCurrentIdentityProvider();
                                String token = currentIdentityProvider.getToken();
                                AWSMobileClient.this.federatedSignInWithoutAssigningState(currentIdentityProvider.getCognitoLoginKey(), token, new Callback<UserStateDetails>() { // from class: com.amazonaws.mobile.client.AWSMobileClient.2.1.1
                                    /* JADX DEBUG: Method merged with bridge method: onResult(Ljava/lang/Object;)V */
                                    @Override // com.amazonaws.mobile.client.Callback
                        ...
                        if (this.val$awsConfiguration.optJsonObject("CredentialsProvider") == null && this.val$awsConfiguration.optJsonObject("CredentialsProvider").optJSONObject("CognitoIdentity") != null) {
                            ...
                            if (jSONObjectOptJsonObject != null) {
                                try {
                                    ...
                                    String strOptString2 = jSONObjectOptJsonObject.optString("PinpointAppId");
                                    String str = strOptString2.equals("") ? null : strOptString2;
                                    String strOptString3 = jSONObjectOptJsonObject.optString(AWSMobileClient.COGNITO_USERPOOL_CUSTOM_ENDPOINT);
                                    ...
                                    AWSMobileClient.this.userpoolsLoginKey = String.format("cognito-idp.%s.amazonaws.com/%s", jSONObjectOptJsonObject.getString("Region"), jSONObjectOptJsonObject.getString("PoolId"));
                                    AWSMobileClient.this.userpool = new CognitoUserPool(AWSMobileClient.this.mContext, AWSMobileClient.this.mUserPoolPoolId, string3, strOptString, AWSMobileClient.this.userpoolLL, str, strOptString3);
                                    AWSMobileClient.this.userpool.setPersistenceEnabled(AWSMobileClient.this.mIsPersistenceEnabled);
                                    AWSMobileClient aWSMobileClient = AWSMobileClient.this;
                                    AWSMobileClient aWSMobileClient2 = AWSMobileClient.this;
                                    aWSMobileClient.mDeviceOperations = new DeviceOperations(aWSMobileClient2, aWSMobileClient2.userpoolLL);
                                    hostedUIJSON = AWSMobileClient.this.getHostedUIJSON(this.val$awsConfiguration);
                                    if (hostedUIJSON != null) {
                                        try {
                                            ...
                                            this.val$callback.onError(new RuntimeException("Failed to initialize OAuth, please check your awsconfiguration.json", e2));
                                        }
                                    }
                            ...
                            AWSMobileClient.this.awsConfiguration = this.val$awsConfiguration;
                            UserStateDetails userStateDetails2 = AWSMobileClient.this.getUserStateDetails(true);
                            this.val$callback.onResult(userStateDetails2);
    ...
    protected void setUserState(final UserStateDetails userStateDetails) {
        boolean zEquals = userStateDetails.equals(this.userStateDetails);
    ...
    /* JADX DEBUG: Don't trust debug lines info. Repeating lines: [1006=4] */
    protected boolean waitForSignIn() {
        try {
            try {
                ...
                int i = AnonymousClass29.$SwitchMap$com$amazonaws$mobile$client$UserState[userStateDetails.getUserState().ordinal()];
                if (i == 1) {
    ...
    protected UserStateDetails getUserStateDetails(boolean z) {
        ...
        if (z || !isNetworkAvailable(this.mContext)) {
            ...
            if (str_getCachedIdentityId != null) {
    ...
    boolean isFederationEnabled() {
        ...
        if (str != null) {
            return str.equals(CredentialEntry.TRUE_STRING);
        }
        return true;
    }
    ...
    public void signIn(String str, String str2, Map<String, String> map, Callback<SignInResult> callback) {
        signIn(str, str2, map, Collections.EMPTY_MAP, callback);
    }
    ...
    public SignInResult signIn(String str, String str2, Map<String, String> map) throws Exception {
        return signIn(str, str2, map, Collections.EMPTY_MAP);
    }
                ...
                try {
                    AWSMobileClient.this.userpool.getUser(str).getSession(map2, new AuthenticationHandler() { // from class: com.amazonaws.mobile.client.AWSMobileClient.6.1
                        ...
                        public void getAuthenticationDetails(AuthenticationContinuation authenticationContinuation, String str3) {
                            ...
                            try {
                                String strName = authFlowType != null ? authFlowType.name() : null;
                                if (strName == null && z) {
                                ...
                                if (strName != null && CognitoServiceConstants.AUTH_TYPE_INIT_CUSTOM_AUTH.equals(strName)) {
                                    if (str2 != null) {
                                        authenticationContinuation.setAuthenticationDetails(new AuthenticationDetails(str, str2, map3, map));
                                    } else {
                                        authenticationContinuation.setAuthenticationDetails(new AuthenticationDetails(str, map3, (Map<String, String>) map));
                                    }
                                } else if (strName == null || !CognitoServiceConstants.AUTH_TYPE_INIT_USER_PASSWORD.equals(strName)) {
    ...
    public void confirmSignIn(String str, Callback<SignInResult> callback) {
        confirmSignIn(str, Collections.EMPTY_MAP, callback);
    }

    public void confirmSignIn(String str, Map<String, String> map, Callback<SignInResult> callback) {
        InternalCallback internalCallback = new InternalCallback(callback);
        internalCallback.async(_confirmSignIn(str, map, Collections.EMPTY_MAP, internalCallback));
    }
    ...
    public SignInResult confirmSignIn(String str) throws Exception {
        return confirmSignIn(str, Collections.EMPTY_MAP);
    }

    public SignInResult confirmSignIn(String str, Map<String, String> map) throws Exception {
        InternalCallback internalCallback = new InternalCallback();
        return (SignInResult) internalCallback.await(_confirmSignIn(str, map, Collections.EMPTY_MAP, internalCallback));
    }
                ...
                if (signOutOptions.isInvalidateTokens()) {
                    ...
                    if (AWSMobileClient.this.hostedUI != null) {
                        ...
                        if (AWSMobileClient.this.getHostedUIJSON().optString("SignOutRedirectURI", null) != null) {
                            builderBuildUpon.appendQueryParameter("redirect_uri", AWSMobileClient.this.getHostedUIJSON().getString("SignOutRedirectURI"));
                        }
    ...
    private Runnable _deleteUser(final Callback<Void> callback) {
        return new Runnable() { // from class: com.amazonaws.mobile.client.AWSMobileClient$$ExternalSyntheticLambda1
            /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 0 */
            @Override // java.lang.Runnable
            public final void run() {
                this.f$0.m384lambda$_deleteUser$0$comamazonawsmobileclientAWSMobileClient(callback);
            }
        };
    }

    /* JADX INFO: renamed from: lambda$_deleteUser$0$com-amazonaws-mobile-client-AWSMobileClient, reason: not valid java name */
    /* synthetic */ void m384lambda$_deleteUser$0$comamazonawsmobileclientAWSMobileClient(final Callback callback) {
        CognitoUserPool cognitoUserPool = this.userpool;
        if (cognitoUserPool == null) {
    ...
    private Runnable _federatedSignIn(final String str, final String str2, FederatedSignInOptions federatedSignInOptions, final Callback<UserStateDetails> callback, final boolean z) {
        ...
        try {
            ...
            map2.put("token", str2);
            map2.put(FEDERATION_ENABLED_KEY, CredentialEntry.TRUE_STRING);
        ...
        return new Runnable() { // from class: com.amazonaws.mobile.client.AWSMobileClient.12
            ...
            public void run() {
                ...
                if (AWSMobileClient.this.getSignInMode().equals(SignInMode.HOSTED_UI)) {
                    AWSMobileClient.this.m385xbee9af4a(callback);
                    return;
                }
                ...
                try {
                    AWSMobileClient.this.userpool.getCurrentUser().getSession(Collections.EMPTY_MAP, new AuthenticationHandler() { // from class: com.amazonaws.mobile.client.AWSMobileClient.12.1
                        @Override // com.amazonaws.mobileconnectors.cognitoidentityprovider.handlers.AuthenticationHandler
                        public void onSuccess(CognitoUserSession cognitoUserSession, CognitoDevice cognitoDevice) {
                            try {
                                AWSMobileClient.this.mCognitoUserSession = cognitoUserSession;
    ...
    private Tokens getHostedUITokens() throws Exception {
        ...
        return (Tokens) internalCallback.await(new Runnable() { // from class: com.amazonaws.mobile.client.AWSMobileClient$$ExternalSyntheticLambda0
            /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 0 */
            @Override // java.lang.Runnable
            public final void run() {
                this.f$0.m385xbee9af4a(internalCallback);
            }
        });
    }

    /* JADX DEBUG: Method merged with bridge method: lambda$getHostedUITokens$1$com-amazonaws-mobile-client-AWSMobileClient(Lcom/amazonaws/mobile/client/internal/InternalCallback;)V */
    /* JADX INFO: Access modifiers changed from: private */
    /* JADX INFO: renamed from: _getHostedUITokens, reason: merged with bridge method [inline-methods] */
    public void m385xbee9af4a(final Callback<Tokens> callback) {
    ...
    public void signUp(String str, String str2, Map<String, String> map, Map<String, String> map2, Callback<SignUpResult> callback) {
        InternalCallback internalCallback = new InternalCallback(callback);
        internalCallback.async(_signUp(str, str2, map, map2, Collections.EMPTY_MAP, internalCallback));
    }

    public SignUpResult signUp(String str, String str2, Map<String, String> map, Map<String, String> map2) throws Exception {
        InternalCallback internalCallback = new InternalCallback();
        return (SignUpResult) internalCallback.await(_signUp(str, str2, map, map2, Collections.EMPTY_MAP, internalCallback));
    }
    ...
    public void confirmSignUp(String str, String str2, Callback<SignUpResult> callback) {
        InternalCallback internalCallback = new InternalCallback(callback);
        internalCallback.async(_confirmSignUp(str, str2, Collections.EMPTY_MAP, internalCallback));
    }

    public SignUpResult confirmSignUp(String str, String str2) throws Exception {
        InternalCallback internalCallback = new InternalCallback();
        return (SignUpResult) internalCallback.await(_confirmSignUp(str, str2, Collections.EMPTY_MAP, internalCallback));
    }
    ...
    public void resendSignUp(String str, Callback<SignUpResult> callback) {
        resendSignUp(str, Collections.EMPTY_MAP, callback);
    }
    ...
    public SignUpResult resendSignUp(String str) throws Exception {
        return resendSignUp(str, Collections.EMPTY_MAP);
    }
    ...
    public void forgotPassword(String str, Callback<ForgotPasswordResult> callback) {
        InternalCallback internalCallback = new InternalCallback(callback);
        internalCallback.async(_forgotPassword(str, Collections.EMPTY_MAP, internalCallback));
    }

    public ForgotPasswordResult forgotPassword(String str) throws Exception {
        InternalCallback internalCallback = new InternalCallback();
        return (ForgotPasswordResult) internalCallback.await(_forgotPassword(str, Collections.EMPTY_MAP, internalCallback));
    }
    ...
    public void confirmForgotPassword(String str, String str2, Callback<ForgotPasswordResult> callback) {
        InternalCallback internalCallback = new InternalCallback(callback);
        internalCallback.async(_confirmForgotPassword(str, str2, Collections.EMPTY_MAP, internalCallback));
    }
    ...
    public void confirmForgotPassword(String str, String str2, String str3, final Callback<ForgotPasswordResult> callback) {
        ...
        internalCallback.async(_confirmForgotPassword(str2, str3, Collections.EMPTY_MAP, internalCallback));
    }

    public ForgotPasswordResult confirmForgotPassword(String str, String str2) throws Exception {
        InternalCallback internalCallback = new InternalCallback();
        return (ForgotPasswordResult) internalCallback.await(_confirmForgotPassword(str, str2, Collections.EMPTY_MAP, internalCallback));
    }
    ...
    public void updateUserAttributes(Map<String, String> map, Callback<List<UserCodeDeliveryDetails>> callback) {
        updateUserAttributes(map, Collections.EMPTY_MAP, callback);
    }
    ...
    public List<UserCodeDeliveryDetails> updateUserAttributes(Map<String, String> map) throws Exception {
        return updateUserAttributes(map, Collections.EMPTY_MAP);
    }
    ...
    public void verifyUserAttribute(String str, Callback<UserCodeDeliveryDetails> callback) {
        verifyUserAttribute(str, Collections.EMPTY_MAP, callback);
    }
    ...
    public UserCodeDeliveryDetails verifyUserAttribute(String str) throws Exception {
        return verifyUserAttribute(str, Collections.EMPTY_MAP);
    }
    ...
    class AnonymousClass26 implements Runnable {
        ...
        AnonymousClass26(SignInUIOptions signInUIOptions, Callback callback) {
        ...
        public void run() {
            ...
            if (federationEnabled != null) {
                ...
                AWSMobileClient.this.mStore.set(AWSMobileClient.FEDERATION_ENABLED_KEY, CredentialEntry.TRUE_STRING);
            }
            ...
            try {
                ...
                if (hostedUIOptions.getSignInQueryParameters() != null) {
                    for (Map.Entry<String, String> entry2 : hostedUIOptions.getSignInQueryParameters().entrySet()) {
                        builderBuildUpon.appendQueryParameter(entry2.getKey(), entry2.getValue());
                    }
                }
                builderBuildUpon.appendQueryParameter("redirect_uri", hostedUIJSONFromJSON.getString("SignInRedirectURI"));
                builderBuildUpon.appendQueryParameter(OAuth2Constants.SCOPES, hostedUIJSONFromJSON.getJSONArray("Scopes").join(" "));
                builderBuildUpon.appendQueryParameter(SharedPrefsProvider.NotifyClientLogContents.Setting.CLIENT_ID, hostedUIJSONFromJSON.getString("AppClientId"));
                HashMap map = new HashMap();
                try {
                    Uri uri = Uri.parse(hostedUIJSONFromJSON.getString("TokenURI"));
                    map.put(SharedPrefsProvider.NotifyClientLogContents.Setting.CLIENT_ID, hostedUIJSONFromJSON.getString("AppClientId"));
                    map.put("redirect_uri", hostedUIJSONFromJSON.getString("SignInRedirectURI"));
                    AWSMobileClient.this.mOAuth2Client.authorize(builderBuildUpon.build(), new AnonymousClass1(uri, map, hostedUIOptions));
                } catch (Exception e2) {
                    throw new RuntimeException("Failed to construct tokens url for OAuth", e2);
                }
            } catch (Exception e3) {
                throw new RuntimeException("Failed to construct authorization url for OAuth", e3);
            }
        }
            ...
            public void onResult(AuthorizeResponse authorizeResponse) {
                ...
                AWSMobileClient.this.mOAuth2Client.requestTokens(this.val$tokensUri, new HashMap(), this.val$tokensBody, authorizeResponse.getCode(), new Callback<OAuth2Tokens>() { // from class: com.amazonaws.mobile.client.AWSMobileClient.26.1.1
                    ...
                    public void onResult(OAuth2Tokens oAuth2Tokens) {
                        if (AWSMobileClient.this.isFederationEnabled()) {
                            AWSMobileClient.this.federatedSignInWithoutAssigningState(AnonymousClass1.this.val$hostedUIOptions.getFederationProviderName(), oAuth2Tokens.getIdToken(), new Callback<UserStateDetails>() { // from class: com.amazonaws.mobile.client.AWSMobileClient.26.1.1.1
                                /* JADX DEBUG: Method merged with bridge method: onResult(Ljava/lang/Object;)V */
                                @Override // com.amazonaws.mobile.client.Callback
                                public void onResult(UserStateDetails userStateDetails) {
    ...
    class AnonymousClass27 implements Runnable {
        ...
        AnonymousClass27(SignInUIOptions signInUIOptions, Callback callback, Activity activity) {
            this.val$signInUIOptions = signInUIOptions;
            this.val$callback = callback;
            ...
            try {
                ...
                hostedUI.setPersistenceEnabled(AWSMobileClient.this.mIsPersistenceEnabled).setAuthHandler(new AuthHandler() { // from class: com.amazonaws.mobile.client.AWSMobileClient.27.1
                    ...
                    public void onSuccess(AuthUserSession authUserSession) {
                        ...
                        if (AWSMobileClient.this.isFederationEnabled()) {
                            AWSMobileClient.this.federatedSignInWithoutAssigningState(AWSMobileClient.this.userpoolsLoginKey, authUserSession.getIdToken().getJWTToken(), new Callback<UserStateDetails>() { // from class: com.amazonaws.mobile.client.AWSMobileClient.27.1.1
                                /* JADX DEBUG: Method merged with bridge method: onResult(Ljava/lang/Object;)V */
                                @Override // com.amazonaws.mobile.client.Callback
                                public void onResult(UserStateDetails userStateDetails) {
                ...
                throw new RuntimeException("Failed to construct HostedUI from awsconfiguration.json", e3);
            }
        }
    }
    ...
    private boolean isConfigurationKeyPresent(String str, AWSConfiguration aWSConfiguration) {
        try {
            ...
            if (jSONObjectOptJsonObject != null) {
                if (jSONObjectOptJsonObject.getString(GOOGLE_WEBAPP_CONFIG_KEY) != null) {
                    return true;
                }
            }
            return false;
