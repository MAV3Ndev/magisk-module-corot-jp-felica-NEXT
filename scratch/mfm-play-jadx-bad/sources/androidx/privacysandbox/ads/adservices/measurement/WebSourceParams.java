...
public final class WebSourceParams {
    ...
    public static final class Companion {
        /* JADX DEBUG: Can't inline method, not implemented redirect type for insn: 0x0000: CONSTRUCTOR  A[MD:():void (m)] call: androidx.privacysandbox.ads.adservices.measurement.WebSourceParams.Companion.<init>():void type: THIS */
        ...
        public final List<android.adservices.measurement.WebSourceParams> convertWebSourceParams$ads_adservices_release(List<WebSourceParams> request) {
            ...
            for (WebSourceParams webSourceParams : request) {
                Transition$Impl26$$ExternalSyntheticApiModelOutline0.m358m$1();
                android.adservices.measurement.WebSourceParams webSourceParamsBuild = Transition$Impl26$$ExternalSyntheticApiModelOutline0.m339m(webSourceParams.getRegistrationUri()).setDebugKeyAllowed(webSourceParams.getDebugKeyAllowed()).build();
