...
public class ViewTransition {
    ...
    */
            ...
            while (eventType != 1) {
                if (eventType == 2) {
                    ...
                    switch (name.hashCode()) {
                        case -1962203927:
                            b = !name.equals(CONSTRAINT_OVERRIDE) ? (byte) -1 : (byte) 2;
                            break;
                        case -1239391468:
    ...
    /* synthetic */ void m69x14d7500(View[] viewArr) {
        if (this.mSetsTag != -1) {
            for (View view : viewArr) {
    ...
    private void updateTransition(MotionScene.Transition transition, View view) {
        ...
        if (keyFrames != null) {
            ...
            while (it.hasNext()) {
                keyFrames2.addKey(it.next().mo68clone().setViewId(id));
            }
