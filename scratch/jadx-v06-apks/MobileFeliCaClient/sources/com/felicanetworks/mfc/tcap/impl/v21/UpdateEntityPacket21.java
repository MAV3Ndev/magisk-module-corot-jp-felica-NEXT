...
class UpdateEntityPacket21 extends Packet {
    static final int MID_FINISHED = 0;
    static final int MID_SELECTED_FELICA_DEVICE = 259;
    static final int MID_SELECT_INTERNAL_FELICA = 257;
    ...
    UpdateEntityPacket21() {
        super(TcapSession21.TCAP_VERSION_21, (byte) 5);
    }

    UpdateEntityPacket21(Packet packet) {
        super(packet);
    }
        ...
        while (size < this.mOffset + this.mSize) {
            ...
            if (id != 0) {
                if (id == 1) {
                    ...
                    if (id != MID_SELECT_INTERNAL_FELICA) {
                        if (id == MID_SET_FELICA_TIMEOUT) {
                        ...
                        } else if (id == MID_SET_RETRY_COUNT && (internalDeviceList.getById(message.getDeviceId()) instanceof FeliCaChipWrapper)) {
