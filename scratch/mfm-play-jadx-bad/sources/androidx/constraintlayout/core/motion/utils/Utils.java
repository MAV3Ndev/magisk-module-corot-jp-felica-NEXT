...
public class Utils {
    ...
    public static void log(String str) {
        ...
        String str2 = ".(" + stackTraceElement.getFileName() + ":" + stackTraceElement.getLineNumber() + ")" + ServicePreference.ICCODE_DEFAULT.substring(Integer.toString(stackTraceElement.getLineNumber()).length()) + strSubstring;
