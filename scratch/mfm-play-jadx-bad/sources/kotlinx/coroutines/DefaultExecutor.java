...
public final class DefaultExecutor extends EventLoopImplBase implements Runnable {
    ...
    /* JADX DEBUG: Another duplicated slice has different insns count: {[SPUT, INVOKE, INVOKE]}, finally: {[SPUT, INVOKE, INVOKE, INVOKE, IF, INVOKE, INVOKE, INVOKE, IF] complete} */
    /* JADX DEBUG: Don't trust debug lines info. Repeating lines: [128=4, 130=4, 126=4, 127=4] */
