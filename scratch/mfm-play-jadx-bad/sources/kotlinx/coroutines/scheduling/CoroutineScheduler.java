...
public final class CoroutineScheduler implements Executor, Closeable {
  ...
  (r7v0 int)
  (r8v0 int)
  (wrap:long:0x0006: TERNARY null = ((wrap:int:0x0000: ARITH (r12v0 int) & (4 int) A[WRAPPED]) != (0 int)) ? (wrap:long:0x0004: SGET  A[WRAPPED] (LINE:95) kotlinx.coroutines.scheduling.TasksKt.IDLE_WORKER_KEEP_ALIVE_NS long) : (r9v0 long))
  (wrap:java.lang.String:?: TERNARY null = ((wrap:int:0x0007: ARITH (r12v0 int) & (8 int) A[WRAPPED]) != (0 int)) ? (wrap:java.lang.String:0x000b: SGET  A[WRAPPED] (LINE:96) kotlinx.coroutines.scheduling.TasksKt.DEFAULT_SCHEDULER_NAME java.lang.String) : (r11v0 java.lang.String))
 A[MD:(int, int, long, java.lang.String):void (m)] (LINE:92) call: kotlinx.coroutines.scheduling.CoroutineScheduler.<init>(int, int, long, java.lang.String):void type: THIS */
    ...
    */
    ...
    /* JADX DEBUG: Don't trust debug lines info. Repeating lines: [562=19] */
