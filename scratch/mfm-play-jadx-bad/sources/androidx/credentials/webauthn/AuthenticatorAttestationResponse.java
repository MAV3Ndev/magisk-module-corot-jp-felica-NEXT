...
public final class AuthenticatorAttestationResponse implements AuthenticatorResponse {
  ...
  (r2v0 androidx.credentials.webauthn.PublicKeyCredentialCreationOptions)
  (r3v0 byte[])
  (r4v0 byte[])
 ...
 A[MD:(androidx.credentials.webauthn.PublicKeyCredentialCreationOptions, byte[], byte[], java.lang.String, boolean, boolean, boolean, boolean, java.lang.String, byte[]):void throws org.json.JSONException (m)] (LINE:25) call: androidx.credentials.webauthn.AuthenticatorAttestationResponse.<init>(androidx.credentials.webauthn.PublicKeyCredentialCreationOptions, byte[], byte[], java.lang.String, boolean, boolean, boolean, boolean, java.lang.String, byte[]):void type: THIS */
