...
public abstract class AbstractMap<K, V> implements Map<K, V>, KMappedMarker {
    ...
    public Set<K> getKeys() {
        if (this._keys == null) {
            this._keys = new AbstractSet<K>(this) { // from class: kotlin.collections.AbstractMap$keys$1
                ...
                /* JADX DEBUG: Multi-variable search result rejected for r1v0, resolved type: kotlin.collections.AbstractMap<K, ? extends V> */
                /* JADX WARN: Multi-variable type inference failed */
                {
                    this.this$0 = this;
                }
    ...
    public static final class Companion {
        /* JADX DEBUG: Can't inline method, not implemented redirect type for insn: 0x0000: CONSTRUCTOR  A[MD:():void (m)] call: kotlin.collections.AbstractMap.Companion.<init>():void type: THIS */
