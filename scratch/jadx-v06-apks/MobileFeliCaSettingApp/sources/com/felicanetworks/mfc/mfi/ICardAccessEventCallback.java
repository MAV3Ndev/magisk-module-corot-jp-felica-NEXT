...
public interface ICardAccessEventCallback extends IInterface {
    ...
    public static abstract class Stub extends Binder implements ICardAccessEventCallback {
        private static final String DESCRIPTOR = "com.felicanetworks.mfc.mfi.ICardAccessEventCallback";
        ...
        public static ICardAccessEventCallback asInterface(IBinder iBinder) {
            if (iBinder == null) {
                return null;
            }
