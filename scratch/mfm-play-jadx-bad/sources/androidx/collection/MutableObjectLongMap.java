...
public final class MutableObjectLongMap<K> extends ObjectLongMap<K> {
 ...
 A[MD:(int):void (m)] (LINE:693) call: androidx.collection.MutableObjectLongMap.<init>(int):void type: THIS */
    ...
    /* JADX DEBUG: Multi-variable search result rejected for r14v0, resolved type: androidx.collection.MutableObjectLongMap<K> */
    ...
    /* JADX DEBUG: Multi-variable search result rejected for r13v0, resolved type: androidx.collection.MutableObjectLongMap<K> */
    /* JADX WARN: Multi-variable type inference failed */
