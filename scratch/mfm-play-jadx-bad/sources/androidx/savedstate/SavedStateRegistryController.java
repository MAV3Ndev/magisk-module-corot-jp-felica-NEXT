...
public final class SavedStateRegistryController {
    ...
    /* JADX DEBUG: Can't inline method, not implemented redirect type for insn: 0x0000: CONSTRUCTOR (r1v0 androidx.savedstate.SavedStateRegistryOwner) A[MD:(androidx.savedstate.SavedStateRegistryOwner):void (m)] call: androidx.savedstate.SavedStateRegistryController.<init>(androidx.savedstate.SavedStateRegistryOwner):void type: THIS */
    ...
    public static final class Companion {
        /* JADX DEBUG: Can't inline method, not implemented redirect type for insn: 0x0000: CONSTRUCTOR  A[MD:():void (m)] call: androidx.savedstate.SavedStateRegistryController.Companion.<init>():void type: THIS */
