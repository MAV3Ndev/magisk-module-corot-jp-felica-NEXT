...
public final class MaterialContainerTransform extends Transition {
    ...
    public Animator createAnimator(ViewGroup viewGroup, TransitionValues transitionValues, TransitionValues transitionValues2) {
        ...
        if (transitionValues != null && transitionValues2 != null) {
            ...
            if (rectF == null || shapeAppearanceModel == null) {
                ...
                RectF rectFCalculateDrawableBounds = calculateDrawableBounds(viewFindAncestorById, view3, f, f2);
                rectF.offset(f, f2);
                rectF2.offset(f, f2);
    ...
    private static final class TransitionDrawable extends Drawable {
        ...
        private void updateProgress(float f) {
            ...
            float fLerp = TransitionUtils.lerp(this.startElevation, this.endElevation, f);
            this.currentElevation = fLerp;
            this.shadowPaint.setShadowLayer(fLerp, 0.0f, fLerp, SHADOW_COLOR);
            ...
            float fLerp2 = TransitionUtils.lerp(0.0f, 1.0f, fFloatValue, fFloatValue2, f);
            if (!zShouldMaskStartBounds) {
                fLerp2 = 1.0f - fLerp2;
            }
            this.fitModeEvaluator.applyMask(rectF, fLerp2, this.fitModeResult);
