...
public final class TypeResolver {
    ...
    public static <T> T expectArgument(Class<T> cls, Object obj) {
        try {
            ...
            StringBuilder sb = new StringBuilder(String.valueOf(strValueOf).length() + 10 + String.valueOf(simpleName).length());
            sb.append(strValueOf);
            sb.append(" is not a ");
    ...
    private static class WildcardCapturer {
        ...
        TypeVariable<?> captureAsTypeVariable(Type[] typeArr) {
            ...
            StringBuilder sb = new StringBuilder(String.valueOf(strJoin).length() + 33);
            sb.append("capture#");
