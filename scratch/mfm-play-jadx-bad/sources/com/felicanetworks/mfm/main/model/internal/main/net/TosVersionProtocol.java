...
public class TosVersionProtocol extends VersionUpProtocol {
    ...
    public static class Parameter extends VersionUpProtocol.Parameter {
        public Parameter(int offlineCheckActualCnt, int offlineCheckMaxCnt, int offlineCheckInterval, int actualOfflineCheckInterval, int tosVersion) {
            super(offlineCheckActualCnt, offlineCheckMaxCnt, offlineCheckInterval, actualOfflineCheckInterval);
            this.appId = (String) Sg.getValue(Sg.Key.NET_TOS_APP_ID);
            this.appVersion = String.format(Locale.US, "0.0.%d", Integer.valueOf(tosVersion));
        }
    }
    ...
    public static class Result {
        ...
        public Result(int offlineCheckMaxCnt, int offlineCheckInterval, int versionupInfo, int networkMode) {
            this.maxCount = offlineCheckMaxCnt;
            this.interval = offlineCheckInterval;
            this.status = versionupInfo;
            this.version = networkMode;
        }
    ...
    TosVersionProtocol(NetworkExpert net) {
        super(net);
    }
}
