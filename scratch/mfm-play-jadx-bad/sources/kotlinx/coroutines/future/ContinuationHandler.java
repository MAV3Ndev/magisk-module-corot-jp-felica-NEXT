...
final class ContinuationHandler<T> implements BiFunction<T, Throwable, Unit> {
    ...
    public void apply2(T result, Throwable exception) {
        ...
        if (exception == null) {
            ...
            continuation.resumeWith(Result.m613constructorimpl(result));
            return;
        }
        CompletionException completionExceptionM1972m = StreamsKt$$ExternalSyntheticApiModelOutline0.m1976m((Object) exception) ? StreamsKt$$ExternalSyntheticApiModelOutline0.m1972m((Object) exception) : null;
        if (completionExceptionM1972m != null && (cause = completionExceptionM1972m.getCause()) != null) {
            exception = cause;
        }
        Result.Companion companion2 = Result.INSTANCE;
        continuation.resumeWith(Result.m613constructorimpl(ResultKt.createFailure(exception)));
    }
}
