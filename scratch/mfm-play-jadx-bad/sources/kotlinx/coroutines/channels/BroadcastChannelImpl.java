...
public final class BroadcastChannelImpl<E> extends BufferedChannel<E> implements BroadcastChannel<E> {
    ...
    @DebugMetadata(c = "kotlinx.coroutines.channels.BroadcastChannelImpl", f = "BroadcastChannel.kt", i = {0, 0}, l = {BaseMfiEventCallback.TYPE_INVALID_KEY_VERSION}, m = "send", n = {"this", "element"}, s = {"L$0", "L$1"})
    ...
    /* JADX DEBUG: Class process forced to load method for inline: kotlinx.coroutines.channels.BroadcastChannelKt.access$getNO_ELEMENT$p():kotlinx.coroutines.internal.Symbol */
        ...
        try {
            ...
            if (!isClosedForSend() || this.lastConflatedElement != BroadcastChannelKt.NO_ELEMENT) {
                if (this.lastConflatedElement != BroadcastChannelKt.NO_ELEMENT) {
                    subscriberConflated.mo2169trySendJP2dKIU(getValue());
                }
    ...
    /* JADX DEBUG: Multi-variable search result rejected for r2v7, resolved type: kotlinx.coroutines.channels.BufferedChannel */
    ...
    */
    public Object send(E e, Continuation<? super Unit> continuation) throws Throwable {
        ...
        if (i == 0) {
            ...
            broadcastChannelImpl = (BroadcastChannelImpl) anonymousClass1.L$0;
            ResultKt.throwOnFailure(obj2);
    ...
    public Object mo2169trySendJP2dKIU(E element) {
        ...
        try {
            if (isClosedForSend()) {
                return super.mo2169trySendJP2dKIU(element);
            }
            List<? extends BufferedChannel<E>> list = this.subscribers;
            ...
            while (it2.hasNext()) {
                ((BufferedChannel) it2.next()).mo2169trySendJP2dKIU(element);
            }
    ...
    private final class SubscriberBuffered extends BufferedChannel<E> {
        ...
        /* JADX DEBUG: Method merged with bridge method: cancelImpl$kotlinx_coroutines_core(Ljava/lang/Throwable;)Z */
        @Override // kotlinx.coroutines.channels.BufferedChannel
    ...
    /* JADX DEBUG: Don't trust debug lines info. Repeating lines: [408=5] */
    @Override // kotlinx.coroutines.channels.BufferedChannel
