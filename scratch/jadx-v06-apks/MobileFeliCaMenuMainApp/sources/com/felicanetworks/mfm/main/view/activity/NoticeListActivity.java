...
public class NoticeListActivity extends DrawerBaseActivity {
    ...
    public void onCreate(Bundle bundle) {
        try {
            ...
            if (supportActionBar != null) {
                supportActionBar.setTitle(R.string.toolbar_title_notice);
            }
    ...
    public boolean onOptionsItemSelected(MenuItem menuItem) {
        try {
            ...
            Structure currentRequest = getCurrentRequest();
            if (currentRequest != null && (currentRequest instanceof NoticeListDrawStructure) && itemId == R.id.tool_lock) {
                AnalysisManager.stamp(MfmStamp.Event.ACTION_LOCK_SETTING, new Object[0]);
                if (Settings.DeviceType.GP == Settings.getDeviceType()) {
                    try {
                        startActivity(((NoticeListDrawStructure) currentRequest).getDefaultIntent(PrimaryDrawStructure.LinkType.SCREEN_LOCK_SETTING));
                    ...
                    ((NoticeListDrawStructure) currentRequest).actLock();
                }
            }
        } catch (Exception e) {
            notifyException(e);
    ...
    protected void dispatchStructure(Structure structure) {
        switch (AnonymousClass1.$SwitchMap$com$felicanetworks$mfm$main$presenter$structure$StructureType[structure.getType().ordinal()]) {
            case 1:
                ...
                if (fragmentFindFragmentById instanceof NoticeListFragment) {
                    ((NoticeListFragment) fragmentFindFragmentById).onResume();
                }
                break;
            case 2:
    ...
    public DrawerContentsLayout.OnSelectDrawerItemListener.DrawerBehavior onSelect(DrawerContentsLayout.DrawerItemType drawerItemType) {
        ...
        try {
            Structure currentRequest = getCurrentRequest();
            if (currentRequest != null && (currentRequest instanceof NoticeListDrawStructure)) {
                NoticeListDrawStructure noticeListDrawStructure = (NoticeListDrawStructure) currentRequest;
                switch (AnonymousClass1.$SwitchMap$com$felicanetworks$mfm$main$view$views$DrawerContentsLayout$DrawerItemType[drawerItemType.ordinal()]) {
                    case 1:
                        noticeListDrawStructure.actMyService();
                        drawerBehaviorOnSelect = DrawerContentsLayout.OnSelectDrawerItemListener.DrawerBehavior.CLOSE;
                        break;
                    case 2:
                        noticeListDrawStructure.actRecommend();
                        drawerBehaviorOnSelect = DrawerContentsLayout.OnSelectDrawerItemListener.DrawerBehavior.CLOSE;
                        break;
                    case 3:
                        noticeListDrawStructure.actNotice();
                        drawerBehaviorOnSelect = DrawerContentsLayout.OnSelectDrawerItemListener.DrawerBehavior.CLOSE;
                        break;
                    case 4:
                        noticeListDrawStructure.actReader();
                        drawerBehaviorOnSelect = DrawerContentsLayout.OnSelectDrawerItemListener.DrawerBehavior.CLOSE;
                        break;
                    case 5:
                        noticeListDrawStructure.actFaq();
                        drawerBehaviorOnSelect = DrawerContentsLayout.OnSelectDrawerItemListener.DrawerBehavior.CLOSE;
                        break;
                    case 6:
                        startActivity(noticeListDrawStructure.getDefaultIntent(PrimaryDrawStructure.LinkType.CHANGE_MODEL));
                        drawerBehaviorOnSelect = DrawerContentsLayout.OnSelectDrawerItemListener.DrawerBehavior.CLOSE;
                        break;
                    case 7:
                        noticeListDrawStructure.actSupportMenu();
                        drawerBehaviorOnSelect = DrawerContentsLayout.OnSelectDrawerItemListener.DrawerBehavior.CLOSE;
                        break;
                    case 8:
                        noticeListDrawStructure.actSetting();
                        drawerBehaviorOnSelect = DrawerContentsLayout.OnSelectDrawerItemListener.DrawerBehavior.CLOSE;
                        break;
                    default:
    ...
    /* JADX INFO: renamed from: com.felicanetworks.mfm.main.view.activity.NoticeListActivity$1, reason: invalid class name */
    static /* synthetic */ class AnonymousClass1 {
        ...
        static {
            ...
            try {
                iArr2[StructureType.NOTICE_LIST.ordinal()] = 1;
            ...
            try {
                $SwitchMap$com$felicanetworks$mfm$main$presenter$structure$StructureType[StructureType.FAQ.ordinal()] = 4;
            } catch (NoSuchFieldError unused12) {
            }
            try {
                $SwitchMap$com$felicanetworks$mfm$main$presenter$structure$StructureType[StructureType.SUPPORT_MENU.ordinal()] = 5;
            } catch (NoSuchFieldError unused13) {
            }
            try {
                $SwitchMap$com$felicanetworks$mfm$main$presenter$structure$StructureType[StructureType.SETTING.ordinal()] = 6;
            } catch (NoSuchFieldError unused14) {
            }
            try {
                $SwitchMap$com$felicanetworks$mfm$main$presenter$structure$StructureType[StructureType.NOTICE_DETAIL.ordinal()] = 7;
    ...
    private void showContentView(Structure structure) {
        ...
        fragmentTransactionBeginTransaction.replace(R.id.fl_content_fragment, new NoticeListFragment());
    ...
    private void updateOptionMenu(Menu menu) {
        ...
        if (Settings.DeviceType.FAVER == Settings.getDeviceType()) {
            ...
            if (((NoticeListDrawStructure) currentRequest).isFelicaLock()) {
        ...
        if (currentRequest instanceof NoticeListDrawStructure) {
            if (((NoticeListDrawStructure) currentRequest).isScreenLock(getApplicationContext())) {
