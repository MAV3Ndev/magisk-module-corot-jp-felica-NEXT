...
public interface SendChannel<E> {
    ...
    Object mo2169trySendJP2dKIU(E element);
    ...
    public static final class DefaultImpls {
        ...
        public static <E> boolean offer(SendChannel<? super E> sendChannel, E e) throws Throwable {
            ...
            if (ChannelResult.m2189isSuccessimpl(objMo2169trySendJP2dKIU)) {
                return true;
            }
            Throwable thM2183exceptionOrNullimpl = ChannelResult.m2183exceptionOrNullimpl(objMo2169trySendJP2dKIU);
