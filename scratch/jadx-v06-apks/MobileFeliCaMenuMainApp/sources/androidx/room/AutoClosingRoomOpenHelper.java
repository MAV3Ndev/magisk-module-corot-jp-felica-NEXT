...
final class AutoClosingRoomOpenHelper implements SupportSQLiteOpenHelper, DelegatingOpenHelper {
    ...
    static final class AutoClosingSupportSQLiteDatabase implements SupportSQLiteDatabase {
        ...
        void pokeOpen() {
            this.mAutoCloser.executeRefCountingFunction(new Function() { // from class: androidx.room.-$$Lambda$AutoClosingRoomOpenHelper$AutoClosingSupportSQLiteDatabase$YderHBOjSFLRVdnhuOlazKmPpVQ
        ...
        public boolean inTransaction() {
            ...
            return ((Boolean) this.mAutoCloser.executeRefCountingFunction(new Function() { // from class: androidx.room.-$$Lambda$TMdjwAyA2HEhVVdu7fycE2v9GyM
                @Override // androidx.arch.core.util.Function
                public final Object apply(Object obj) {
        ...
        public boolean isDbLockedByCurrentThread() {
            ...
            return ((Boolean) this.mAutoCloser.executeRefCountingFunction(new Function() { // from class: androidx.room.-$$Lambda$ukE71PYFz2jhrqIgnUMNFkpCDcc
                @Override // androidx.arch.core.util.Function
                public final Object apply(Object obj) {
        ...
        public int getVersion() {
            return ((Integer) this.mAutoCloser.executeRefCountingFunction(new Function() { // from class: androidx.room.-$$Lambda$XmxrakQ01Bf_oNrrhprBMwPcn80
                @Override // androidx.arch.core.util.Function
                public final Object apply(Object obj) {
        ...
        public long getMaximumSize() {
            return ((Long) this.mAutoCloser.executeRefCountingFunction(new Function() { // from class: androidx.room.-$$Lambda$yfvpxEUNblARfw2B3344El0ksds
                @Override // androidx.arch.core.util.Function
                public final Object apply(Object obj) {
        ...
        public long getPageSize() {
            return ((Long) this.mAutoCloser.executeRefCountingFunction(new Function() { // from class: androidx.room.-$$Lambda$O7EV1lNrU2QrC1Vknty_OHx9nWY
                @Override // androidx.arch.core.util.Function
                public final Object apply(Object obj) {
        ...
        public boolean isReadOnly() {
            return ((Boolean) this.mAutoCloser.executeRefCountingFunction(new Function() { // from class: androidx.room.-$$Lambda$FnfrLN73Kb5eEMd_EThzd87ecn4
                @Override // androidx.arch.core.util.Function
                public final Object apply(Object obj) {
        ...
        public String getPath() {
            return (String) this.mAutoCloser.executeRefCountingFunction(new Function() { // from class: androidx.room.-$$Lambda$yKxzlL2CA_3zs224T-C80CaPwg4
                @Override // androidx.arch.core.util.Function
                public final Object apply(Object obj) {
        ...
        public boolean isWriteAheadLoggingEnabled() {
            return ((Boolean) this.mAutoCloser.executeRefCountingFunction(new Function() { // from class: androidx.room.-$$Lambda$AutoClosingRoomOpenHelper$AutoClosingSupportSQLiteDatabase$4QgN1EjdyJVlH_XLa1YbM6V7esk
                @Override // androidx.arch.core.util.Function
                public final Object apply(Object obj) {
        ...
        public List<Pair<String, String>> getAttachedDbs() {
            return (List) this.mAutoCloser.executeRefCountingFunction(new Function() { // from class: androidx.room.-$$Lambda$GfIUxMX6NwQv2--yWCkyFsS9ov8
                @Override // androidx.arch.core.util.Function
                public final Object apply(Object obj) {
        ...
        public boolean isDatabaseIntegrityOk() {
            return ((Boolean) this.mAutoCloser.executeRefCountingFunction(new Function() { // from class: androidx.room.-$$Lambda$z_yKiINBCC3WVGnJOjud-lDWWfQ
                @Override // androidx.arch.core.util.Function
                public final Object apply(Object obj) {
    ...
    static class AutoClosingSupportSqliteStatement implements SupportSQLiteStatement {
        ...
        private <T> T executeSqliteStatementWithRefCount(final Function<SupportSQLiteStatement, T> function) {
            return (T) this.mAutoCloser.executeRefCountingFunction(new Function() { // from class: androidx.room.-$$Lambda$AutoClosingRoomOpenHelper$AutoClosingSupportSqliteStatement$qjWyeRRtlHQ_6io66Un2BbqNCGc
                @Override // androidx.arch.core.util.Function
                public final Object apply(Object obj) {
                    return this.f$0.lambda$executeSqliteStatementWithRefCount$0$AutoClosingRoomOpenHelper$AutoClosingSupportSqliteStatement(function, (SupportSQLiteDatabase) obj);
                }
            });
        }
        ...
        public void execute() {
            executeSqliteStatementWithRefCount(new Function() { // from class: androidx.room.-$$Lambda$AutoClosingRoomOpenHelper$AutoClosingSupportSqliteStatement$5bahE1n-rDJSacRnpwx5Y67Ra44
                @Override // androidx.arch.core.util.Function
                public final Object apply(Object obj) {
        ...
        public int executeUpdateDelete() {
            return ((Integer) executeSqliteStatementWithRefCount(new Function() { // from class: androidx.room.-$$Lambda$1GPS-Sx1HgDeoXE5nNYZ3T9AckE
                @Override // androidx.arch.core.util.Function
                public final Object apply(Object obj) {
        ...
        public long executeInsert() {
            return ((Long) executeSqliteStatementWithRefCount(new Function() { // from class: androidx.room.-$$Lambda$N7u9kOTpWTpzDJZkV2DOxmvLbrY
                @Override // androidx.arch.core.util.Function
                public final Object apply(Object obj) {
        ...
        public long simpleQueryForLong() {
            return ((Long) executeSqliteStatementWithRefCount(new Function() { // from class: androidx.room.-$$Lambda$iYIWeB8Yg-vix66FTd-LDQBHFb8
                @Override // androidx.arch.core.util.Function
                public final Object apply(Object obj) {
        ...
        public String simpleQueryForString() {
            return (String) executeSqliteStatementWithRefCount(new Function() { // from class: androidx.room.-$$Lambda$86MUbrc6uipmvj_wBEBf4Ja9I-Y
                @Override // androidx.arch.core.util.Function
                public final Object apply(Object obj) {
