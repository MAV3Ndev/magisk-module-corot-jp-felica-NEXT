...
public final class UStringsKt {
    ...
    public static final String m2008toStringLxnNnR4(byte b, int i) {
    ...
    public static final String m2010toStringolVBNx4(short s, int i) {
    ...
    public static final String m2009toStringV7xB4Y4(int i, int i2) {
    ...
    public static final String m2007toStringJSWoG40(long j, int i) {
    ...
    public static final UByte toUByteOrNull(String str, int i) {
        ...
        if (Integer.compare(data ^ Integer.MIN_VALUE, UInt.m713constructorimpl(255) ^ Integer.MIN_VALUE) > 0) {
            return null;
        }
        return UByte.m625boximpl(UByte.m631constructorimpl((byte) data));
    }
    ...
    public static final UShort toUShortOrNull(String str, int i) {
        ...
        int data = uIntOrNull.getData();
        if (Integer.compare(data ^ Integer.MIN_VALUE, UInt.m713constructorimpl(65535) ^ Integer.MIN_VALUE) > 0) {
            return null;
        }
        return UShort.m893boximpl(UShort.m899constructorimpl((short) data));
    }
    ...
    public static final UInt toUIntOrNull(String str, int i) {
        ...
        int iM713constructorimpl = UInt.m713constructorimpl(i);
        int iM = 119304647;
        while (i2 < length) {
            ...
            if (Integer.compare(i3 ^ Integer.MIN_VALUE, iM ^ Integer.MIN_VALUE) > 0) {
                if (iM == 119304647) {
                    iM = UByte$$ExternalSyntheticBackport0.m(-1, iM713constructorimpl);
                    if (Integer.compare(i3 ^ Integer.MIN_VALUE, iM ^ Integer.MIN_VALUE) > 0) {
                    }
                }
                return null;
            }
            int iM713constructorimpl2 = UInt.m713constructorimpl(i3 * iM713constructorimpl);
            int iM713constructorimpl3 = UInt.m713constructorimpl(UInt.m713constructorimpl(iDigitOf) + iM713constructorimpl2);
            if (Integer.compare(iM713constructorimpl3 ^ Integer.MIN_VALUE, iM713constructorimpl2 ^ Integer.MIN_VALUE) < 0) {
                return null;
            }
            i2++;
            i3 = iM713constructorimpl3;
        }
        return UInt.m707boximpl(i3);
    }
    ...
    public static final ULong toULongOrNull(String str, int i) {
        ...
        long jM792constructorimpl = ULong.m792constructorimpl(i);
        long j = 0;
        ...
        while (i2 < length) {
            ...
            if (Long.compare(j ^ Long.MIN_VALUE, jM$1 ^ Long.MIN_VALUE) > 0) {
                if (jM$1 == 512409557603043100L) {
                    jM$1 = UByte$$ExternalSyntheticBackport0.m$1(-1L, jM792constructorimpl);
                    if (Long.compare(j ^ Long.MIN_VALUE, jM$1 ^ Long.MIN_VALUE) > 0) {
                    }
                }
                return null;
            }
            long jM792constructorimpl2 = ULong.m792constructorimpl(j * jM792constructorimpl);
            long jM792constructorimpl3 = ULong.m792constructorimpl(ULong.m792constructorimpl(((long) UInt.m713constructorimpl(iDigitOf)) & 4294967295L) + jM792constructorimpl2);
            if (Long.compare(jM792constructorimpl3 ^ Long.MIN_VALUE, jM792constructorimpl2 ^ Long.MIN_VALUE) < 0) {
                return null;
            }
            i2++;
            j = jM792constructorimpl3;
        }
        return ULong.m786boximpl(j);
    }
}
