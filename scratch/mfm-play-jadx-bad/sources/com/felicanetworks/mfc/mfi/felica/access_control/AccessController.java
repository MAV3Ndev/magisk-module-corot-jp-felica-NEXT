...
public interface AccessController {
    ...
    void check(int category) throws AccessControllerException;

    void checkMfiServiceId(String serviceId) throws AccessControllerException;

    void checkNodeCodeList(int currentSystemCode, int[] nodeCodeList) throws AccessControllerException;

    void checkSystemCode(int systemCode) throws AccessControllerException;
