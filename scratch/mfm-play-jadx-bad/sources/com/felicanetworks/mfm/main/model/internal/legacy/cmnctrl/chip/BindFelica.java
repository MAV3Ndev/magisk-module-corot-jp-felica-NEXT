...
public class BindFelica {
    ...
    public BindFelica(AppContext context) {
        this.context = context;
    }

    public void bindFelica(BindFelicaListener listener) throws BindException {
        try {
            if (listener == null) {
    ...
    private class FelicaServiceConnection implements ServiceConnection {
        ...
        public void onServiceConnected(ComponentName cpName, IBinder service) {
            if (BindFelica.this.context.felica == null) {
                try {
                    if (BindFelica.this.listener != null) {
                        BindFelica.this.context.felica = ((Felica.LocalBinder) service).getInstance();
        ...
        @Override // android.content.ServiceConnection
        public void onServiceDisconnected(ComponentName cpName) {
