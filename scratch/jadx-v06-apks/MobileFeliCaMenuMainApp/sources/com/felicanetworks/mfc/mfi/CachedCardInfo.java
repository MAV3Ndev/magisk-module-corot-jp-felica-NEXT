...
public class CachedCardInfo extends CardInfo {
    ...
    public CachedCardInfo(CompleteCardInfo.Cache cache, long j) {
        super(cache.cid, cache.serviceId, cache.walletAppId, cache.state, cache.position, cache.task, cache.reissuePossibility, cache.serviceType, cache.additionalInfoHash, cache.cardCategory);
        this.mCachedTime = j;
    }
