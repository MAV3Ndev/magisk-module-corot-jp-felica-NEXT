...
public final class CircularIntArray {
  ...
  (wrap:int:?: TERNARY null = ((wrap:int:0x0000: ARITH (r2v0 int) & (1 int) A[WRAPPED]) != (0 int)) ? (8 int) : (r1v0 int))
 A[MD:(int):void (m)] (LINE:30) call: androidx.collection.CircularIntArray.<init>(int):void type: THIS */
