...
public class SparseArrayCompat<E> implements Cloneable {
 ...
 A[MD:(int):void (m)] (LINE:61) call: androidx.collection.SparseArrayCompat.<init>(int):void type: THIS */
    ...
    public SparseArrayCompat<E> m63clone() throws CloneNotSupportedException {
    ...
    /* JADX DEBUG: Class process forced to load method for inline: androidx.collection.SparseArrayCompatKt.access$gc(androidx.collection.SparseArrayCompat):void */
