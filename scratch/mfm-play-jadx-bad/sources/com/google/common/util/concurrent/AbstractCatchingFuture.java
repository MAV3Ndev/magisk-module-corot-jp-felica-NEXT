...
abstract class AbstractCatchingFuture<V, X extends Throwable, F, T> extends FluentFuture.TrustedFuture<V> implements Runnable {
    ...
    /* JADX DEBUG: Multi-variable search result rejected for r9v0, resolved type: com.google.common.util.concurrent.AbstractCatchingFuture<V, X extends java.lang.Throwable, F, T> */
    ...
    private static final class AsyncCatchingFuture<V, X extends Throwable> extends AbstractCatchingFuture<V, X, AsyncFunction<? super X, ? extends V>, ListenableFuture<? extends V>> {
        ...
        /* JADX DEBUG: Method merged with bridge method: doFallback(Ljava/lang/Object;Ljava/lang/Throwable;)Ljava/lang/Object; */
        /* JADX DEBUG: Multi-variable search result rejected for r3v0, resolved type: X extends java.lang.Throwable */
    ...
    private static final class CatchingFuture<V, X extends Throwable> extends AbstractCatchingFuture<V, X, Function<? super X, ? extends V>, V> {
        ...
        /* JADX DEBUG: Method merged with bridge method: doFallback(Ljava/lang/Object;Ljava/lang/Throwable;)Ljava/lang/Object; */
        /* JADX DEBUG: Multi-variable search result rejected for r2v0, resolved type: X extends java.lang.Throwable */
        /* JADX INFO: Access modifiers changed from: package-private */
        /* JADX WARN: Multi-variable type inference failed */
        @Override // com.google.common.util.concurrent.AbstractCatchingFuture
        @ParametricNullness
