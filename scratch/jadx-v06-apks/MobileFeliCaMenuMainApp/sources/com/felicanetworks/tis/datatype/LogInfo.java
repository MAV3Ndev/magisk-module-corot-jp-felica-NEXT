...
public class LogInfo {
    ...
    public void setPaymentLogInfo(int i, int i2, int i3) {
        ...
        try {
            ...
            String str = String.format(Locale.JAPAN, "%d", Integer.valueOf(i2));
            String str2 = String.format(Locale.JAPAN, "%d", Integer.valueOf(i3));
            if (payTypeCode != 0) {
    ...
    public void addUsageData(TransactionInfo transactionInfo) {
        ...
        if (this.mUsageData.length() + 2 + 4 + 32 + 3 > 200) {
