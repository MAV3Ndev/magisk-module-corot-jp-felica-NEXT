...
public class SupportMenuActivity extends DrawerBaseActivity implements DrawerContentsLayout.OnSelectDrawerItemListener {
    ...
    public void onCreate(Bundle bundle) {
        try {
            ...
            if (supportActionBar != null) {
                supportActionBar.setTitle(R.string.toolbar_title_support_menu);
            }
    ...
    public DrawerContentsLayout.OnSelectDrawerItemListener.DrawerBehavior onSelect(DrawerContentsLayout.DrawerItemType drawerItemType) {
        ...
        try {
            Structure currentRequest = getCurrentRequest();
            if (currentRequest != null && (currentRequest instanceof SupportMenuDrawStructure)) {
                SupportMenuDrawStructure supportMenuDrawStructure = (SupportMenuDrawStructure) currentRequest;
                switch (AnonymousClass1.$SwitchMap$com$felicanetworks$mfm$main$view$views$DrawerContentsLayout$DrawerItemType[drawerItemType.ordinal()]) {
                    case 1:
                        supportMenuDrawStructure.actMyService();
                        drawerBehaviorOnSelect = DrawerContentsLayout.OnSelectDrawerItemListener.DrawerBehavior.CLOSE;
                        break;
                    case 2:
                        supportMenuDrawStructure.actRecommend();
                        drawerBehaviorOnSelect = DrawerContentsLayout.OnSelectDrawerItemListener.DrawerBehavior.CLOSE;
                        break;
                    case 3:
                        supportMenuDrawStructure.actNotice();
                        drawerBehaviorOnSelect = DrawerContentsLayout.OnSelectDrawerItemListener.DrawerBehavior.CLOSE;
                        break;
                    case 4:
                        supportMenuDrawStructure.actReader();
                        drawerBehaviorOnSelect = DrawerContentsLayout.OnSelectDrawerItemListener.DrawerBehavior.CLOSE;
                        break;
                    case 5:
                        supportMenuDrawStructure.actFaq();
                        drawerBehaviorOnSelect = DrawerContentsLayout.OnSelectDrawerItemListener.DrawerBehavior.CLOSE;
                        break;
                    case 6:
                        startActivity(supportMenuDrawStructure.getDefaultIntent(PrimaryDrawStructure.LinkType.CHANGE_MODEL));
                        drawerBehaviorOnSelect = DrawerContentsLayout.OnSelectDrawerItemListener.DrawerBehavior.CLOSE;
                        break;
                    case 7:
                        supportMenuDrawStructure.actSupportMenu();
                        drawerBehaviorOnSelect = DrawerContentsLayout.OnSelectDrawerItemListener.DrawerBehavior.CLOSE;
                        break;
                    case 8:
                        supportMenuDrawStructure.actSetting();
                        drawerBehaviorOnSelect = DrawerContentsLayout.OnSelectDrawerItemListener.DrawerBehavior.CLOSE;
                        break;
                    default:
    ...
    /* JADX INFO: renamed from: com.felicanetworks.mfm.main.view.activity.SupportMenuActivity$1, reason: invalid class name */
    static /* synthetic */ class AnonymousClass1 {
        ...
        static {
            ...
            try {
                $SwitchMap$com$felicanetworks$mfm$main$presenter$structure$StructureType[StructureType.MEMORY.ordinal()] = 8;
            } catch (NoSuchFieldError unused8) {
            }
            try {
                $SwitchMap$com$felicanetworks$mfm$main$presenter$structure$StructureType[StructureType.TUTORIAL_ANYTIME.ordinal()] = 9;
            } catch (NoSuchFieldError unused9) {
            }
            try {
                $SwitchMap$com$felicanetworks$mfm$main$presenter$structure$StructureType[StructureType.ACCOUNT_CHANGE_HISTORY.ordinal()] = 10;
        ...
        try {
            switch (AnonymousClass1.$SwitchMap$com$felicanetworks$mfm$main$presenter$structure$StructureType[structure.getType().ordinal()]) {
                ...
                case 7:
                    ...
                    break;
                case 8:
                    startActivity(new Intent(this, (Class<?>) MemoryUsageActivity.class));
                    break;
                case 9:
                    startActivity(new Intent(this, (Class<?>) TutorialActivity.class));
                    break;
                case 10:
                    startActivity(new Intent(this, (Class<?>) AccountChangeHistoryActivity.class));
                    break;
                default:
    ...
    protected void onNewIntent(Intent intent) {
        try {
            if (getCurrentRequest() instanceof SupportMenuDrawStructure) {
    ...
    public boolean onOptionsItemSelected(MenuItem menuItem) {
        try {
            ...
            Structure currentRequest = getCurrentRequest();
            if ((currentRequest instanceof SupportMenuDrawStructure) && itemId == R.id.tool_lock) {
                AnalysisManager.stamp(MfmStamp.Event.ACTION_LOCK_SETTING, new Object[0]);
                if (Settings.DeviceType.GP == Settings.getDeviceType()) {
                    try {
                        startActivity(((SupportMenuDrawStructure) currentRequest).getDefaultIntent(PrimaryDrawStructure.LinkType.SCREEN_LOCK_SETTING));
                    ...
                    ((SupportMenuDrawStructure) currentRequest).actLock();
                }
            }
        } catch (Exception e) {
            notifyException(e);
    ...
    private void updateOptionMenu(Menu menu) {
        ...
        if (Settings.DeviceType.FAVER == Settings.getDeviceType()) {
            if (currentRequest instanceof SupportMenuDrawStructure) {
                if (((SupportMenuDrawStructure) currentRequest).isFelicaLock()) {
        ...
        if (currentRequest instanceof SupportMenuDrawStructure) {
            if (((SupportMenuDrawStructure) currentRequest).isScreenLock(getApplicationContext())) {
    ...
    private void showContentView() {
        ...
        fragmentTransactionBeginTransaction.replace(R.id.fl_content_fragment, new SupportMenuFragment());
