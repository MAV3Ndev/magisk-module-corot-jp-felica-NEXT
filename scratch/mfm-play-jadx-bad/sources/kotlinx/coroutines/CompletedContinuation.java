...
final /* data */ class CompletedContinuation {
    ...
    /* JADX DEBUG: Multi-variable search result rejected for r0v0, resolved type: kotlinx.coroutines.CompletedContinuation */
  ...
  (wrap:kotlinx.coroutines.CancelHandler:?: TERNARY null = ((wrap:int:0x0000: ARITH (r7v0 int) & (2 int) A[WRAPPED]) != (0 int)) ? (null kotlinx.coroutines.CancelHandler) : (r3v0 kotlinx.coroutines.CancelHandler))
  (wrap:kotlin.jvm.functions.Function1:?: TERNARY null = ((wrap:int:0x0006: ARITH (r7v0 int) & (4 int) A[WRAPPED]) != (0 int)) ? (null kotlin.jvm.functions.Function1) : (r4v0 kotlin.jvm.functions.Function1))
  (wrap:java.lang.Object:?: TERNARY null = ((wrap:int:0x000b: ARITH (r7v0 int) & (8 int) A[WRAPPED]) != (0 int)) ? (null java.lang.Object) : (r5v0 java.lang.Object))
  (wrap:java.lang.Throwable:?: TERNARY null = ((wrap:int:0x0010: ARITH (r7v0 int) & (16 int) A[WRAPPED]) != (0 int)) ? (null java.lang.Throwable) : (r6v0 java.lang.Throwable))
 A[MD:(java.lang.Object, kotlinx.coroutines.CancelHandler, kotlin.jvm.functions.Function1<? super java.lang.Throwable, kotlin.Unit>, java.lang.Object, java.lang.Throwable):void (m)] (LINE:648) call: kotlinx.coroutines.CompletedContinuation.<init>(java.lang.Object, kotlinx.coroutines.CancelHandler, kotlin.jvm.functions.Function1, java.lang.Object, java.lang.Throwable):void type: THIS */
