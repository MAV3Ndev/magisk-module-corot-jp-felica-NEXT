...
public interface IDataListEventCallback extends IInterface {
    ...
    void onPart(List<String> list, boolean z) throws RemoteException;

    public static abstract class Stub extends Binder implements IDataListEventCallback {
        private static final String DESCRIPTOR = "com.felicanetworks.mfc.mfi.IDataListEventCallback";
        ...
        public static IDataListEventCallback asInterface(IBinder iBinder) {
            if (iBinder == null) {
                return null;
            }
        ...
        public boolean onTransact(int i, Parcel parcel, Parcel parcel2, int i2) throws RemoteException {
            if (i == 1) {
                ...
                onPart(parcel.createStringArrayList(), parcel.readInt() != 0);
