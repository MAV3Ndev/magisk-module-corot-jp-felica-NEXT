...
public interface ISilentStartEventCallback extends IInterface {
    ...
    public static abstract class Stub extends Binder implements ISilentStartEventCallback {
        private static final String DESCRIPTOR = "com.felicanetworks.mfc.mfi.ISilentStartEventCallback";
        ...
        public static ISilentStartEventCallback asInterface(IBinder iBinder) {
            if (iBinder == null) {
                return null;
            }
        ...
        public boolean onTransact(int i, Parcel parcel, Parcel parcel2, int i2) throws RemoteException {
            ...
            if (i == 2) {
                parcel.enforceInterface(DESCRIPTOR);
                onRequestActivity(parcel.readInt() != 0 ? (Intent) Intent.CREATOR.createFromParcel(parcel) : null);
                return true;
            }
            if (i == 3) {
                parcel.enforceInterface(DESCRIPTOR);
