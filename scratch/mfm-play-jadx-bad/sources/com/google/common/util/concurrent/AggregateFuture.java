...
abstract class AggregateFuture<InputT, OutputT> extends AggregateFutureState<OutputT> {
    ...
    final void init() {
            ...
            while (it.hasNext()) {
                ...
                next.addListener(new Runnable() { // from class: com.google.common.util.concurrent.AggregateFuture$$ExternalSyntheticLambda0
                    ...
                    public final void run() {
                        this.f$0.m554lambda$init$0$comgooglecommonutilconcurrentAggregateFuture(next, i);
                    }
        ...
        Runnable runnable = new Runnable() { // from class: com.google.common.util.concurrent.AggregateFuture$$ExternalSyntheticLambda1
            ...
            @Override // java.lang.Runnable
            public final void run() {
                this.f$0.m555lambda$init$1$comgooglecommonutilconcurrentAggregateFuture(immutableCollection);
            }
        };
    ...
    /* synthetic */ void m554lambda$init$0$comgooglecommonutilconcurrentAggregateFuture(ListenableFuture listenableFuture, int i) {
        try {
            ...
            m555lambda$init$1$comgooglecommonutilconcurrentAggregateFuture(null);
        }
    }
    ...
    /* JADX DEBUG: Multi-variable search result rejected for r0v0, resolved type: com.google.common.util.concurrent.AggregateFuture<InputT, OutputT> */
    ...
    /* JADX DEBUG: Method merged with bridge method: lambda$init$1$com-google-common-util-concurrent-AggregateFuture(Lcom/google/common/collect/ImmutableCollection;)V */
    /* JADX INFO: Access modifiers changed from: private */
    /* JADX INFO: renamed from: decrementCountAndMaybeComplete, reason: merged with bridge method [inline-methods] */
    public void m555lambda$init$1$comgooglecommonutilconcurrentAggregateFuture(@CheckForNull ImmutableCollection<? extends Future<? extends InputT>> immutableCollection) {
