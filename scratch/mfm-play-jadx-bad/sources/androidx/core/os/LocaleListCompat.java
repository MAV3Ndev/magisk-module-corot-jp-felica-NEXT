...
public final class LocaleListCompat {
    ...
    public static LocaleListCompat wrap(Object obj) {
        return wrap(Profiling$$ExternalSyntheticApiModelOutline0.m105m(obj));
    }
    ...
    static Locale forLanguageTagCompat(String str) {
        ...
        } else if (str.contains(CacheUtil.DELIMITER)) {
            String[] strArrSplit2 = str.split(CacheUtil.DELIMITER, -1);
