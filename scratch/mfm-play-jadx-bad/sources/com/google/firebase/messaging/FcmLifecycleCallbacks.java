        ...
        if (Build.VERSION.SDK_INT <= 25) {
            new Handler(Looper.getMainLooper()).post(new Runnable() { // from class: com.google.firebase.messaging.FcmLifecycleCallbacks$$ExternalSyntheticLambda0
                ...
                public final void run() {
                    this.f$0.m591xd8132052(intent);
                }
            });
        } else {
            m591xd8132052(intent);
        }
    }

    /* JADX DEBUG: Method merged with bridge method: lambda$onActivityCreated$0$com-google-firebase-messaging-FcmLifecycleCallbacks(Landroid/content/Intent;)V */
    /* JADX INFO: Access modifiers changed from: private */
    /* JADX INFO: renamed from: logNotificationOpen, reason: merged with bridge method [inline-methods] */
    public void m591xd8132052(Intent intent) {
        Bundle bundle = null;
        try {
