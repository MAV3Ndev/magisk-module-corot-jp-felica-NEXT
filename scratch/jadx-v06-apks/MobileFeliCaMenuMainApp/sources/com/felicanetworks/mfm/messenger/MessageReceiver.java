...
public abstract class MessageReceiver extends BroadcastReceiver {
    ...
    static /* synthetic */ class AnonymousClass1 {
        ...
        static {
            ...
            try {
                $SwitchMap$com$felicanetworks$mfm$messenger$MessageProtocol$Action[MessageProtocol.Action.RECEIVE_TOKEN.ordinal()] = 3;
            } catch (NoSuchFieldError unused3) {
            }
            try {
                $SwitchMap$com$felicanetworks$mfm$messenger$MessageProtocol$Action[MessageProtocol.Action.RECEIVE_DELETED_MESSAGE.ordinal()] = 4;
            } catch (NoSuchFieldError unused4) {
            }
            try {
                $SwitchMap$com$felicanetworks$mfm$messenger$MessageProtocol$Action[MessageProtocol.Action.UNKNOWN.ordinal()] = 5;
