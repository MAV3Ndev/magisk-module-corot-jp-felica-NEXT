...
final /* synthetic */ class ChannelsKt__Channels_commonKt {
    ...
    /* JADX INFO: compiled from: Channels.common.kt */
    @Metadata(k = 3, mv = {1, 8, 0}, xi = MfiClientException.TYPE_EXIST_SERVICE_FAILED)
    @DebugMetadata(c = "kotlinx.coroutines.channels.ChannelsKt__Channels_commonKt", f = "Channels.common.kt", i = {0, 0}, l = {FeliCaParams.BLOCK_NO_FELICAPOCKET_LITE_DATA_FORMAT_CODE}, m = "consumeEach", n = {"action", "channel$iv"}, s = {"L$0", "L$1"})
    ...
    public static final <E> Object toList(ReceiveChannel<? extends E> receiveChannel, Continuation<? super List<? extends E>> continuation) throws Throwable {
        ...
        if (i == 0) {
            ...
            try {
                ...
                c01681.L$0 = list;
                c01681.L$1 = r5;
                c01681.L$2 = receiveChannel2;
                c01681.L$3 = it;
                c01681.label = 1;
                objHasNext = it.hasNext(c01681);
                if (objHasNext != coroutine_suspended) {
                }
            } catch (Throwable th2) {
                receiveChannel2 = receiveChannel;
            ...
            it = (ChannelIterator) c01681.L$3;
            ReceiveChannel<? extends E> receiveChannel3 = (ReceiveChannel) c01681.L$2;
            List list2 = (List) c01681.L$1;
            List list3 = (List) c01681.L$0;
            try {
                ResultKt.throwOnFailure(obj);
                ?? r52 = list2;
                List list4 = list3;
