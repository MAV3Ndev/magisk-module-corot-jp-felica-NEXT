...
public class MaterialCheckBox extends AppCompatCheckBox {
    ...
    public void setCheckedState(int i) {
        AutofillManager autofillManagerM562m;
        ...
        if (this.checkedState != i) {
            ...
            if (Build.VERSION.SDK_INT >= 26 && (autofillManagerM562m = Timestamp$$ExternalSyntheticApiModelOutline0.m562m(getContext().getSystemService(Timestamp$$ExternalSyntheticApiModelOutline0.m564m()))) != null) {
                autofillManagerM562m.notifyValueChanged(this);
            }
