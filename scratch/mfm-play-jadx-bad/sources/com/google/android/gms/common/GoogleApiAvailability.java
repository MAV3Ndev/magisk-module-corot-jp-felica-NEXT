...
public class GoogleApiAvailability extends GoogleApiAvailabilityLight {
    ...
    /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 1 */
    /* JADX DEBUG: Failed to insert an additional move for type inference into block B:8:0x002c */
        ...
        if (PlatformVersion.isAtLeastO()) {
            ...
            if (str2 == null) {
                ...
                if (notificationChannel == null) {
                    notificationManager.createNotificationChannel(Timestamp$$ExternalSyntheticApiModelOutline0.m("com.google.android.gms.availability", string, 4));
