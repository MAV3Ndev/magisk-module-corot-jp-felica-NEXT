...
public class BeginGetCustomCredentialOption extends BeginGetCredentialOption {
    ...
    public static final class Companion {
        /* JADX DEBUG: Can't inline method, not implemented redirect type for insn: 0x0000: CONSTRUCTOR  A[MD:():void (m)] call: androidx.credentials.provider.BeginGetCustomCredentialOption.Companion.<init>():void type: THIS */
