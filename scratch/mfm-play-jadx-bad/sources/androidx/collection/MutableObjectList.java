...
public final class MutableObjectList<E> extends ObjectList<E> {
  ...
  (wrap:int:?: TERNARY null = ((wrap:int:0x0000: ARITH (r2v0 int) & (1 int) A[WRAPPED]) != (0 int)) ? (16 int) : (r1v0 int))
 A[MD:(int):void (m)] (LINE:640) call: androidx.collection.MutableObjectList.<init>(int):void type: THIS */
    ...
    /* JADX DEBUG: Multi-variable search result rejected for r13v0, resolved type: androidx.collection.MutableObjectList<E> */
    ...
    /* JADX DEBUG: Multi-variable search result rejected for r6v0, resolved type: androidx.collection.ObjectList<E> */
    /* JADX WARN: Multi-variable type inference failed */
    ...
    /* JADX DEBUG: Multi-variable search result rejected for r3v0, resolved type: androidx.collection.MutableObjectList<E> */
    /* JADX WARN: Multi-variable type inference failed */
