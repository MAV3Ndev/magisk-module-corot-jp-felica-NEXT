...
public final class zzpj extends zzor {
    ...
    final zzog zzf(String str, com.google.android.gms.internal.measurement.zzic zzicVar, com.google.android.gms.internal.measurement.zzhr zzhrVar, String str2) {
        ...
        Set setM684m = UByte$$ExternalSyntheticBackport0.m684m((Object[]) zzibVar.zzc().zzk(str, zzfx.zzau).split(","));
        ...
        zzN(builder, "gmp_app_id", zzicVar.zzac(), setM684m);
        zzibVar.zzc().zzi();
        zzN(builder, "gmp_version", String.valueOf(130000L), setM684m);
        ...
        zzN(builder, "app_instance_id", strZzV, setM684m);
        zzN(builder, "rdid", zzicVar.zzP(), setM684m);
        zzN(builder, "bundle_id", zzicVar.zzK(), setM684m);
        String strZzk2 = zzhrVar.zzk();
        String strZza = zzjl.zza(strZzk2);
        if (true != TextUtils.isEmpty(strZza)) {
            strZzk2 = strZza;
        }
        zzN(builder, "app_event_name", strZzk2, setM684m);
        zzN(builder, "app_version", String.valueOf(zzicVar.zzai()), setM684m);
        ...
        zzN(builder, "os_version", strZzD, setM684m);
        zzN(builder, "timestamp", String.valueOf(zzhrVar.zzn()), setM684m);
        if (zzicVar.zzS()) {
            zzN(builder, "lat", "1", setM684m);
        }
        zzN(builder, "privacy_sandbox_version", String.valueOf(zzicVar.zzaG()), setM684m);
        zzN(builder, "trigger_uri_source", "1", setM684m);
        zzN(builder, "trigger_uri_timestamp", String.valueOf(jCurrentTimeMillis), setM684m);
        zzN(builder, "request_uuid", str2, setM684m);
        ...
        zzQ(builder, zzibVar.zzc().zzk(str, zzfx.zzat).split("\\|"), bundle, setM684m);
        ...
        zzQ(builder, zzibVar.zzc().zzk(str, zzfx.zzas).split("\\|"), bundle2, setM684m);
        zzN(builder, "dma", true != zzicVar.zzaC() ? "0" : "1", setM684m);
        if (!zzicVar.zzaE().isEmpty()) {
            zzN(builder, "dma_cps", zzicVar.zzaE(), setM684m);
        }
        if (zzicVar.zzaK()) {
            com.google.android.gms.internal.measurement.zzha zzhaVarZzaL = zzicVar.zzaL();
            if (!zzhaVarZzaL.zzb().isEmpty()) {
                zzN(builder, "dl_gclid", zzhaVarZzaL.zzb(), setM684m);
            }
            if (!zzhaVarZzaL.zzd().isEmpty()) {
                zzN(builder, "dl_gbraid", zzhaVarZzaL.zzd(), setM684m);
            }
            if (!zzhaVarZzaL.zzf().isEmpty()) {
                zzN(builder, "dl_gs", zzhaVarZzaL.zzf(), setM684m);
            }
            if (zzhaVarZzaL.zzh() > 0) {
                zzN(builder, "dl_ss_ts", String.valueOf(zzhaVarZzaL.zzh()), setM684m);
            }
            if (!zzhaVarZzaL.zzj().isEmpty()) {
                zzN(builder, "mr_gclid", zzhaVarZzaL.zzj(), setM684m);
            }
            if (!zzhaVarZzaL.zzm().isEmpty()) {
                zzN(builder, "mr_gbraid", zzhaVarZzaL.zzm(), setM684m);
            }
            if (!zzhaVarZzaL.zzo().isEmpty()) {
                zzN(builder, "mr_gs", zzhaVarZzaL.zzo(), setM684m);
            }
            if (zzhaVarZzaL.zzq() > 0) {
                zzN(builder, "mr_click_ts", String.valueOf(zzhaVarZzaL.zzq()), setM684m);
            }
        }
    ...
    final String zzi(com.google.android.gms.internal.measurement.zzib zzibVar) {
        ...
        for (com.google.android.gms.internal.measurement.zzid zzidVar : zzibVar.zza()) {
            if (zzidVar != null) {
                ...
                zzS(sb, 1, ClientContext.APP_ID_KEY, zzidVar.zzA());
    ...
    final long zzu(String str) {
        ...
        return zzt(str.getBytes(Charset.forName(StringUtil.UTF_8)));
    }
