...
public interface IFelicaEventListener extends IInterface {
    void errorOccurred(int i, String str, AppInfo appInfo) throws RemoteException;
    ...
    public static abstract class Stub extends Binder implements IFelicaEventListener {
        ...
        public boolean onTransact(int i, Parcel parcel, Parcel parcel2, int i2) throws RemoteException {
            ...
            if (i == 2) {
                parcel.enforceInterface(DESCRIPTOR);
                errorOccurred(parcel.readInt(), parcel.readString(), parcel.readInt() != 0 ? AppInfo.CREATOR.createFromParcel(parcel) : null);
                return true;
            }
            if (i == 1598968902) {
            ...
            public void errorOccurred(int i, String str, AppInfo appInfo) throws RemoteException {
                ...
                try {
                    ...
                    if (appInfo != null) {
                        ...
                        appInfo.writeToParcel(parcelObtain, 0);
                    } else {
