...
final class CombineKt$zipImpl$1$1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
    ...
    /* JADX DEBUG: Failed to insert an additional move for type inference into block B:31:0x000a */
    /* JADX DEBUG: Failed to insert an additional move for type inference into block B:8:0x0018 */
    /* JADX DEBUG: Type inference failed for r12v0. Raw type applied. Possible types: kotlinx.coroutines.flow.Flow<T1>, kotlinx.coroutines.flow.Flow */
    /* JADX DEBUG: Type inference failed for r2v9. Raw type applied. Possible types: kotlinx.coroutines.flow.FlowCollector<R>, kotlinx.coroutines.flow.FlowCollector */
    /* JADX DEBUG: Type inference failed for r5v3. Raw type applied. Possible types: kotlin.jvm.functions.Function3<T1, T2, kotlin.coroutines.Continuation<? super R>, java.lang.Object>, kotlin.jvm.functions.Function3 */
    /* JADX DEBUG: Type inference failed for r5v4. Raw type applied. Possible types: kotlinx.coroutines.flow.FlowCollector<R>, kotlinx.coroutines.flow.FlowCollector */
    /* JADX DEBUG: Type inference failed for r6v0. Raw type applied. Possible types: kotlinx.coroutines.flow.Flow<T2>, kotlinx.coroutines.flow.Flow */
    /* JADX DEBUG: Type inference failed for r8v2. Raw type applied. Possible types: kotlinx.coroutines.flow.FlowCollector<R>, kotlinx.coroutines.flow.FlowCollector */
    /* JADX WARN: Multi-variable type inference failed */
    ...
    static final class AnonymousClass2 extends SuspendLambda implements Function2<Unit, Continuation<? super Unit>, Object> {
        ...
        static final class AnonymousClass1<T> implements FlowCollector {
            ...
            static final class C00801 extends SuspendLambda implements Function2<Unit, Continuation<? super Unit>, Object> {
                final /* synthetic */ ReceiveChannel<Object> $second;
                final /* synthetic */ FlowCollector<R> $this_unsafeFlow;
                final /* synthetic */ Function3<T1, T2, Continuation<? super R>, Object> $transform;
                ...
                /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                /* JADX WARN: Multi-variable type inference failed */
                C00801(ReceiveChannel<? extends Object> receiveChannel, FlowCollector<? super R> flowCollector, Function3<? super T1, ? super T2, ? super Continuation<? super R>, ? extends Object> function3, T1 t1, Continuation<? super C00801> continuation) {
                    super(2, continuation);
                    this.$second = receiveChannel;
                    this.$this_unsafeFlow = flowCollector;
                    this.$transform = function3;
                ...
                @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
                public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
                    return new C00801(this.$second, this.$this_unsafeFlow, this.$transform, this.$value, continuation);
                }
                ...
                */
                public final Object invokeSuspend(Object obj) throws Throwable {
                    Object objMo2173receiveCatchingJP2dKIU;
                    ...
                    if (i == 0) {
                        ResultKt.throwOnFailure(obj);
                        this.label = 1;
                        objMo2173receiveCatchingJP2dKIU = this.$second.mo2173receiveCatchingJP2dKIU(this);
                        if (objMo2173receiveCatchingJP2dKIU != coroutine_suspended) {
                        }
                        return coroutine_suspended;
                    }
                    if (i == 1) {
                        ResultKt.throwOnFailure(obj);
                        objMo2173receiveCatchingJP2dKIU = ((ChannelResult) obj).getHolder();
                    } else {
                        if (i != 2) {
                            if (i != 3) {
                                throw new IllegalStateException("call to 'resume' before 'invoke' with coroutine");
                    ...
                    if (objMo2173receiveCatchingJP2dKIU instanceof ChannelResult.Failed) {
                        Throwable thM2183exceptionOrNullimpl = ChannelResult.m2183exceptionOrNullimpl(objMo2173receiveCatchingJP2dKIU);
                        if (thM2183exceptionOrNullimpl == null) {
                            throw new AbortFlowException(flowCollector3);
                        }
                        throw thM2183exceptionOrNullimpl;
                    }
                    Function3<T1, T2, Continuation<? super R>, Object> function3 = this.$transform;
                    T1 t1 = this.$value;
                    if (objMo2173receiveCatchingJP2dKIU == NullSurrogateKt.NULL) {
                        objMo2173receiveCatchingJP2dKIU = null;
                    }
                    this.L$0 = flowCollector3;
                    this.label = 2;
                    obj = function3.invoke(t1, objMo2173receiveCatchingJP2dKIU, this);
            ...
            */
            public final Object emit(T1 t1, Continuation<? super Unit> continuation) throws Throwable {
                ...
                if (i == 0) {
                    ...
                    C00801 c00801 = new C00801(this.$second, this.$this_unsafeFlow, this.$transform, t1, null);
                    combineKt$zipImpl$1$1$2$1$emit$1.label = 1;
                    if (ChannelFlowKt.withContextUndispatched(coroutineContext, unit, obj2, c00801, combineKt$zipImpl$1$1$2$1$emit$1) == coroutine_suspended) {
                        return coroutine_suspended;
                    }
                } else {
                    if (i != 1) {
