...
public class Processor {
    ...
    private static final String WORD = "EG8XbYNp95fRTnMbrdFUBhSp2c6dM8z5";
    ...
    private void load() {
        ...
        try {
            ...
            this.mPreProcessData = preprocess(bArrPrepare[0], bArrPrepare[1], FlavorConst.DEFINE_2);
        } catch (Exception e) {
    ...
    private JSONObject createHeader() {
        ...
        try {
            ...
            jSONObject.put(HEADER_PARAM_3, FlavorConst.DEFINE_1);
