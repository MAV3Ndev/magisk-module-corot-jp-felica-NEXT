...
final /* synthetic */ class FlowKt__ErrorsKt {
    ...
    @DebugMetadata(c = "kotlinx.coroutines.flow.FlowKt__ErrorsKt", f = "Errors.kt", i = {0}, l = {MfiClientException.TYPE_NO_ACCOUNT_INFO}, m = "catchImpl", n = {"fromDownstream"}, s = {"L$0"})
    ...
    static final class C02091 extends SuspendLambda implements Function2<Throwable, Continuation<? super Boolean>, Object> {
        int label;
        ...
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            return new C02091(continuation);
        }

        /* JADX DEBUG: Method merged with bridge method: invoke(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object; */
        @Override // kotlin.jvm.functions.Function2
        public final Object invoke(Throwable th, Continuation<? super Boolean> continuation) {
            return ((C02091) create(th, continuation)).invokeSuspend(Unit.INSTANCE);
        }
    ...
    */
    ...
    static final class AnonymousClass2<T> implements FlowCollector {
        ...
        */
        ...
        public static final <T> Flow<T> m2209catch(Flow<? extends T> flow, Function3<? super FlowCollector<? super T>, ? super Throwable, ? super Continuation<? super Unit>, ? extends Object> function3) {
