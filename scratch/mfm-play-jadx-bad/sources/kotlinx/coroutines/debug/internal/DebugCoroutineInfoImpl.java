...
public final class DebugCoroutineInfoImpl {
    ...
    @DebugMetadata(c = "kotlinx.coroutines.debug.internal.DebugCoroutineInfoImpl$creationStackTrace$1", f = "DebugCoroutineInfoImpl.kt", i = {}, l = {MfiClientException.TYPE_GET_LOCAL_CID_LIST_FAILED}, m = "invokeSuspend", n = {}, s = {})
    ...
    */
    public final Object yieldFrames(SequenceScope<? super StackTraceElement> sequenceScope, CoroutineStackFrame coroutineStackFrame, Continuation<? super Unit> continuation) throws Throwable {
        ...
        if (i == 0) {
            ...
            CoroutineStackFrame coroutineStackFrame2 = (CoroutineStackFrame) c02061.L$2;
            SequenceScope<? super StackTraceElement> sequenceScope2 = (SequenceScope) c02061.L$1;
            debugCoroutineInfoImpl = (DebugCoroutineInfoImpl) c02061.L$0;
            ResultKt.throwOnFailure(obj);
            ...
            if (coroutineStackFrame == null) {
                ...
                if (stackTraceElement != null) {
                    c02061.L$0 = debugCoroutineInfoImpl;
                    c02061.L$1 = sequenceScope;
                    c02061.L$2 = coroutineStackFrame;
                    c02061.label = 1;
                    if (sequenceScope.yield(stackTraceElement, c02061) == coroutine_suspended) {
                        return coroutine_suspended;
                    }
