        ...
        while (i2 != childCount) {
            ...
            if (bitSet.get(layoutParams.mSpan.mIndex)) {
                ...
                if (!layoutParams.mFullSpan && (i = i2 + i3) != childCount) {
                    View childAt22 = getChildAt(i);
                    if (!this.mShouldReverseLayout) {
                        int decoratedEnd = this.mPrimaryOrientation.getDecoratedEnd(childAt);
                        int decoratedEnd2 = this.mPrimaryOrientation.getDecoratedEnd(childAt22);
                        if (decoratedEnd >= decoratedEnd2) {
                            if (decoratedEnd == decoratedEnd2) {
                                if ((layoutParams.mSpan.mIndex - ((LayoutParams) childAt22.getLayoutParams()).mSpan.mIndex < 0) != (b < 0)) {
                                }
                            } else {
                                continue;
                            }
                        ...
                        int decoratedStart2 = this.mPrimaryOrientation.getDecoratedStart(childAt22);
