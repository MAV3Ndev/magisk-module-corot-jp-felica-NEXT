...
public class LogSender {
    ...
    public static void send(Context context, String str, String str2, Bundle bundle) {
        LogMgr.log(5, "000 eventName=" + str + ",logType=" + str2);
        if (context == null) {
        ...
        try {
            prepareUUID(str);
            String uuid = getUUID();
            if (EXTRA_VALUE_EVENT_NAME_SHOW_AGREEMENT.equals(str) || EXTRA_VALUE_EVENT_NAME_SHOW_SIGN_IN.equals(str) || EXTRA_VALUE_EVENT_NAME_SHOW_SKIPPABLE_SIGN_IN.equals(str) || EXTRA_VALUE_EVENT_NAME_SHOW_SIGN_IN_ONLY.equals(str)) {
                LogSenderPreferences.getInstance().putLatestUuidDisplay(uuid);
            } else if (EXTRA_VALUE_EVENT_NAME_ACCOUNT_FIX.equals(str) && uuid != null && !uuid.equals(LogSenderPreferences.getInstance().getLatestUuidDisplay())) {
            ...
            intent.putExtra(EXTRA_KEY_LOG_TYPE, str2);
