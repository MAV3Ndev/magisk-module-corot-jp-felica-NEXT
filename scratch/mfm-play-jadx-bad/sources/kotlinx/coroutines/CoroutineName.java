...
public final /* data */ class CoroutineName extends AbstractCoroutineContextElement {
    ...
    public static final class Companion implements CoroutineContext.Key<CoroutineName> {
        /* JADX DEBUG: Can't inline method, not implemented redirect type for insn: 0x0000: CONSTRUCTOR  A[MD:():void (m)] call: kotlinx.coroutines.CoroutineName.Key.<init>():void type: THIS */
