...
public final class StackTraceRecoveryKt {
    ...
    static {
        ...
        try {
            ...
            objM613constructorimpl = Result.m613constructorimpl(Class.forName(baseContinuationImplClass).getCanonicalName());
        } catch (Throwable th) {
            Result.Companion companion2 = Result.INSTANCE;
            objM613constructorimpl = Result.m613constructorimpl(ResultKt.createFailure(th));
        }
        if (Result.m616exceptionOrNullimpl(objM613constructorimpl) == null) {
            obj2 = objM613constructorimpl;
        }
        baseContinuationImplClassName = (String) obj2;
        try {
            Result.Companion companion3 = Result.INSTANCE;
            objM613constructorimpl2 = Result.m613constructorimpl(Class.forName(stackTraceRecoveryClass).getCanonicalName());
        } catch (Throwable th2) {
            Result.Companion companion4 = Result.INSTANCE;
            objM613constructorimpl2 = Result.m613constructorimpl(ResultKt.createFailure(th2));
        }
        if (Result.m616exceptionOrNullimpl(objM613constructorimpl2) == null) {
            obj = objM613constructorimpl2;
        }
