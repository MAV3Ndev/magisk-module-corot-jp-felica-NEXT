...
public class NestedScrollView extends FrameLayout implements NestedScrollingParent3, NestedScrollingChild3, ScrollingView {
    ...
    public boolean executeKeyEvent(KeyEvent keyEvent) {
        ...
        int i = MobileFeliCaSettings.Result.FAILED_MFICVERSION;
        if (!zCanScroll) {
            ...
            View viewFindNextFocus = FocusFinder.getInstance().findNextFocus(this, viewFindFocus, MobileFeliCaSettings.Result.FAILED_MFICVERSION);
            return (viewFindNextFocus == null || viewFindNextFocus == this || !viewFindNextFocus.requestFocus(MobileFeliCaSettings.Result.FAILED_MFICVERSION)) ? false : true;
        }
        ...
        if (keyCode == 20) {
            if (!keyEvent.isAltPressed()) {
                return arrowScroll(MobileFeliCaSettings.Result.FAILED_MFICVERSION);
            }
            return fullScroll(MobileFeliCaSettings.Result.FAILED_MFICVERSION);
        }
        if (keyCode != 62) {
            return false;
        }
    ...
    */
    ...
    protected boolean onRequestFocusInDescendants(int i, Rect rect) {
        ...
        if (i == 2) {
            i = MobileFeliCaSettings.Result.FAILED_MFICVERSION;
        } else if (i == 1) {
            i = 33;
        }
        if (rect == null) {
