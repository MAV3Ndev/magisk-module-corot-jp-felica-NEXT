...
class GmsRpc {
    ...
    /* JADX DEBUG: Type inference failed for r3v1. Raw type applied. Possible types: com.google.android.gms.tasks.Task<TContinuationResult>, com.google.android.gms.tasks.Task<java.lang.String> */
    private Task<String> extractResponseWhenComplete(Task<Bundle> task) {
        return task.continueWith(new CredentialManager$$ExternalSyntheticLambda0(), new Continuation() { // from class: com.google.firebase.messaging.GmsRpc$$ExternalSyntheticLambda0
            ...
            public final Object then(Task task2) {
                return this.f$0.m604xb80eb67f(task2);
            }
        });
    }
    ...
    /* synthetic */ String m604xb80eb67f(Task task) throws Exception {
