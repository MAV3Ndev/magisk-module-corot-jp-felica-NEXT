...
public abstract class IntLongMap {
    ...
    /* JADX DEBUG: Can't inline method, not implemented redirect type for insn: 0x0000: CONSTRUCTOR  A[MD:():void (m)] call: androidx.collection.IntLongMap.<init>():void type: THIS */
        ...
        while (true) {
            ...
            if ((((~j) << 7) & j & (-9187201950435737472L)) != -9187201950435737472L) {
                ...
                for (int i3 = 0; i3 < i2; i3++) {
                    if ((255 & j) < 128) {
                        int i4 = (i << 3) + i3;
                        iM += UByte$$ExternalSyntheticBackport0.m(jArr[i4]) ^ iArr[i4];
                    }
                    j >>= 8;
                }
                if (i2 != 8) {
