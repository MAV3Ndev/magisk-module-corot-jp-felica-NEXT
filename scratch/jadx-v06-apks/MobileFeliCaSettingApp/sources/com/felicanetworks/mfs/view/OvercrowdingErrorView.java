...
public class OvercrowdingErrorView extends CustomDialogFragment implements FunctionCodeInterface {
    ...
    public void onDialogButtonClick() {
        AnalysisManager.stamp(MfsStamp.Event.ACTION_WID_1_12_CLOSE, new Object[0]);
        try {
    ...
    protected void onSetupDialog() {
        AnalysisManager.stamp(MfsStamp.Event.SCREEN_WID_1_12, new Object[0]);
        setTitle(getString(R.string.dlg_title_011));
        setNegativeText(getString(R.string.btn_msg_012));
        setNegativeButtonListener(new CustomDialogFragment.OnClickListener() { // from class: com.felicanetworks.mfs.view.OvercrowdingErrorView.1
            @Override // com.felicanetworks.mfs.view.CustomDialogFragment.OnClickListener
            public boolean onClick() {
                OvercrowdingErrorView.this.onDialogButtonClick();
                return false;
            }
        });
        setText(getString(R.string.dlg_msg_012));
    }
}
