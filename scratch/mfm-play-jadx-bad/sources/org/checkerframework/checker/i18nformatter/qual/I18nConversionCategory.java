...
public enum I18nConversionCategory {
    UNUSED(null, null),
    GENERAL(null, null),
    DATE(new Class[]{Date.class, Number.class}, new String[]{LogSender.EXTRA_KEY_DATE, "time"}),
    ...
    public String toString() {
        ...
        if (this.types == null) {
            ...
            StringJoiner stringJoinerM = StreamsKt$$ExternalSyntheticApiModelOutline0.m(", ", " conversion category (one of: ", ")");
            for (Class<?> cls : this.types) {
                stringJoinerM.add(cls.getCanonicalName());
            }
