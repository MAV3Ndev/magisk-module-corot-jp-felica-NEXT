...
public class DeleteLegacyCardTask extends AsyncParentTaskBase<String> {
    ...
    DeleteLegacyCardTask(int i, ExecutorService executorService, AsyncTaskBase.Listener listener, String str, FwsClient fwsClient, MfiChipHolder mfiChipHolder, DataManager dataManager) {
