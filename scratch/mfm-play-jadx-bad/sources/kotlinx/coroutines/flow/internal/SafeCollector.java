...
public final class SafeCollector<T> extends ContinuationImpl implements FlowCollector<T>, CoroutineStackFrame {
    ...
    public Object invokeSuspend(Object result) {
        Throwable thM616exceptionOrNullimpl = Result.m616exceptionOrNullimpl(result);
        if (thM616exceptionOrNullimpl != null) {
            this.lastEmissionContext = new DownstreamExceptionContext(thM616exceptionOrNullimpl, getContext());
        }
        Continuation<? super Unit> continuation = this.completion;
    ...
    /* JADX DEBUG: Class process forced to load method for inline: kotlinx.coroutines.flow.internal.SafeCollectorKt.access$getEmitFun$p():kotlin.jvm.functions.Function3 */
