...
public final class MutableIntObjectMap<V> extends IntObjectMap<V> {
 ...
 A[MD:(int):void (m)] (LINE:678) call: androidx.collection.MutableIntObjectMap.<init>(int):void type: THIS */
    ...
    */
    ...
    /* JADX DEBUG: Multi-variable search result rejected for r14v0, resolved type: androidx.collection.MutableIntObjectMap<V> */
