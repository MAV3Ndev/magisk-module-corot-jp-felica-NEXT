...
public class FirebaseApp {
    ...
    public String toString() {
        return Objects.toStringHelper(this).add(MfiContentProvider.Accounts.AccountsColumns.NAME, this.name).add("options", this.options).toString();
    }
    ...
    protected FirebaseApp(final Context context, String str, FirebaseOptions firebaseOptions) {
        ...
        this.dataCollectionConfigStorage = new Lazy<>(new Provider() { // from class: com.google.firebase.-$$Lambda$FirebaseApp$g2HBDSvWXpy9ytXuN68VN_QnBHQ
            @Override // com.google.firebase.inject.Provider
            public final Object get() {
                return this.f$0.lambda$new$0$FirebaseApp(context);
            }
        });
    }
