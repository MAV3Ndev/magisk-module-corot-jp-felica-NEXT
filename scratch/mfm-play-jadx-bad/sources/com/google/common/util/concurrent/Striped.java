...
public abstract class Striped<L> {
    ...
    /* JADX DEBUG: Can't inline method, not implemented redirect type for insn: 0x0003: CONSTRUCTOR false A[MD:(boolean):void (c)] (LINE:220) call: java.util.concurrent.locks.ReentrantLock.<init>(boolean):void type: CONSTRUCTOR */
    ...
    /* JADX DEBUG: Can't inline method, not implemented redirect type for insn: 0x0002: CONSTRUCTOR (r1v0 int) A[MD:(int):void (m)] (LINE:238) call: com.google.common.util.concurrent.Striped.PaddedSemaphore.<init>(int):void type: CONSTRUCTOR */
    ...
    /* JADX DEBUG: Can't inline method, not implemented redirect type for insn: 0x0003: CONSTRUCTOR (r2v0 int), false A[MD:(int, boolean):void (c)] (LINE:250) call: java.util.concurrent.Semaphore.<init>(int, boolean):void type: CONSTRUCTOR */
