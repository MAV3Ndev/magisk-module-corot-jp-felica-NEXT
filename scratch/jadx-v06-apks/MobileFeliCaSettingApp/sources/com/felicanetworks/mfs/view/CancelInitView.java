...
public class CancelInitView extends CustomDialogFragment implements FunctionCodeInterface {
    ...
    public void onDialogButtonClick() {
        AnalysisManager.stamp(MfsStamp.Event.ACTION_WID_1_9_CLOSE, new Object[0]);
        try {
    ...
    protected void onSetupDialog() {
        AnalysisManager.stamp(MfsStamp.Event.SCREEN_WID_1_9, new Object[0]);
        setTitle(getString(R.string.dlg_title_008));
        setNegativeText(getString(R.string.btn_msg_009));
        setNegativeButtonListener(new CustomDialogFragment.OnClickListener() { // from class: com.felicanetworks.mfs.view.CancelInitView.1
            @Override // com.felicanetworks.mfs.view.CustomDialogFragment.OnClickListener
            public boolean onClick() {
                CancelInitView.this.onDialogButtonClick();
                return false;
            }
        });
        setText(getString(R.string.dlg_msg_009));
    }
}
