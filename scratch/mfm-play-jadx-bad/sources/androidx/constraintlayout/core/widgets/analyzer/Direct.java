    ...
    public static boolean solveChain(ConstraintWidgetContainer constraintWidgetContainer, LinearSystem linearSystem, int i, int i2, ChainHead chainHead, boolean z, boolean z2, boolean z3) {
        ...
        while (true) {
            ...
            if (z4) {
                ...
                if (!z) {
                    ...
                    while (!z6) {
                        if (constraintWidget7.getVisibility() != 8) {
                            int margin3 = margin2 + constraintWidget7.mListAnchors[i2].getMargin();
                            if (i == 0) {
                                constraintWidget7.setFinalHorizontal(margin3, constraintWidget7.getWidth() + margin3);
                                horizontalSolvingPass(1, constraintWidget7, constraintWidgetContainer.getMeasurer(), zIsRtl);
                            ...
                            margin2 = margin3 + height + constraintWidget7.mListAnchors[i4].getMargin() + i8;
                        } else if (i == 0) {
                            constraintWidget7.setFinalHorizontal(margin2, margin2);
                            horizontalSolvingPass(r6, constraintWidget7, constraintWidgetContainer.getMeasurer(), zIsRtl);
                        } else {
                            constraintWidget7.setFinalVertical(margin2, margin2);
                ...
                int margin4 = margin + constraintWidget3.mListAnchors[i2].getMargin();
                if (i == 0) {
                    height2 = constraintWidget3.getWidth();
                } else {
                    height2 = constraintWidget3.getHeight();
                }
                margin = margin4 + height2 + constraintWidget3.mListAnchors[i4].getMargin();
                i7++;
