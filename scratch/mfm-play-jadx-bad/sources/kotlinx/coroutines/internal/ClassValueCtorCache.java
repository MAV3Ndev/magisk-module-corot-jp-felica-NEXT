...
final class ClassValueCtorCache extends CtorCache {
    ...
    private static final ClassValueCtorCache$cache$1 cache = new ClassValue<Function1<? super Throwable, ? extends Throwable>>() { // from class: kotlinx.coroutines.internal.ClassValueCtorCache$cache$1
        ...
        /* JADX DEBUG: Class process forced to load method for inline: kotlinx.coroutines.internal.ExceptionsConstructorKt.access$createConstructor(java.lang.Class):kotlin.jvm.functions.Function1 */
        /* JADX DEBUG: Return type fixed from 'kotlin.jvm.functions.Function1<java.lang.Throwable, java.lang.Throwable>' to match base method */
        @Override // java.lang.ClassValue
