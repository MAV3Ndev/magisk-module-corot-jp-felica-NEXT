...
public final class MutableLongObjectMap<V> extends LongObjectMap<V> {
 ...
 A[MD:(int):void (m)] (LINE:678) call: androidx.collection.MutableLongObjectMap.<init>(int):void type: THIS */
    ...
    */
    ...
    /* JADX DEBUG: Multi-variable search result rejected for r14v0, resolved type: androidx.collection.MutableLongObjectMap<V> */
