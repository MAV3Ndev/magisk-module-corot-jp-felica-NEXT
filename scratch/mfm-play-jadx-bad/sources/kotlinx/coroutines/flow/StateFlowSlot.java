...
final class StateFlowSlot extends AbstractSharedFlowSlot<StateFlowImpl<?>> {
    ...
    /* JADX DEBUG: Method merged with bridge method: allocateLocked(Ljava/lang/Object;)Z */
    ...
    /* JADX DEBUG: Method merged with bridge method: freeLocked(Ljava/lang/Object;)[Lkotlin/coroutines/Continuation; */
    @Override // kotlinx.coroutines.flow.internal.AbstractSharedFlowSlot
    ...
    public final void makePending() {
        ...
        while (true) {
            ...
            if (obj == StateFlowKt.NONE) {
                ...
                ((CancellableContinuationImpl) obj).resumeWith(Result.m613constructorimpl(Unit.INSTANCE));
                return;
            }
        }
    }
