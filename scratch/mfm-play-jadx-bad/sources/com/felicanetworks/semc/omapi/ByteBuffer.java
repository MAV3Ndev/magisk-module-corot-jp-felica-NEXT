...
public class ByteBuffer {
    ...
    public ByteBuffer(int i) throws ArrayIndexOutOfBoundsException {
        if (i < 0) {
            throw new ArrayIndexOutOfBoundsException(ObfuscatedMsgUtil.executionPoint(String.valueOf(i)));
        }
    ...
    public final void append(byte b) throws ArrayIndexOutOfBoundsException {
        ...
        if (i == bArr.length) {
            throw new ArrayIndexOutOfBoundsException(ObfuscatedMsgUtil.executionPoint(String.valueOf(this.mCount)));
        }
        this.mCount = i + 1;
        bArr[i] = b;
    }
    ...
    public final void append(byte[] bArr, int i, int i2) throws ArrayIndexOutOfBoundsException, NullPointerException {
        ...
        if (i2 < 0) {
            throw new ArrayIndexOutOfBoundsException(ObfuscatedMsgUtil.executionPoint(String.valueOf(i2)));
        }
        int i3 = i + i2;
        if (i3 > bArr.length) {
            throw new ArrayIndexOutOfBoundsException(ObfuscatedMsgUtil.executionPoint(String.valueOf(i3)));
        }
        int i4 = this.mCount;
        int i5 = i4 + i2;
        byte[] bArr2 = this.mBytes;
        if (i5 > bArr2.length) {
            throw new ArrayIndexOutOfBoundsException(ObfuscatedMsgUtil.executionPoint(String.valueOf(this.mCount + i2)));
        }
    ...
    public final void copy(int i, byte[] bArr, int i2, int i3) throws ArrayIndexOutOfBoundsException, NullPointerException {
        ...
        int i4 = i2 + i3;
        if (i4 > bArr.length) {
            throw new ArrayIndexOutOfBoundsException(ObfuscatedMsgUtil.executionPoint(String.valueOf(i4)));
        }
        if (i < 0) {
            throw new ArrayIndexOutOfBoundsException(ObfuscatedMsgUtil.executionPoint(String.valueOf(i)));
        }
        if (i + i3 > this.mCount) {
            throw new ArrayIndexOutOfBoundsException(ObfuscatedMsgUtil.executionPoint(String.valueOf(i3 + i3)));
        }
