...
public class MfcDisableErrorView extends CustomDialogFragment implements FunctionCodeInterface {
    ...
    protected void onSetupDialog() {
        AnalysisManager.stamp(MfsStamp.Event.SCREEN_WID_1_27, new Object[0]);
        setTitle(getString(R.string.dlg_title_031));
        setNegativeText(getString(R.string.btn_msg_035));
        setNegativeButtonListener(new CustomDialogFragment.OnClickListener() { // from class: com.felicanetworks.mfs.view.MfcDisableErrorView.1
            @Override // com.felicanetworks.mfs.view.CustomDialogFragment.OnClickListener
            public boolean onClick() {
                MfcDisableErrorView.this.onDialogNegativeButtonClick();
                return false;
            }
        });
        setText(getString(R.string.dlg_msg_039));
    }
}
