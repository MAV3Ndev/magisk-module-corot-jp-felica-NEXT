...
public final class FloatFloatPair {
    ...
    /* JADX DEBUG: Can't inline method, not implemented redirect type for insn: 0x0002: CONSTRUCTOR (r1v0 long) A[MD:(long):void (m)] call: androidx.collection.FloatFloatPair.<init>(long):void type: CONSTRUCTOR */
    /* JADX INFO: renamed from: box-impl, reason: not valid java name */
    public static final /* synthetic */ FloatFloatPair m38boximpl(long j) {
    ...
    public boolean equals(Object obj) {
        return m43equalsimpl(this.packedValue, obj);
    }

    public int hashCode() {
        return m47hashCodeimpl(this.packedValue);
    }
    ...
    /* JADX DEBUG: Method not inlined, still used in: [androidx.collection.FloatFloatPair.box-impl(long):androidx.collection.FloatFloatPair] */
    ...
    /* JADX INFO: renamed from: constructor-impl, reason: not valid java name */
    public static long m41constructorimpl(float f, float f2) {
        return m42constructorimpl((((long) Float.floatToRawIntBits(f2)) & 4294967295L) | (Float.floatToRawIntBits(f) << 32));
    }

    /* JADX INFO: renamed from: getFirst-impl, reason: not valid java name */
    public static final float m45getFirstimpl(long j) {
        return Float.intBitsToFloat((int) (j >> 32));
    }

    /* JADX INFO: renamed from: getSecond-impl, reason: not valid java name */
    public static final float m46getSecondimpl(long j) {
        return Float.intBitsToFloat((int) (j & 4294967295L));
    }

    /* JADX INFO: renamed from: component1-impl, reason: not valid java name */
    public static final float m39component1impl(long j) {
        return Float.intBitsToFloat((int) (j >> 32));
    }

    /* JADX INFO: renamed from: component2-impl, reason: not valid java name */
    public static final float m40component2impl(long j) {
        return Float.intBitsToFloat((int) (j & 4294967295L));
    }
}
