...
public class AppCompatSpinner extends Spinner implements TintableBackgroundView {
    ...
    public final class InspectionCompanion implements android.view.inspector.InspectionCompanion<AppCompatSpinner> {
        ...
        public void readProperties(AppCompatSpinner appCompatSpinner, PropertyReader propertyReader) {
            if (!this.mPropertiesMapped) {
                throw ComponentDialog$$ExternalSyntheticApiModelOutline0.m16m();
            }
    ...
    /* JADX DEBUG: Multi-variable search result rejected for r2v2, resolved type: android.content.res.TypedArray */
    /* JADX DEBUG: Multi-variable search result rejected for r2v3, resolved type: android.content.res.TypedArray */
    /* JADX DEBUG: Multi-variable search result rejected for r2v4, resolved type: android.content.res.TypedArray */
