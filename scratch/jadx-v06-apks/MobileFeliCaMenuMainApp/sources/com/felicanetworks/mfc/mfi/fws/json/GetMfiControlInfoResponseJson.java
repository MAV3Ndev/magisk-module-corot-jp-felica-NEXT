...
public class GetMfiControlInfoResponseJson extends ResponseJson {
    ...
    public GetMfiControlInfoResponseJson(String str) throws JSONException {
        super(str);
    }
    ...
    public List<String> getService1ServiceIdList() throws JSONException {
        ...
        ArrayList arrayList = new ArrayList();
        for (int i = 0; i < jSONArrayCheckArray.length(); i++) {
            arrayList.add(JsonUtil.checkString(JsonUtil.checkObject(jSONArrayCheckArray, i, true), NAME_SERVICE_ID, true, 8));
        }
        return arrayList;
    }
    ...
    private List<String> getTargetServiceIdList(JSONObject jSONObject) throws JSONException {
        JSONArray jSONArrayCheckArray = JsonUtil.checkArray(jSONObject, NAME_TARGET_SERVICE_ID_LIST, true);
        ArrayList arrayList = new ArrayList();
        for (int i = 0; i < jSONArrayCheckArray.length(); i++) {
            arrayList.add(JsonUtil.checkString(JsonUtil.checkObject(jSONArrayCheckArray, i, true), NAME_SERVICE_ID, true, 8));
        }
