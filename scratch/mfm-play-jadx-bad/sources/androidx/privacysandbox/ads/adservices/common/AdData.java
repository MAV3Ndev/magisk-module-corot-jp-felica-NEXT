...
public final class AdData {
  ...
  (r7v0 android.net.Uri)
  (r8v0 java.lang.String)
  (wrap:java.util.Set:0x0008: TERNARY null = ((wrap:int:0x0000: ARITH (r12v0 int) & (4 int) A[WRAPPED]) != (0 int)) ? (wrap:java.util.Set:0x0004: INVOKE  STATIC call: kotlin.collections.SetsKt.emptySet():java.util.Set A[MD:<T>:():java.util.Set<T> (m), WRAPPED] (LINE:44)) : (r9v0 java.util.Set))
  (wrap:androidx.privacysandbox.ads.adservices.common.AdFilters:?: TERNARY null = ((wrap:int:0x0009: ARITH (r12v0 int) & (8 int) A[WRAPPED]) != (0 int)) ? (null androidx.privacysandbox.ads.adservices.common.AdFilters) : (r10v0 androidx.privacysandbox.ads.adservices.common.AdFilters))
  (wrap:java.lang.String:?: TERNARY null = ((wrap:int:0x0011: ARITH (r12v0 int) & (16 int) A[WRAPPED]) != (0 int)) ? (null java.lang.String) : (r11v0 java.lang.String))
 A[MD:(android.net.Uri, java.lang.String, java.util.Set<java.lang.Integer>, androidx.privacysandbox.ads.adservices.common.AdFilters, java.lang.String):void (m)] (LINE:41) call: androidx.privacysandbox.ads.adservices.common.AdData.<init>(android.net.Uri, java.lang.String, java.util.Set, androidx.privacysandbox.ads.adservices.common.AdFilters, java.lang.String):void type: THIS */
  ...
  (wrap:java.util.Set:?: TERNARY null = ((wrap:int:0x0000: ARITH (r5v0 int) & (4 int) A[WRAPPED]) != (0 int)) ? (wrap:java.util.Set:0x0004: INVOKE  STATIC call: kotlin.collections.SetsKt.emptySet():java.util.Set A[MD:<T>:():java.util.Set<T> (m), WRAPPED] (LINE:60)) : (r3v0 java.util.Set))
  (wrap:androidx.privacysandbox.ads.adservices.common.AdFilters:?: TERNARY null = ((wrap:int:0x0008: ARITH (r5v0 int) & (8 int) A[WRAPPED]) != (0 int)) ? (null androidx.privacysandbox.ads.adservices.common.AdFilters) : (r4v0 androidx.privacysandbox.ads.adservices.common.AdFilters))
 A[MD:(android.net.Uri, java.lang.String, java.util.Set<java.lang.Integer>, androidx.privacysandbox.ads.adservices.common.AdFilters):void (m)] (LINE:57) call: androidx.privacysandbox.ads.adservices.common.AdData.<init>(android.net.Uri, java.lang.String, java.util.Set, androidx.privacysandbox.ads.adservices.common.AdFilters):void type: THIS */
    ...
    /* JADX DEBUG: Don't trust debug lines info. Repeating lines: [98=6, 99=5] */
    ...
    private static final class Ext10Impl {
        ...
        public static final class Companion {
            /* JADX DEBUG: Can't inline method, not implemented redirect type for insn: 0x0000: CONSTRUCTOR  A[MD:():void (m)] call: androidx.privacysandbox.ads.adservices.common.AdData.Ext10Impl.Companion.<init>():void type: THIS */
            ...
            public final android.adservices.common.AdData convertAdData(AdData adData) {
                ...
                AdData.Builder adCounterKeys = AdFilters$$ExternalSyntheticApiModelOutline0.m288m().setMetadata(adData.getMetadata()).setRenderUri(adData.getRenderUri()).setAdCounterKeys(adData.getAdCounterKeys());
    ...
    private static final class Ext8Impl {
        ...
        public static final class Companion {
            /* JADX DEBUG: Can't inline method, not implemented redirect type for insn: 0x0000: CONSTRUCTOR  A[MD:():void (m)] call: androidx.privacysandbox.ads.adservices.common.AdData.Ext8Impl.Companion.<init>():void type: THIS */
            public /* synthetic */ Companion(DefaultConstructorMarker defaultConstructorMarker) {
                this();
            }
    ...
    private static final class Ext4Impl {
        ...
        public static final class Companion {
            /* JADX DEBUG: Can't inline method, not implemented redirect type for insn: 0x0000: CONSTRUCTOR  A[MD:():void (m)] call: androidx.privacysandbox.ads.adservices.common.AdData.Ext4Impl.Companion.<init>():void type: THIS */
            public /* synthetic */ Companion(DefaultConstructorMarker defaultConstructorMarker) {
                this();
            }
            ...
            public final android.adservices.common.AdData convertAdData(AdData adData) {
                ...
                android.adservices.common.AdData adDataBuild = AdFilters$$ExternalSyntheticApiModelOutline0.m288m().setMetadata(adData.getMetadata()).setRenderUri(adData.getRenderUri()).build();
                Intrinsics.checkNotNullExpressionValue(adDataBuild, "Builder()\n              …                 .build()");
                return adDataBuild;
            }
        }
