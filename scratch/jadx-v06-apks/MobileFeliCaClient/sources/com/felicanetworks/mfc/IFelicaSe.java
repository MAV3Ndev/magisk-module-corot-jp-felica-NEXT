...
public interface IFelicaSe extends IInterface {
    FelicaResultInfo activateFelica(String[] strArr, IFelicaEventListener iFelicaEventListener, IBinder iBinder) throws RemoteException;
    ...
    public static abstract class Stub extends Binder implements IFelicaSe {
        private static final String DESCRIPTOR = "com.felicanetworks.mfc.IFelicaSe";
        static final int TRANSACTION_activateFelica = 1;
        static final int TRANSACTION_cancelOffline = 24;
        static final int TRANSACTION_checkOnlineAccess = 21;
        static final int TRANSACTION_close = 2;
        static final int TRANSACTION_executeFelicaCommand = 25;
        ...
        static final int TRANSACTION_getKeyVersionV2 = 27;
        static final int TRANSACTION_getNodeInformation = 9;
        static final int TRANSACTION_getPrivacyNodeInformation = 10;
        static final int TRANSACTION_getSelectTimeout = 23;
        static final int TRANSACTION_getSystemCode = 11;
        static final int TRANSACTION_getSystemCodeList = 12;
        static final int TRANSACTION_inactivateFelica = 13;
        static final int TRANSACTION_isConnected = 26;
        static final int TRANSACTION_open = 14;
        static final int TRANSACTION_read = 15;
        static final int TRANSACTION_reset = 16;
        static final int TRANSACTION_select = 17;
        static final int TRANSACTION_setNodeCodeSize = 20;
        static final int TRANSACTION_setPrivacy = 18;
        static final int TRANSACTION_setSelectTimeout = 22;
        static final int TRANSACTION_write = 19;
        ...
        public static IFelicaSe asInterface(IBinder iBinder) {
            if (iBinder == null) {
                return null;
            }
            IInterface iInterfaceQueryLocalInterface = iBinder.queryLocalInterface(DESCRIPTOR);
            if (iInterfaceQueryLocalInterface != null && (iInterfaceQueryLocalInterface instanceof IFelicaSe)) {
                return (IFelicaSe) iInterfaceQueryLocalInterface;
            }
        ...
        public boolean onTransact(int i, Parcel parcel, Parcel parcel2, int i2) throws RemoteException {
            ...
            switch (i) {
                case 1:
                    ...
                    FelicaResultInfo felicaResultInfoActivateFelica = activateFelica(parcel.createStringArray(), IFelicaEventListener.Stub.asInterface(parcel.readStrongBinder()), parcel.readStrongBinder());
        ...
        private static class Proxy implements IFelicaSe {
