...
public class ExtIcCardReadingFragment extends BaseFragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        View viewInflate = inflater.inflate(R.layout.fragment_card_reader, container, false);
        try {
            ...
            ((Button) viewInflate.findViewById(R.id.button_guide_card_reader_announce)).setOnClickListener(new View.OnClickListener() { // from class: com.felicanetworks.mfm.main.view.views.ExtIcCardReadingFragment.2
                @Override // android.view.View.OnClickListener
                public void onClick(View v) {
                    AnalysisManager.stamp(MfmStamp.Event.ACTION_MENU_SETTINGS, new Object[0]);
                    Structure structure = ExtIcCardReadingFragment.this.getStructure();
                    if (structure instanceof ExtIcCardDrawStructure) {
                        ((ExtIcCardDrawStructure) structure).actSetting();
                    }
                }
            });
    ...
    public void onResume() {
        ...
        try {
            ...
            if (!extIcCardDrawStructure.isEnableRWP2P()) {
                ...
                customDialogFragmentCreateSelectDialog.setPositiveButtonListener(new CustomDialogFragment.OnClickListener() { // from class: com.felicanetworks.mfm.main.view.views.ExtIcCardReadingFragment.3
                ...
                customDialogFragmentCreateSelectDialog.setNegativeButtonListener(new CustomDialogFragment.OnClickListener() { // from class: com.felicanetworks.mfm.main.view.views.ExtIcCardReadingFragment.4
                    @Override // com.felicanetworks.mfm.main.view.views.CustomDialogFragment.OnClickListener
                    public boolean onClick() {
    ...
    public void switchProcessing(boolean processing) {
        View view = getView();
        if (view == null) {
            this.mIsOnDiscoverNotified = processing;
            return;
        }
        if (processing) {
