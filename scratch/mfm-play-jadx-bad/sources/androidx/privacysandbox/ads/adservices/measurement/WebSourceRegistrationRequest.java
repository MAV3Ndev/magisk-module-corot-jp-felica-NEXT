...
public final class WebSourceRegistrationRequest {
  ...
  (r2v0 java.util.List)
  (r3v0 android.net.Uri)
  (wrap:android.view.InputEvent:?: TERNARY null = ((wrap:int:0x0000: ARITH (r8v0 int) & (4 int) A[WRAPPED]) != (0 int)) ? (null android.view.InputEvent) : (r4v0 android.view.InputEvent))
  (wrap:android.net.Uri:?: TERNARY null = ((wrap:int:0x0006: ARITH (r8v0 int) & (8 int) A[WRAPPED]) != (0 int)) ? (null android.net.Uri) : (r5v0 android.net.Uri))
  (wrap:android.net.Uri:?: TERNARY null = ((wrap:int:0x000b: ARITH (r8v0 int) & (16 int) A[WRAPPED]) != (0 int)) ? (null android.net.Uri) : (r6v0 android.net.Uri))
  (wrap:android.net.Uri:?: TERNARY null = ((wrap:int:0x0010: ARITH (r8v0 int) & (32 int) A[WRAPPED]) != (0 int)) ? (null android.net.Uri) : (r7v0 android.net.Uri))
 A[MD:(java.util.List<androidx.privacysandbox.ads.adservices.measurement.WebSourceParams>, android.net.Uri, android.view.InputEvent, android.net.Uri, android.net.Uri, android.net.Uri):void (m)] (LINE:44) call: androidx.privacysandbox.ads.adservices.measurement.WebSourceRegistrationRequest.<init>(java.util.List, android.net.Uri, android.view.InputEvent, android.net.Uri, android.net.Uri, android.net.Uri):void type: THIS */
    ...
    /* JADX DEBUG: Don't trust debug lines info. Repeating lines: [89=8, 90=4] */
