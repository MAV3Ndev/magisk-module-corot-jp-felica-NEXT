...
public class FpServiceListActivity extends BranchBaseActivity {
    ...
    public void onCreate(Bundle bundle) {
        try {
            ...
            getSupportActionBar().setTitle(R.string.toolbar_title_felicapocket);
    ...
    /* JADX INFO: renamed from: com.felicanetworks.mfm.main.view.activity.FpServiceListActivity$1, reason: invalid class name */
    static /* synthetic */ class AnonymousClass1 {
        ...
        static {
            ...
            try {
                iArr[StructureType.FELICA_POCKET.ordinal()] = 1;
    ...
    private void showContentView() {
        ...
        fragmentTransactionBeginTransaction.replace(R.id.fl_content_fragment, new FpServiceListFragment());
