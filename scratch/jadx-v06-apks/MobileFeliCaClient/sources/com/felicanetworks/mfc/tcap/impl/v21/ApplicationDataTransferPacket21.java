...
class ApplicationDataTransferPacket21 extends Packet {
    ...
    ApplicationDataTransferPacket21() {
        super(TcapSession21.TCAP_VERSION_21, (byte) 4);
    }

    ApplicationDataTransferPacket21(Packet packet) {
        super(packet);
    }
        ...
        while (size < this.mOffset + this.mSize) {
            ...
            if (id != 0) {
                if (id == 1) {
                    ...
                    if (id == MID_FELICA_COMMAND && (internalDeviceList.getById(message.getDeviceId()) instanceof FeliCaChipWrapper)) {
