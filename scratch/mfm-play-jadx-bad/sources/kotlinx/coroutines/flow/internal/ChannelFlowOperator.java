...
public abstract class ChannelFlowOperator<S, T> extends ChannelFlow<T> {
    ...
    /* JADX DEBUG: Class process forced to load method for inline: kotlinx.coroutines.flow.internal.ChannelFlowKt.access$withUndispatchedContextCollector(kotlinx.coroutines.flow.FlowCollector, kotlin.coroutines.CoroutineContext):kotlinx.coroutines.flow.FlowCollector */
