...
public class CognitoCachingCredentialsProvider extends CognitoCredentialsProvider {
    ...
    private static final String USER_AGENT = CognitoCachingCredentialsProvider.class.getName() + DomExceptionUtils.SEPARATOR + VersionInfoUtils.getVersion();
    ...
    /* JADX DEBUG: Method merged with bridge method: getCredentials()Lcom/amazonaws/auth/AWSCredentials; */
