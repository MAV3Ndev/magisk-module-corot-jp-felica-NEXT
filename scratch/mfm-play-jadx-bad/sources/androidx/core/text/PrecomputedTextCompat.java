...
public class PrecomputedTextCompat implements Spannable {
    ...
    public static final class Params {
        ...
        Params(TextPaint textPaint, TextDirectionHeuristic textDirectionHeuristic, int i, int i2) {
            if (Build.VERSION.SDK_INT >= 29) {
                this.mWrapped = Profiling$$ExternalSyntheticApiModelOutline0.m108m(textPaint).setBreakStrategy(i).setHyphenationFrequency(i2).setTextDirection(textDirectionHeuristic).build();
            } else {
                this.mWrapped = null;
            }
            this.mPaint = textPaint;
    ...
    public PrecomputedText getPrecomputedText() {
        if (Profiling$$ExternalSyntheticApiModelOutline0.m123m((Object) this.mText)) {
            return Profiling$$ExternalSyntheticApiModelOutline0.m109m((Object) this.mText);
        }
        return null;
    }
