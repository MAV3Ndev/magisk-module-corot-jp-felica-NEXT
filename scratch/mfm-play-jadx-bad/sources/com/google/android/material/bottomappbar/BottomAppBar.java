...
public class BottomAppBar extends Toolbar implements CoordinatorLayout.AttachedBehavior {
    ...
    protected void onLayout(boolean z, int i, int i2, int i3, int i4) {
        ...
        if (z) {
            ...
            if (viewFindDependentView != null && ViewCompat.isLaidOut(viewFindDependentView)) {
                viewFindDependentView.post(new Runnable() { // from class: com.google.android.material.bottomappbar.BottomAppBar$$ExternalSyntheticLambda2
    ...
    /* JADX DEBUG: Method merged with bridge method: getBehavior()Landroidx/coordinatorlayout/widget/CoordinatorLayout$Behavior; */
