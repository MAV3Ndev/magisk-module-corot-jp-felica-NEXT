...
public class MfiClientCallbackConst {
    ...
    public static final String MSG_INVALID_LINKAGE_DATA_LIST = "Invalid linkage data list error.";
    ...
    public static final String MSG_STATE_ERROR = "Illegal state error.";
    ...
    public static final int TYPE_INVALID_RESPONSE_LINKADGE_DATA_LIST = 220;
    ...
    public enum Api {
        ...
        FELICA_GET_IDM("Felica#getIDm()"),
        FELICA_GET_IC_CODE("Felica#getICCode()"),
        ...
        Api(String str) {
            this.msg = Integer.toHexString(str.hashCode());
        }
    }
}
