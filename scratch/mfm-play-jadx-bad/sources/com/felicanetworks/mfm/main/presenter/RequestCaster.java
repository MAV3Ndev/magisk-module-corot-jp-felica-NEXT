...
public class RequestCaster {
    ...
    public void request(final Structure structure) {
        try {
    ...
    public static void registerObservers(StructureType[] types, RequestObserver observer) throws MfmException {
        try {
            for (StructureType structureType : types) {
                _this._observers.put(structureType, observer);
            }
        } catch (Exception e) {
    ...
    public static void unregisterObserver(StructureType[] types) {
        try {
            for (StructureType structureType : types) {
