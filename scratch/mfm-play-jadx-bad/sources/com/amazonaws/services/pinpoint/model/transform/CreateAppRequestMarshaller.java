...
public class CreateAppRequestMarshaller implements Marshaller<Request<CreateAppRequest>, CreateAppRequest> {
    ...
    public Request<CreateAppRequest> marshall(CreateAppRequest createAppRequest) {
        ...
        DefaultRequest defaultRequest = new DefaultRequest(createAppRequest, "AmazonPinpoint");
        ...
        try {
            ...
            if (createAppRequest.getCreateApplicationRequest() != null) {
                CreateApplicationRequestJsonMarshaller.getInstance().marshall(createAppRequest.getCreateApplicationRequest(), jsonWriter);
            }
            jsonWriter.close();
