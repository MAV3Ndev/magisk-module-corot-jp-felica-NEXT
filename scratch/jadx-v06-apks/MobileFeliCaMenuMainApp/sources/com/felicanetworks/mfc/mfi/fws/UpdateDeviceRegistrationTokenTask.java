...
public class UpdateDeviceRegistrationTokenTask extends AsyncParentTaskBase<Void> {
    ...
    static {
        ...
        arrayList.add("0000");
        VALID_RESULT_CODE_LIST_UPDATE_DEVICE_REG_TOKEN.add(FwsConst.RESULT_CODE_RETRYREQUEST);
        VALID_RESULT_CODE_LIST_UPDATE_DEVICE_REG_TOKEN.add(FwsConst.RESULT_ILLEGAL_ARGUMENTS);
        VALID_RESULT_CODE_LIST_UPDATE_DEVICE_REG_TOKEN.add(FwsConst.RESULT_ILLEGAL_URL);
        VALID_RESULT_CODE_LIST_UPDATE_DEVICE_REG_TOKEN.add(FwsConst.RESULT_ILLEGAL_REQUEST_TOKEN);
        VALID_RESULT_CODE_LIST_UPDATE_DEVICE_REG_TOKEN.add(FwsConst.RESULT_INVALID_REQUEST_TOKEN);
        VALID_RESULT_CODE_LIST_UPDATE_DEVICE_REG_TOKEN.add("4000");
        VALID_RESULT_CODE_LIST_UPDATE_DEVICE_REG_TOKEN.add("9001");
        VALID_RESULT_CODE_LIST_UPDATE_DEVICE_REG_TOKEN.add(FwsConst.RESULT_CONGESTED);
    }
    ...
    private String createDeviceRegistrationRequestToken(a aVar, String str) {
        String strA;
        LogMgr.log(6, "000");
        try {
            ...
            deviceRegistrationRequestTokenPayloadJson.setRegistrationToken(str);
            LogMgr.log(6, "001");
            strA = aVar.a(deviceRegistrationRequestTokenPayloadJson);
