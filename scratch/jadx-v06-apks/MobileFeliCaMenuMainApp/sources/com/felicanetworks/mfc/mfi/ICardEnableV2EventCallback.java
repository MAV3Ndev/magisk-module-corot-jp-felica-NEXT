...
public interface ICardEnableV2EventCallback extends IInterface {
    ...
    public static abstract class Stub extends Binder implements ICardEnableV2EventCallback {
        private static final String DESCRIPTOR = "com.felicanetworks.mfc.mfi.ICardEnableV2EventCallback";
        ...
        public static ICardEnableV2EventCallback asInterface(IBinder iBinder) {
            if (iBinder == null) {
                return null;
            }
