...
public class Felica extends Service {
    ...
    class MfcConnection implements ServiceConnection {
        ...
        public void onServiceConnected(ComponentName componentName, IBinder iBinder) {
            ...
            if (felicaEventListener != null) {
                ...
                felicaEventListener.errorOccurred(i, null, appInfo3);
            }
            LogMgr.log(3, "%s", "999");
        }
    ...
    public static String getMfiClientVersion(Context context) throws MfiClientException {
        ...
        try {
            ...
            String string = resourcesForApplication.getString(resourcesForApplication.getIdentifier(MFI_CLIENT_VERSION_RESOURCE_NAME, "string", "com.felicanetworks.mfm.main"));
            LogMgr.log(3, "%s", "999");
            return string;
        } catch (Exception e) {
