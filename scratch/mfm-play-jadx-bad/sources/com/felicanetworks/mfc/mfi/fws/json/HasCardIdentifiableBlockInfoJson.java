...
public class HasCardIdentifiableBlockInfoJson extends JSONObject {
    ...
    public HasCardIdentifiableBlockInfoJson(String json) throws JSONException {
        super(json);
    }
    ...
    protected List<CardIdBlockInfo> getIdBlockList(JSONArray blockJArray, boolean hasBlockMask) throws JSONException {
        ArrayList arrayList = new ArrayList();
        int length = blockJArray.length();
        for (int i = 0; i < length; i++) {
            JSONObject jSONObjectCheckObject = JsonUtil.checkObject(blockJArray, i, true);
