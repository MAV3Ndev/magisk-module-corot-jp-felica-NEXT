...
public abstract class BufferFillPolicy {
    ...
    /* JADX DEBUG: Can't inline method, not implemented redirect type for insn: 0x0000: CONSTRUCTOR (r1v0 int) A[MD:(int):void (m)] call: androidx.core.os.BufferFillPolicy.<init>(int):void type: THIS */
