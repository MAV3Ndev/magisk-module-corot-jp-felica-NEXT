...
public class FelicaResultInfoNodeInformation extends FelicaResultInfoType implements Parcelable {
    public static final Parcelable.Creator CREATOR = new g0();

    /* synthetic */ FelicaResultInfoNodeInformation(Parcel parcel, g0 g0Var) {
        this(parcel);
    }
    ...
    protected void c(Parcel parcel) {
        ...
        super.c(parcel);
        this.h = parcel.readParcelable(NodeInformation.class.getClassLoader());
