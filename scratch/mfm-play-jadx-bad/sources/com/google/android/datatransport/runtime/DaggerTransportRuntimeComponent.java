...
final class DaggerTransportRuntimeComponent extends TransportRuntimeComponent {
    ...
    private static final class Builder implements TransportRuntimeComponent.Builder {
        ...
        /* JADX DEBUG: Method merged with bridge method: setApplicationContext(Landroid/content/Context;)Lcom/google/android/datatransport/runtime/TransportRuntimeComponent$Builder; */
