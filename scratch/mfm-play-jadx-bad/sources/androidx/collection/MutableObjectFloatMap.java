...
public final class MutableObjectFloatMap<K> extends ObjectFloatMap<K> {
 ...
 A[MD:(int):void (m)] (LINE:693) call: androidx.collection.MutableObjectFloatMap.<init>(int):void type: THIS */
    ...
    /* JADX DEBUG: Multi-variable search result rejected for r14v0, resolved type: androidx.collection.MutableObjectFloatMap<K> */
    ...
    /* JADX DEBUG: Multi-variable search result rejected for r13v0, resolved type: androidx.collection.MutableObjectFloatMap<K> */
    /* JADX WARN: Multi-variable type inference failed */
