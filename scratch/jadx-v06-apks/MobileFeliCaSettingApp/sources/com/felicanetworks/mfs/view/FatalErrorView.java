...
public class FatalErrorView extends CustomDialogFragment implements FunctionCodeInterface {
    ...
    public FatalErrorView applyArgument(String str) {
    ...
    public void onDialogButtonClick() {
        AnalysisManager.stamp(MfsStamp.Event.ACTION_WID_2_1_CLOSE, new Object[0]);
        try {
    ...
    protected void onSetupDialog() {
        AnalysisManager.stamp(MfsStamp.Event.SCREEN_WID_2_1, this._errorId);
        setTitle(getString(R.string.dlg_title_018));
        setNegativeText(getString(R.string.btn_msg_018));
        setNegativeButtonListener(new CustomDialogFragment.OnClickListener() { // from class: com.felicanetworks.mfs.view.FatalErrorView.1
            @Override // com.felicanetworks.mfs.view.CustomDialogFragment.OnClickListener
            public boolean onClick() {
                FatalErrorView.this.onDialogButtonClick();
                return false;
            }
        });
        setText(getString(R.string.dlg_msg_017));
        setText2(getString(R.string.dlg_msg_021, this._errorId));
    }
}
