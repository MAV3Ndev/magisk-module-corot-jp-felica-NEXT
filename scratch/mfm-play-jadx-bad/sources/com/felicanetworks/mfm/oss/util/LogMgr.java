package com.felicanetworks.mfm.oss.util;
...
public class LogMgr {
    ...
    private static final String PERFORMANCE_TAG_MODULE = "OssLicenseViewer";
    public static final String PERFORMANCE_UI = "UI";
    public static final int PKG = 4;
    private static final String P_CMP = "[OSS-Viewer]";
