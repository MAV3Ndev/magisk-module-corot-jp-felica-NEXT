...
public class ShapeableImageView extends AppCompatImageView implements Shapeable {
    ...
    public ShapeableImageView(Context context, AttributeSet attributeSet, int i) {
        ...
        this.strokeColor = MaterialResources.getColorStateList(context2, context2.obtainStyledAttributes(attributeSet, R.styleable.ShapeableImageView, i, DEF_STYLE_RES), R.styleable.ShapeableImageView_strokeColor);
