...
public class Felica extends Service {
    ...
    public synchronized void select(int systemCode) throws FelicaException, IllegalArgumentException {
        ...
        try {
            try {
                ...
                LogMgr.performanceIn(LogMgr.PERFORMANCE_MFC, "Felica", "select", "systemCode = 0x" + String.format("%04x", Integer.valueOf(systemCode)));
                MfcUtil.checkMfcResult(this.felica.select(systemCode));
    ...
    public synchronized void select(int systemCode, String cid) throws FelicaException, IllegalArgumentException {
        ...
        try {
            checkActivated();
            if (systemCode < 0 || systemCode > 65535) {
                LogMgr.log(2, "710 systemCode:" + systemCode);
                throw new IllegalArgumentException("The specified System Code is out of range.");
            }
            if (systemCode == 65535 || (systemCode & 65280) == 65280 || (systemCode & 255) == 255) {
                LogMgr.log(2, "711 systemCode:" + systemCode);
                throw new IllegalArgumentException("The specified System Code is out of range.");
            }
            ...
            LogMgr.performanceIn(LogMgr.PERFORMANCE_MFC, "Felica", "selectWithCid", "systemCode = 0x" + String.format("%04x", Integer.valueOf(systemCode)));
            MfcUtil.checkMfcResult(this.felica.selectWithCid(systemCode, cid));
            ...
            LogMgr.log(2, "702 systemCode:" + systemCode);
            throw e2;
        } catch (Exception unused) {
    ...
    public synchronized void select(int target, int systemCode) throws FelicaException, IllegalArgumentException {
        ...
        try {
            ...
            LogMgr.performanceIn(LogMgr.PERFORMANCE_MFC, "Felica", "selectWithTarget", "systemCode = 0x" + String.format("%04x", Integer.valueOf(systemCode)) + ", target = " + target);
            MfcUtil.checkMfcResult(this.felica.selectWithTarget(target, systemCode));
    ...
    public synchronized int getKeyVersion(int serviceCode) throws FelicaException, IllegalArgumentException {
        ...
        try {
            ...
            FelicaResultInfoInt keyVersion = this.felica.getKeyVersion(serviceCode, this.timeout, this.retryCount);
    ...
    public synchronized void setNodeCodeSize(int nodeCodeSize) throws FelicaException, IllegalArgumentException {
        ...
        try {
            ...
            MfcUtil.checkMfcResult(this.felica.setNodeCodeSize(nodeCodeSize, this.timeout, this.retryCount));
    ...
    public synchronized NodeInformation getNodeInformation(int parentAreaCode) throws FelicaException, IllegalArgumentException {
        ...
        try {
            try {
                ...
                FelicaResultInfoNodeInformation nodeInformation = this.felica.getNodeInformation(parentAreaCode, this.timeout, this.retryCount);
    ...
    public synchronized NodeInformation getPrivacyNodeInformation(int parentAreaCode) throws FelicaException, IllegalArgumentException {
        ...
        try {
            try {
                ...
                FelicaResultInfoNodeInformation privacyNodeInformation = this.felica.getPrivacyNodeInformation(parentAreaCode, this.timeout, this.retryCount);
    ...
    public synchronized BlockCountInformation[] getBlockCountInformation(int[] nodeCodeList) throws FelicaException, IllegalArgumentException {
        ...
        try {
            ...
            FelicaResultInfoBlockCountInformationArray blockCountInformation = this.felica.getBlockCountInformation(nodeCodeList, this.timeout, this.retryCount);
    ...
    public synchronized void setPrivacy(PrivacySettingData[] privacySettingData) throws FelicaException, IllegalArgumentException {
        ...
        try {
            try {
                ...
                MfcUtil.checkMfcResult(this.felica.setPrivacy(privacySettingData, this.timeout, this.retryCount));
        ...
        try {
            try {
                ...
                try {
                    ...
                    MfcUtil.checkMfcResult(this.felica.setPushNotificationListener(pushAppNotificationListenerStub, appIdentificationCode));
    ...
    class MfcConnection implements ServiceConnection {
        ...
        /* JADX DEBUG: Don't trust debug lines info. Repeating lines: [3708=4, 3710=4] */
    ...
    public synchronized void setSelectTimeout(int timeout) throws FelicaException {
        ...
        try {
            ...
            MfcUtil.checkMfcResult(this.felica.setSelectTimeout(timeout));
    ...
    public synchronized byte[] executeFelicaCommand(byte[] commandPacket) throws FelicaException, IllegalArgumentException {
        ...
        try {
            try {
                ...
                FelicaResultInfoByteArray felicaResultInfoByteArrayExecuteFelicaCommand = this.felica.executeFelicaCommand(commandPacket, this.timeout, this.retryCount);
    ...
    public synchronized KeyInformation[] getKeyVersionV2(int[] nodeCodeList) throws FelicaException, IllegalArgumentException {
        ...
        try {
            ...
            FelicaResultInfoKeyInformationArray keyVersionV2 = this.felica.getKeyVersionV2(nodeCodeList, this.timeout, this.retryCount);
