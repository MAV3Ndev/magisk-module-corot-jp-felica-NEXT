...
public class EventBus {
    ...
    static final class LoggingHandler implements SubscriberExceptionHandler {
        ...
        private static Logger logger(SubscriberExceptionContext subscriberExceptionContext) {
            ...
            StringBuilder sb = new StringBuilder(String.valueOf(name).length() + 1 + String.valueOf(strIdentifier).length());
            sb.append(name);
            sb.append(".");
        ...
        private static String message(SubscriberExceptionContext subscriberExceptionContext) {
            ...
            StringBuilder sb = new StringBuilder(String.valueOf(name).length() + 80 + String.valueOf(name2).length() + String.valueOf(strValueOf).length() + String.valueOf(strValueOf2).length());
