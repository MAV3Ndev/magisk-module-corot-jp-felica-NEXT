...
class EnableCachedCardTask extends AsyncParentTaskBase<Result> {
    ...
    EnableCachedCardTask(int taskId, ExecutorService executor, AsyncTaskBase.Listener listener, CachedCardInfo cachedCardInfo, String callingAppInfo, String appIdInfo, MfiChipHolder chipHolder, DataManager dataManager) {
            ...
            if (createSeInfo()) {
                ...
                if (cardListLoadOnly != null && cardListLoadOnly.cardInfoMap != null && cardListLoadOnly.cardIdInfoMap != null) {
                    ...
                    try {
                            ...
                            try {
                                ...
                                try {
                                    ...
                                    try {
                                        ...
                                        i2 = 2;
                                        LogMgr.log(i2, "716 cancel occured.");
                                        onFinished(false, 215, null);
                                        LogMgr.log(6, "999");
                                        return;
                                    }
                        ...
                        onFinished(false, 200, ObfuscatedMsgUtil.executionPoint());
                        return;
                    } catch (MfiClientException unused6) {
                        LogMgr.log(2, "708");
