...
public class FpServiceInfo {
    ...
    public FpServiceInfo(int i, String str, long j, String str2, String str3, String str4, String str5, NetworkExpert networkExpert, Type type) {
        this._serviceNumber = i;
        this._serviceName = str;
        this._point = j;
        this._pointUnit = str2;
        this._iconUrl = str3;
        this._serviceProvider = str4;
        this._linkIntent = new Intent("android.intent.action.VIEW", Uri.parse(str5));
