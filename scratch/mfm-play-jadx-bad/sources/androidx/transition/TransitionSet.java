...
public class TransitionSet extends Transition {
    ...
    /* JADX DEBUG: Method merged with bridge method: setDuration(J)Landroidx/transition/Transition; */
    @Override // androidx.transition.Transition
    ...
    /* JADX DEBUG: Method merged with bridge method: setStartDelay(J)Landroidx/transition/Transition; */
    @Override // androidx.transition.Transition
    public TransitionSet setStartDelay(long j) {
        return (TransitionSet) super.setStartDelay(j);
    }

    /* JADX DEBUG: Method merged with bridge method: setInterpolator(Landroid/animation/TimeInterpolator;)Landroidx/transition/Transition; */
    @Override // androidx.transition.Transition
    ...
    /* JADX DEBUG: Method merged with bridge method: addTarget(Landroid/view/View;)Landroidx/transition/Transition; */
    @Override // androidx.transition.Transition
    ...
    /* JADX DEBUG: Method merged with bridge method: addTarget(I)Landroidx/transition/Transition; */
    @Override // androidx.transition.Transition
    ...
    /* JADX DEBUG: Method merged with bridge method: addTarget(Ljava/lang/String;)Landroidx/transition/Transition; */
    @Override // androidx.transition.Transition
    ...
    /* JADX DEBUG: Method merged with bridge method: addListener(Landroidx/transition/Transition$TransitionListener;)Landroidx/transition/Transition; */
    @Override // androidx.transition.Transition
    public TransitionSet addListener(Transition.TransitionListener transitionListener) {
        return (TransitionSet) super.addListener(transitionListener);
    }

    /* JADX DEBUG: Method merged with bridge method: removeTarget(I)Landroidx/transition/Transition; */
    @Override // androidx.transition.Transition
    ...
    /* JADX DEBUG: Method merged with bridge method: removeTarget(Landroid/view/View;)Landroidx/transition/Transition; */
    @Override // androidx.transition.Transition
    ...
    /* JADX DEBUG: Method merged with bridge method: removeTarget(Ljava/lang/String;)Landroidx/transition/Transition; */
    @Override // androidx.transition.Transition
    ...
    /* JADX DEBUG: Method merged with bridge method: removeListener(Landroidx/transition/Transition$TransitionListener;)Landroidx/transition/Transition; */
    @Override // androidx.transition.Transition
    ...
    */
    ...
    public Transition mo337clone() {
        TransitionSet transitionSet = (TransitionSet) super.mo337clone();
        transitionSet.mTransitions = new ArrayList<>();
        int size = this.mTransitions.size();
        for (int i = 0; i < size; i++) {
            transitionSet.addTransitionInternal(this.mTransitions.get(i).mo337clone());
        }
