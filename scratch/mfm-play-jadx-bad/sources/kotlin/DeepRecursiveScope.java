...
public abstract class DeepRecursiveScope<T, R> {
    /* JADX DEBUG: Can't inline method, not implemented redirect type for insn: 0x0000: CONSTRUCTOR  A[MD:():void (m)] call: kotlin.DeepRecursiveScope.<init>():void type: THIS */
