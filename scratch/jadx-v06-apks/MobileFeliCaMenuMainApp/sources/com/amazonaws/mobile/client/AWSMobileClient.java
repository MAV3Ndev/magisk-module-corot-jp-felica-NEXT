...
public final class AWSMobileClient implements AWSCredentialsProvider {
    ...
    class AnonymousClass2 implements Runnable {
        ...
        /* JADX WARN: Removed duplicated region for block: B:30:0x015b A[Catch: all -> 0x02ce, TRY_LEAVE, TryCatch #4 {, blocks: (B:4:0x0007, B:6:0x000e, B:7:0x0019, B:9:0x001b, B:10:0x001f, B:12:0x0029, B:14:0x0039, B:15:0x004b, B:17:0x009f, B:19:0x00af, B:21:0x00f8, B:22:0x00ff, B:24:0x0140, B:27:0x014d, B:28:0x0159, B:30:0x015b, B:32:0x0165, B:34:0x01b2, B:35:0x01b9, B:41:0x0239, B:43:0x0243, B:45:0x024b, B:46:0x027a, B:50:0x028d, B:52:0x0293, B:54:0x0299, B:55:0x02a5, B:57:0x02a7, B:58:0x02bd, B:49:0x0281, B:38:0x022b, B:39:0x0237, B:61:0x02c0, B:62:0x02cc), top: B:76:0x0007, inners: #0, #1, #2, #3 }] */
        /* JADX WARN: Removed duplicated region for block: B:41:0x0239 A[Catch: all -> 0x02ce, TRY_LEAVE, TryCatch #4 {, blocks: (B:4:0x0007, B:6:0x000e, B:7:0x0019, B:9:0x001b, B:10:0x001f, B:12:0x0029, B:14:0x0039, B:15:0x004b, B:17:0x009f, B:19:0x00af, B:21:0x00f8, B:22:0x00ff, B:24:0x0140, B:27:0x014d, B:28:0x0159, B:30:0x015b, B:32:0x0165, B:34:0x01b2, B:35:0x01b9, B:41:0x0239, B:43:0x0243, B:45:0x024b, B:46:0x027a, B:50:0x028d, B:52:0x0293, B:54:0x0299, B:55:0x02a5, B:57:0x02a7, B:58:0x02bd, B:49:0x0281, B:38:0x022b, B:39:0x0237, B:61:0x02c0, B:62:0x02cc), top: B:76:0x0007, inners: #0, #1, #2, #3 }] */
    ...
    protected boolean waitForSignIn() {
        try {
            try {
                ...
                int i = AnonymousClass28.$SwitchMap$com$amazonaws$mobile$client$UserState[userStateDetails.getUserState().ordinal()];
                if (i == 1) {
    ...
    /* JADX INFO: renamed from: com.amazonaws.mobile.client.AWSMobileClient$28, reason: invalid class name */
    ...
    class AnonymousClass25 implements Runnable {
        ...
        public void run() {
            ...
            try {
                ...
                builderBuildUpon.appendQueryParameter("client_id", hostedUIJSONFromJSON.getString("AppClientId"));
                HashMap map = new HashMap();
                try {
                    ...
                    map.put("client_id", hostedUIJSONFromJSON.getString("AppClientId"));
        ...
        /* JADX INFO: renamed from: com.amazonaws.mobile.client.AWSMobileClient$25$1, reason: invalid class name */
                        ...
                        if (AWSMobileClient.this.isFederationEnabled()) {
                            AWSMobileClient.this.federatedSignInWithoutAssigningState(AnonymousClass1.this.val$hostedUIOptions.getFederationProviderName(), oAuth2Tokens.getIdToken(), new Callback<UserStateDetails>() { // from class: com.amazonaws.mobile.client.AWSMobileClient.25.1.1.1
                                ...
                                public void onResult(UserStateDetails userStateDetails) {
                                    ...
                                    AnonymousClass25.this.val$callback.onResult(userStateDetails2);
    ...
    class AnonymousClass26 implements Runnable {
        ...
        AnonymousClass26(SignInUIOptions signInUIOptions, Callback callback, Activity activity) {
            this.val$signInUIOptions = signInUIOptions;
            this.val$callback = callback;
    ...
    private Runnable _showSignInHostedUI(Activity activity, SignInUIOptions signInUIOptions, Callback<UserStateDetails> callback) {
        return new AnonymousClass26(signInUIOptions, callback, activity);
    }
        ...
        return new Runnable() { // from class: com.amazonaws.mobile.client.AWSMobileClient.27
            ...
            public void run() {
                synchronized (AWSMobileClient.this.showSignInLockObject) {
                    ...
                    AWSMobileClient.this.getClient(AWSMobileClient.this.mContext, SignInUI.class).login(activity, signInUIOptions.nextActivity() == null ? activity.getClass() : signInUIOptions.nextActivity()).authUIConfiguration(builderIsBackgroundColorFullScreen.build()).enableFederation(false).execute();
    ...
    public AWSConfigurable getClient(Context context, Class<? extends AWSConfigurable> cls) {
        ...
        try {
            ...
            Log.d(TAG, "Created the new client: " + aWSConfigurableInitialize.toString());
            return aWSConfigurableInitialize;
        } catch (Exception e) {
