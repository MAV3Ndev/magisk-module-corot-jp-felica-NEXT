...
public class AccountSwitchingNotificationController {
    ...
    public boolean notifyNotification() {
        ...
        PendingIntent activity = PendingIntent.getActivity(this._context, 1000, new Intent("android.intent.action.VIEW", Uri.parse((String) Sg.getValue(Sg.Key.NET_ACCOUNT_CHANGE_GUIDANCE_PAGE_URL))), 134217728);
        ...
        if (Build.VERSION.SDK_INT >= 26) {
            NotificationChannel notificationChannel = new NotificationChannel(NOTIFICATION_CHANNEL_ID, resources.getString(R.string.text_account_change_notificaion_channel_name), 3);
