...
public final class BeginCreatePublicKeyCredentialRequest extends BeginCreateCredentialRequest {
  ...
  (wrap:byte[]:?: TERNARY null = ((wrap:int:0x0000: ARITH (r5v0 int) & (8 int) A[WRAPPED]) != (0 int)) ? (null byte[]) : (r4v0 byte[]))
 A[MD:(java.lang.String, androidx.credentials.provider.CallingAppInfo, android.os.Bundle, byte[]):void (m)] (LINE:58) call: androidx.credentials.provider.BeginCreatePublicKeyCredentialRequest.<init>(java.lang.String, androidx.credentials.provider.CallingAppInfo, android.os.Bundle, byte[]):void type: THIS */
    ...
    public static final class Companion {
        /* JADX DEBUG: Can't inline method, not implemented redirect type for insn: 0x0000: CONSTRUCTOR  A[MD:():void (m)] call: androidx.credentials.provider.BeginCreatePublicKeyCredentialRequest.Companion.<init>():void type: THIS */
