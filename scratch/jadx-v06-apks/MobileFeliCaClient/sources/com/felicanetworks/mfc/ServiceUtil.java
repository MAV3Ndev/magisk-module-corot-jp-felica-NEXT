...
public class ServiceUtil {
    ...
    public void checkServiceCode(int i, int i2) throws IllegalArgumentException {
        if (i2 == 2) {
            if ((i & 65535) == 65535) {
                return;
            }
    ...
    public int getBlockType(int i) throws IllegalArgumentException {
        int i2 = i & 63;
        if (i2 == 9) {
            return 1;
        }
    ...
    public void checkBlockNo(int i) throws IllegalArgumentException {
        if (i < 0 || i > 65535) {
    ...
    public void checkBlock(Block block, boolean z) throws IllegalArgumentException {
        if (block == null) {
            throw new IllegalArgumentException(EXC_INVALID_BLOCK);
        }
        if (z) {
    ...
    public void checkAreaCode(int i) throws IllegalArgumentException {
    ...
    public void checkNodeCode(int i) throws IllegalArgumentException {
    ...
    public void checkServiceCode(int i) throws IllegalArgumentException {
