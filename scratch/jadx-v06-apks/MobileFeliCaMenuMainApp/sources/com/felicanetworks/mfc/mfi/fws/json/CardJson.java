...
public class CardJson extends JSONObject {
    ...
    static {
        ...
        STATUS_MAP.put(STATUS_ACTIVE, 1);
        STATUS_MAP.put(STATUS_LOST, 2);
        STATUS_MAP.put(STATUS_DELETED, 3);
        HashMap<String, Integer> map2 = new HashMap<>();
        POSITION_MAP = map2;
        map2.put(POSITION_FOREGROUND, 0);
        POSITION_MAP.put(POSITION_BACKGROUND, 1);
        HashMap<String, CompleteCardInfo.Finish> map3 = new HashMap<>();
        FINISH_MAP = map3;
        map3.put(FINISH_NOT_YET, CompleteCardInfo.Finish.NOT_YET);
        FINISH_MAP.put(FINISH_DONE, CompleteCardInfo.Finish.DONE);
        HashMap<String, Integer> map4 = new HashMap<>();
        TASK_MAP = map4;
        map4.put(TASK_ISSUE, 0);
        TASK_MAP.put(TASK_ENABLE, 1);
        TASK_MAP.put(TASK_DISABLE, 2);
        TASK_MAP.put(TASK_PERMANET_DELETE, 3);
        TASK_MAP.put(TASK_DELETE, 4);
        TASK_MAP.put(TASK_SE_ACCESS, 5);
        HashMap<String, Boolean> map5 = new HashMap<>();
        REISSUE_POSSIBILITY_MAP = map5;
        map5.put(REISSUE_STATUS_REISSUABLE, Boolean.TRUE);
        REISSUE_POSSIBILITY_MAP.put(REISSUE_STATUS_UNREISSUABLE, Boolean.FALSE);
        REISSUE_POSSIBILITY_MAP.put(REISSUE_STATUS_PENDING, Boolean.TRUE);
        REISSUE_POSSIBILITY_MAP.put("unknown", Boolean.TRUE);
        ...
        REISSUE_STATUS_MAP.put(REISSUE_STATUS_UNREISSUABLE, CompleteCardInfo.ReissueStatus.UNREISSUABLE);
        REISSUE_STATUS_MAP.put(REISSUE_STATUS_PENDING, CompleteCardInfo.ReissueStatus.PENDING);
        REISSUE_STATUS_MAP.put("unknown", CompleteCardInfo.ReissueStatus.UNKNOWN);
    }
    ...
    public CompleteCardInfo getCardInfo(CheckType checkType, SeInfo seInfo) throws JSONException {
        ...
        int iIntValue3;
        String strCheckString2 = JsonUtil.checkString((JSONObject) this, NAME_SERVICE_ID, true, 0);
        JSONObject jSONObjectCheckObject = JsonUtil.checkObject((JSONObject) this, NAME_SE_INFO, true);
        String strCheckString3 = JsonUtil.checkString(jSONObjectCheckObject, NAME_SE_ID, true, 0);
        try {
            byte[] bArrHexToByteArray = StringUtil.hexToByteArray(JsonUtil.checkString(jSONObjectCheckObject, NAME_IDM, true, 16));
            String strCheckString4 = JsonUtil.checkString((JSONObject) this, NAME_SERVICE_TYPE, true, 8);
            String strCheckString5 = (checkType == CheckType.ASSET_INDIVIDUAL_CARD || (ServiceTypeInfoUtil.SysType.isPrivate(strCheckString4) && ServiceTypeInfoUtil.MultiCardType.isLocalMultiple(strCheckString4))) ? JsonUtil.checkString((JSONObject) this, NAME_CARD_CATEGORY, true, 0) : null;
            if (strCheckString3.equalsIgnoreCase(seInfo.getSeId())) {
            ...
            if (checkType == CheckType.ASSET_INDIVIDUAL_CARD || zIsChipGP || !ServiceTypeInfoUtil.SysType.isPrivate(strCheckString4)) {
                iArr = null;
            } else {
            ...
            if (zIsChipGP) {
                strCheckString = JsonUtil.checkString((JSONObject) this, NAME_APPLET_INSTANCE_AID, true, 32);
                try {
            ...
            String strCheckString7 = checkType != CheckType.ASSET_INDIVIDUAL_CARD ? JsonUtil.checkString(JsonUtil.checkObject((JSONObject) this, NAME_ISSUER_INFO, true), NAME_WALLET_APP_ID, true, 0) : null;
            ...
            if (checkType == CheckType.FWS_CREATE_CARD) {
                iIntValue = STATUS_MAP.containsKey(strCheckString8) ? STATUS_MAP.get(strCheckString8).intValue() : -1;
            } else {
                if (!STATUS_MAP.containsKey(strCheckString8)) {
                    throw new JSONException("Not supported status :" + strCheckString8);
                }
                iIntValue = STATUS_MAP.get(strCheckString8).intValue();
            }
            ...
            if (3 == iIntValue) {
                ...
                if (!REISSUE_POSSIBILITY_MAP.containsKey(strCheckString11)) {
                    throw new JSONException("Not supported reissueStatus :" + strCheckString11);
                }
                boolean zBooleanValue = REISSUE_POSSIBILITY_MAP.get(strCheckString11).booleanValue();
            ...
            if (checkType == CheckType.ASSET_INDIVIDUAL_CARD) {
                ...
                if (!TASK_MAP.containsKey(strCheckString12)) {
                    throw new JSONException("Not supported task :" + strCheckString12);
                }
                iIntValue3 = TASK_MAP.get(strCheckString12).intValue();
            }
            return new CompleteCardInfo(getCid(), strCheckString2, strCheckString7, iIntValue, iIntValue2, iIntValue3, z, strCheckString4, strCheckString6, strCheckString5, strCheckString, finish, reissueStatus, strCheckString3, bArrHexToByteArray, iArr);
    ...
    */
    public com.felicanetworks.mfc.mfi.CompleteCardInfo getCardInfoWithSpStatus(com.felicanetworks.mfc.mfi.fws.json.CardJson.CheckType r5, java.lang.String r6, com.felicanetworks.mfc.mfi.SeInfo r7) throws org.json.JSONException {
        /*
            r4 = this;
            com.felicanetworks.mfc.mfi.CompleteCardInfo r5 = r4.getCardInfo(r5, r7)
            int r6 = r5.getCardStatus()
            r7 = 4
            r0 = 2
            r1 = 1
            r2 = 3
            if (r2 != r6) goto L29
            int[] r6 = com.felicanetworks.mfc.mfi.fws.json.CardJson.AnonymousClass1.$SwitchMap$com$felicanetworks$mfc$mfi$CompleteCardInfo$ReissueStatus
            com.felicanetworks.mfc.mfi.CompleteCardInfo$ReissueStatus r3 = r5.getReissueStatus()
            int r3 = r3.ordinal()
            r6 = r6[r3]
            if (r6 == r1) goto L27
            if (r6 == r0) goto L25
        ...
        L2a:
            r5.setSpStatus(r7)
            r6 = 0
            java.lang.String r7 = "spAdditionalInfo"
            org.json.JSONObject r6 = com.felicanetworks.mfc.mfi.fws.json.JsonUtil.checkObject(r4, r7, r6)
            if (r6 == 0) goto L39
            r5.setSpAdditionalInfo(r6)
        L39:
            return r5
        */
