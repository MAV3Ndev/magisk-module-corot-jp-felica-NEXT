...
public class CyclicData extends Data {
    ...
    private void readFromParcel(Parcel parcel) {
        ...
        setBytes(bArr);
        LogMgr.log(6, "001 bytes.length=%d bytes[]:%d %d %d ... %d", Integer.valueOf(bArr.length), Byte.valueOf(bArr[0]), Byte.valueOf(bArr[1]), Byte.valueOf(bArr[2]), Byte.valueOf(bArr[bArr.length - 1]));
        LogMgr.log(6, "999");
    }
