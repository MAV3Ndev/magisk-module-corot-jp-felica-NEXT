...
public class JobInfoSchedulerService extends JobService {
    ...
    public boolean onStartJob(final JobParameters jobParameters) {
        ...
        TransportRuntime.getInstance().getUploader().upload(priority.build(), i2, new Runnable() { // from class: com.google.android.datatransport.runtime.scheduling.jobscheduling.-$$Lambda$JobInfoSchedulerService$V3wA045JGbQPPEw1rM8LPYhhWLI
            @Override // java.lang.Runnable
            public final void run() {
                this.f$0.lambda$onStartJob$0$JobInfoSchedulerService(jobParameters);
            }
        });
        return true;
    }
