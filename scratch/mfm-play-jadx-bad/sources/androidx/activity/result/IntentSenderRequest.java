...
public final class IntentSenderRequest implements Parcelable {
 ...
 A[MD:(android.content.IntentSender, android.content.Intent, int, int):void (m)] (LINE:33) call: androidx.activity.result.IntentSenderRequest.<init>(android.content.IntentSender, android.content.Intent, int, int):void type: THIS */
    ...
    public static final class Companion {
        /* JADX DEBUG: Can't inline method, not implemented redirect type for insn: 0x0000: CONSTRUCTOR  A[MD:():void (m)] call: androidx.activity.result.IntentSenderRequest.Companion.<init>():void type: THIS */
