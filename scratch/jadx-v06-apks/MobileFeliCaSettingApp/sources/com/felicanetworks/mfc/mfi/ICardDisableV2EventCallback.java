...
public interface ICardDisableV2EventCallback extends IInterface {
    ...
    public static abstract class Stub extends Binder implements ICardDisableV2EventCallback {
        private static final String DESCRIPTOR = "com.felicanetworks.mfc.mfi.ICardDisableV2EventCallback";
        ...
        public static ICardDisableV2EventCallback asInterface(IBinder iBinder) {
            if (iBinder == null) {
                return null;
            }
