...
public class IFelicaGpDeviceImpl extends IFelica.Stub {
    ...
    public FelicaResultInfo close() throws RemoteException {
        ...
        FelicaResultInfo felicaResultInfoClose2 = this.mFelicaGpEntity.close();
    ...
    FelicaResultInfo doClose(boolean z) {
        ...
        FelicaResultInfo felicaResultInfoDoClose2 = this.mFelicaGpEntity.doClose(z);
    ...
    public FelicaResultInfoBlockCountInformationArray getBlockCountInformation(int[] iArr, int i, int i2) throws RemoteException {
        try {
            checkListenActive();
            if (this.mTarget == 0) {
                return this.mFelicaGpEntity.getBlockCountInformation(iArr, i, i2);
            }
    ...
    public FelicaResultInfoByteArray getContainerId(int i, int i2) throws RemoteException {
        try {
            checkListenActive();
            if (this.mTarget == 0) {
                return this.mFelicaGpEntity.getContainerId(i, i2);
            }
    ...
    public FelicaResultInfoByteArray getContainerIssueInformation(int i, int i2) throws RemoteException {
        try {
            checkListenActive();
            if (this.mTarget == 0) {
                return this.mFelicaGpEntity.getContainerIssueInformation(i, i2);
            }
    ...
    public FelicaResultInfoByteArray getICCode() throws RemoteException {
        int i = this.mTarget;
        if (i == 0) {
            return this.mFelicaGpEntity.getIcCode();
        }
        if (i == 1) {
    ...
    public FelicaResultInfoByteArray getIDm() throws RemoteException {
        int i = this.mTarget;
        if (i == 0) {
            return this.mFelicaGpEntity.getIdm();
        }
        if (i == 1) {
    ...
    public FelicaResultInfoInt getInterface() throws RemoteException {
        ...
        int i = this.mTarget;
        if (i == 0) {
            felicaResultInfoCheckStatus = this.mFelicaGpEntity.checkStatus();
        } else {
            if (i != 1) {
                if (i == 2) {
    ...
    public FelicaResultInfoInt getKeyVersion(int i, int i2, int i3) throws RemoteException {
        try {
            checkListenActive();
            if (this.mTarget == 0) {
                return this.mFelicaGpEntity.getKeyVersion(i, i2, i3);
            }
    ...
    public FelicaResultInfoKeyInformationArray getKeyVersionV2(int[] iArr, int i, int i2) throws RemoteException {
        try {
            checkListenActive();
            if (this.mTarget == 0) {
                return this.mFelicaGpEntity.getKeyVersionV2(iArr, i, i2);
            }
    ...
    public FelicaResultInfoNodeInformation getNodeInformation(int i, int i2, int i3) throws RemoteException {
        try {
            checkListenActive();
            if (this.mTarget == 0) {
                return this.mFelicaGpEntity.getNodeInformation(i, i2, i3);
            }
    ...
    public FelicaResultInfoNodeInformation getPrivacyNodeInformation(int i, int i2, int i3) throws RemoteException {
        try {
            checkListenActive();
            if (this.mTarget == 0) {
                return this.mFelicaGpEntity.getPrivacyNodeInformation(i, i2, i3);
            }
    ...
    public FelicaResultInfoIntArray getSystemCodeList(int i, int i2) throws RemoteException {
        try {
            checkListenActive();
            if (this.mTarget == 0) {
                return this.mFelicaGpEntity.getSystemCodeList(i, i2);
            }
    ...
    public synchronized FelicaResultInfo inactivateFelica() throws RemoteException {
        FelicaResultInfo felicaResultInfoInactivateFelica = this.mFelicaGpEntity.inactivateFelica();
    ...
    synchronized FelicaResultInfo doInactivateFelica(boolean z) {
        FelicaResultInfo felicaResultInfoDoInactivateFelica = this.mFelicaGpEntity.doInactivateFelica(z);
    ...
    public FelicaResultInfo open() throws RemoteException {
        ...
        FelicaResultInfo felicaResultInfoOpen = this.mFelicaGpEntity.open();
    ...
    public FelicaResultInfoDataArray read(BlockList blockList, int i, int i2) throws RemoteException {
        try {
            checkListenActive();
            if (this.mTarget == 0) {
                return this.mFelicaGpEntity.read(blockList, i, i2);
            }
    ...
    public FelicaResultInfo reset() throws RemoteException {
        ...
        FelicaResultInfo felicaResultInfoReset2 = this.mFelicaGpEntity.reset(true, false);
    ...
    public FelicaResultInfo selectWithTarget(int i, int i2) throws RemoteException {
        ...
        if (i == 0) {
            ...
            felicaResultInfoSelect = this.mFelicaGpEntity.select(i2);
            ...
            if (this.mFelicaGpEntity.isConnected()) {
                FelicaResultInfo felicaResultInfoReset2 = this.mFelicaGpEntity.reset(false, true);
                if (felicaResultInfoReset2.getExceptionType() != 0) {
                    return felicaResultInfoReset2;
                }
                z = true;
    ...
    public FelicaResultInfo selectWithCid(int i, String str) throws RemoteException {
        ...
        FelicaResultInfo felicaResultInfoSelect = this.mFelicaGpEntity.select(i, str);
        if (felicaResultInfoSelect.getExceptionType() == 0) {
            this.mTarget = 0;
            this.mSystemCode = i;
            this.mPrevIcCode = this.mFelicaGpEntity.getIcCode();
    ...
    public FelicaResultInfo setNodeCodeSize(int i, int i2, int i3) throws RemoteException {
        try {
            checkListenActive();
            if (this.mTarget == 0) {
                return this.mFelicaGpEntity.setNodeCodeSize(i, i2, i3);
            }
    ...
    public FelicaResultInfo write(BlockDataList blockDataList, int i, int i2) throws RemoteException {
        try {
            checkListenActive();
            if (this.mTarget == 0) {
                return this.mFelicaGpEntity.write(blockDataList, i, i2);
            }
    ...
    public FelicaResultInfo push(PushSegmentParcelableWrapper pushSegmentParcelableWrapper) throws RemoteException {
        try {
            checkListenActive();
            if (this.mFelicaGpEntity.isConnected()) {
                boolean zIsSelected = this.mFelicaGpEntity.isSelected();
                FelicaResultInfo felicaResultInfoReset = this.mFelicaGpEntity.reset(false, true);
                if (felicaResultInfoReset.getExceptionType() != 0) {
                    return felicaResultInfoReset;
                }
                FelicaResultInfo felicaResultInfoPush = this.mFelicaRfEntity.push(pushSegmentParcelableWrapper);
                FelicaResultInfo felicaResultInfoReconnect = this.mFelicaGpEntity.reconnect(zIsSelected, this.mSystemCode);
    ...
    public FelicaResultInfo setPrivacy(PrivacySettingData[] privacySettingDataArr, int i, int i2) throws RemoteException {
        try {
            checkListenActive();
            if (this.mTarget == 0) {
                return this.mFelicaGpEntity.setPrivacy(privacySettingDataArr, i, i2);
            }
    ...
    public synchronized FelicaResultInfo activateFelica(String[] strArr, IFelicaEventListener iFelicaEventListener, IBinder iBinder) throws RemoteException {
        ...
        felicaResultInfoActivateFelica = this.mFelicaGpEntity.activateFelica(strArr, iFelicaEventListener, iBinder);
    ...
    public FelicaResultInfoInt getSelectTimeout() throws RemoteException {
        if (this.mTarget == 0) {
            return this.mFelicaGpEntity.getSelectTimeout();
        }
    ...
    public FelicaResultInfo cancelOffline() throws RemoteException {
        FelicaResultInfo felicaResultInfoCancelOffline = this.mFelicaGpEntity.cancelOffline();
    ...
    public FelicaResultInfoByteArray executeFelicaCommand(byte[] bArr, int i, int i2) throws RemoteException {
        try {
            checkListenActive();
            if (this.mTarget == 0) {
                return this.mFelicaGpEntity.executeFelicaCommand(bArr, i, i2);
            }
