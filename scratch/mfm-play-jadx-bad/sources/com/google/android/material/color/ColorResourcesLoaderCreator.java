            ...
            try {
                ...
                try {
                    ...
                    try {
                        ...
                        ResourcesLoader resourcesLoaderM560m = Timestamp$$ExternalSyntheticApiModelOutline0.m560m();
                        resourcesLoaderM560m.addProvider(ResourcesProvider.loadFromTable(parcelFileDescriptorDup, null));
