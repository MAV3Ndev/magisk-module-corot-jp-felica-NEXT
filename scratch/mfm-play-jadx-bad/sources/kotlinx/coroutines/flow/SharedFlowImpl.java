...
public class SharedFlowImpl<T> extends AbstractSharedFlow<SharedFlowSlot> implements MutableSharedFlow<T>, CancellableFlow<T>, FusibleFlow<T> {
    ...
    /* JADX DEBUG: Multi-variable search result rejected for r10v12, resolved type: kotlinx.coroutines.flow.FlowCollector */
    /* JADX DEBUG: Multi-variable search result rejected for r10v7, resolved type: kotlinx.coroutines.flow.FlowCollector */
    /* JADX DEBUG: Multi-variable search result rejected for r10v9, resolved type: kotlinx.coroutines.flow.FlowCollector */
    ...
    */
    ...
    public boolean tryEmit(T value) {
        ...
        for (Continuation<Unit> continuation : continuationArrFindSlotsToResumeLocked) {
            if (continuation != null) {
                ...
                continuation.resumeWith(Result.m613constructorimpl(Unit.INSTANCE));
            }
        }
        return z;
    }
    ...
    /* JADX DEBUG: Class process forced to load method for inline: kotlinx.coroutines.flow.internal.AbstractSharedFlow.access$getNCollectors(kotlinx.coroutines.flow.internal.AbstractSharedFlow):int */
    ...
    /* JADX DEBUG: Failed to insert an additional move for type inference into block B:22:0x004a */
    ...
    /* JADX DEBUG: Method merged with bridge method: createSlot()Lkotlinx/coroutines/flow/internal/AbstractSharedFlowSlot; */
    ...
    /* JADX DEBUG: Method merged with bridge method: createSlotArray(I)[Lkotlinx/coroutines/flow/internal/AbstractSharedFlowSlot; */
    /* JADX INFO: Access modifiers changed from: protected */
    @Override // kotlinx.coroutines.flow.internal.AbstractSharedFlow
        ...
        synchronized (this) {
            try {
                if (tryEmitLocked(t)) {
                    try {
                        Result.Companion companion = Result.INSTANCE;
                        cancellableContinuationImpl2.resumeWith(Result.m613constructorimpl(Unit.INSTANCE));
                ...
                for (Continuation<Unit> continuation2 : continuationArrFindSlotsToResumeLocked) {
                    if (continuation2 != null) {
                        ...
                        continuation2.resumeWith(Result.m613constructorimpl(Unit.INSTANCE));
                    }
                }
    ...
    /* JADX DEBUG: Class process forced to load method for inline: kotlinx.coroutines.flow.SharedFlowKt.access$getBufferAt(java.lang.Object[], long):java.lang.Object */
    /* JADX INFO: Access modifiers changed from: private */
