...
public class GridLayoutManager extends LinearLayoutManager {
    ...
    private static final Set<Integer> sSupportedDirectionsForActionScrollInDirection = Collections.unmodifiableSet(new HashSet(Arrays.asList(17, 66, 33, Integer.valueOf(FeliCaParams.BLOCK_NO_FELICAPOCKET_LITE_DATA_FORMAT_CODE))));
    int[] mCachedBorders;
