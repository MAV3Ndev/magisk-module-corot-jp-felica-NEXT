...
public class FeliCaInUseProcessingView extends CustomDialogFragment implements FunctionCodeInterface {
    ...
    public void onDialogButtonClick() {
        AnalysisManager.stamp(MfsStamp.Event.ACTION_WID_1_17_CLOSE, new Object[0]);
        try {
    ...
    protected void onSetupDialog() {
        AnalysisManager.stamp(MfsStamp.Event.SCREEN_WID_1_17, new Object[0]);
        setTitle(getString(R.string.dlg_title_016));
        setNegativeText(getString(R.string.btn_msg_019));
        setNegativeButtonListener(new CustomDialogFragment.OnClickListener() { // from class: com.felicanetworks.mfs.view.FeliCaInUseProcessingView.1
            @Override // com.felicanetworks.mfs.view.CustomDialogFragment.OnClickListener
            public boolean onClick() {
                FeliCaInUseProcessingView.this.onDialogButtonClick();
                return false;
            }
        });
        setText(getString(R.string.dlg_msg_018));
    }
}
