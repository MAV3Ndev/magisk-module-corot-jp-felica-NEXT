...
public class SelectResponse {
    ...
    public SelectResponse(final byte[] response) throws IllegalArgumentException {
    ...
    public byte[] getSystemCodeInByte() throws IllegalArgumentException {
        ...
        byte[] value = tLVResponse.getValue(FILE_CONTROL_INFORMATION, PROPRIETARY_DATA, -128);
