...
class LocalCache<K, V> extends AbstractMap<K, V> implements ConcurrentMap<K, V> {
 ...
 A[WRAPPED] (LINE:556) elemType: com.google.common.cache.LocalCache$EntryFactory
    ...
    static class Segment<K, V> extends ReentrantLock {
        ...
        /* JADX DEBUG: Don't trust debug lines info. Repeating lines: [2059=4] */
        ...
        */
                    ...
                    if (referenceEntryNewEntry.getHash() != i2 || key == null || !this.map.keyEquivalence.equivalent(k, key)) {
                        ...
                        if (valueReference.isLoading()) {
                            ...
                            if (v == null) {
                                ...
                                i2 = i;
                            } else if (this.map.isExpired(referenceEntryNewEntry, j2)) {
                                i2 = i;
        ...
        /* JADX DEBUG: Don't trust debug lines info. Repeating lines: [2343=4, 2344=4] */
        @CheckForNull
        ...
        /* JADX DEBUG: Don't trust debug lines info. Repeating lines: [2761=4, 2762=4] */
                    ...
                    if (referenceEntry2.getHash() != i2 || key == null || !this.map.keyEquivalence.equivalent(k, key)) {
                        ...
                        if (v3 == null) {
                            ...
                            if (this.map.valueEquivalence.equivalent(v, v3)) {
                                ...
                                setValue(referenceEntry2, k, v2, j3);
                ...
                while (true) {
                    ...
                    if (next.getHash() != i || key == null || !this.map.keyEquivalence.equivalent(k, key)) {
                        ...
                        if (v2 == null) {
                            ...
                            this.modCount++;
                            enqueueNotification(k, i, v2, valueReference.getWeight(), RemovalCause.REPLACED);
                            setValue(referenceEntry3, k, v, j3);
                            evictEntries(referenceEntry3);
                            return v2;
                        }
                    }
        ...
        */
        ...
        /* JADX DEBUG: Don't trust debug lines info. Repeating lines: [3268=4, 3269=4, 3270=4] */
        /* JADX WARN: Removed duplicated region for block: B:37:0x008e  */
        /* JADX WARN: Removed duplicated region for block: B:45:? A[SYNTHETIC] */
        /*
            Code decompiled incorrectly, please refer to instructions dump.
        */
        boolean reclaimValue(K k, int i, ValueReference<K, V> valueReference) throws Throwable {
            AtomicReferenceArray<ReferenceEntry<K, V>> atomicReferenceArray;
            int length;
            ReferenceEntry<K, V> referenceEntry;
            ReferenceEntry<K, V> next;
    ...
    */
                ...
                try {
                    try {
                        ...
                        if (z2) {
                            ...
                            StringBuilder sb2 = new StringBuilder(String.valueOf(strValueOf2).length() + 42);
    ...
    static class ManualSerializationProxy<K, V> extends ForwardingCache<K, V> implements Serializable {
        ...
        /* JADX DEBUG: Type inference failed for r1v12. Raw type applied. Possible types: com.google.common.cache.Weigher<K, V>, com.google.common.cache.Weigher<? super K1 extends K, ? super V1 extends V> */
