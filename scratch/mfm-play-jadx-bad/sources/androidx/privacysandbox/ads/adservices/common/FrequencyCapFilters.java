...
/* JADX INFO: compiled from: FrequencyCapFilters.kt */
...
public final class FrequencyCapFilters {
  ...
  (wrap:java.util.List:?: TERNARY null = ((wrap:int:0x0000: ARITH (r5v0 int) & (1 int) A[WRAPPED]) != (0 int)) ? (wrap:java.util.List:0x0004: INVOKE  STATIC call: kotlin.collections.CollectionsKt.emptyList():java.util.List A[MD:<T>:():java.util.List<T> (m), WRAPPED] (LINE:45)) : (r1v0 java.util.List))
  (wrap:java.util.List:?: TERNARY null = ((wrap:int:0x0008: ARITH (r5v0 int) & (2 int) A[WRAPPED]) != (0 int)) ? (wrap:java.util.List:0x000c: INVOKE  STATIC call: kotlin.collections.CollectionsKt.emptyList():java.util.List A[MD:<T>:():java.util.List<T> (m), WRAPPED] (LINE:46)) : (r2v0 java.util.List))
  (wrap:java.util.List:?: TERNARY null = ((wrap:int:0x0010: ARITH (r5v0 int) & (4 int) A[WRAPPED]) != (0 int)) ? (wrap:java.util.List:0x0014: INVOKE  STATIC call: kotlin.collections.CollectionsKt.emptyList():java.util.List A[MD:<T>:():java.util.List<T> (m), WRAPPED] (LINE:47)) : (r3v0 java.util.List))
  (wrap:java.util.List:?: TERNARY null = ((wrap:int:0x0018: ARITH (r5v0 int) & (8 int) A[WRAPPED]) != (0 int)) ? (wrap:java.util.List:0x001c: INVOKE  STATIC call: kotlin.collections.CollectionsKt.emptyList():java.util.List A[MD:<T>:():java.util.List<T> (m), WRAPPED] (LINE:48)) : (r4v0 java.util.List))
 A[MD:(java.util.List<androidx.privacysandbox.ads.adservices.common.KeyedFrequencyCap>, java.util.List<androidx.privacysandbox.ads.adservices.common.KeyedFrequencyCap>, java.util.List<androidx.privacysandbox.ads.adservices.common.KeyedFrequencyCap>, java.util.List<androidx.privacysandbox.ads.adservices.common.KeyedFrequencyCap>):void (m)] (LINE:44) call: androidx.privacysandbox.ads.adservices.common.FrequencyCapFilters.<init>(java.util.List, java.util.List, java.util.List, java.util.List):void type: THIS */
