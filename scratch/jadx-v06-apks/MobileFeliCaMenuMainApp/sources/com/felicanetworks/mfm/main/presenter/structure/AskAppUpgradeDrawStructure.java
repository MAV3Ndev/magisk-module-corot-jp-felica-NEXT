...
public class AskAppUpgradeDrawStructure extends AskDrawStructure {
    public AskAppUpgradeDrawStructure() {
        super(StructureType.ASK_APP_UPGRADE);
    }
    ...
    public Intent getDefaultIntent() {
        ...
        try {
            ...
            e = e3;
            MfmException mfmException = new MfmException(StateController.class, 1, e);
            LogUtil.error(e);
