...
/* JADX INFO: compiled from: GetAdSelectionDataOutcome.kt */
...
public final class GetAdSelectionDataOutcome {
  ...
  (r1v0 long)
  (wrap:byte[]:?: TERNARY null = ((wrap:int:0x0000: ARITH (r4v0 int) & (2 int) A[WRAPPED]) != (0 int)) ? (null byte[]) : (r3v0 byte[]))
 A[MD:(long, byte[]):void (m)] (LINE:37) call: androidx.privacysandbox.ads.adservices.adselection.GetAdSelectionDataOutcome.<init>(long, byte[]):void type: THIS */
    ...
    public int hashCode() {
        ...
        return iM + (bArr != null ? bArr.hashCode() : 0);
    }
