    ...
    class SlidingTabIndicator extends LinearLayout {
        ...
        public void draw(Canvas canvas) {
            ...
            if (i3 >= 0 && this.indicatorRight > i3) {
                Drawable drawableMutate = DrawableCompat.wrap(TabLayout.this.tabSelectedIndicator != null ? TabLayout.this.tabSelectedIndicator : this.defaultSelectionIndicator).mutate();
                ...
                if (this.selectedIndicatorPaint != null) {
                    if (Build.VERSION.SDK_INT == 21) {
                        ...
                        DrawableCompat.setTint(drawableMutate, this.selectedIndicatorPaint.getColor());
                    }
                }
