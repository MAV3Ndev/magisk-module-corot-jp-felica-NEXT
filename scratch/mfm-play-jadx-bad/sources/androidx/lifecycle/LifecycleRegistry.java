...
public class LifecycleRegistry extends Lifecycle {
    ...
    /* JADX DEBUG: Can't inline method, not implemented redirect type for insn: 0x0000: CONSTRUCTOR (r1v0 androidx.lifecycle.LifecycleOwner), (r2v0 boolean) A[MD:(androidx.lifecycle.LifecycleOwner, boolean):void (m)] call: androidx.lifecycle.LifecycleRegistry.<init>(androidx.lifecycle.LifecycleOwner, boolean):void type: THIS */
    ...
    public static final class Companion {
        /* JADX DEBUG: Can't inline method, not implemented redirect type for insn: 0x0000: CONSTRUCTOR  A[MD:():void (m)] call: androidx.lifecycle.LifecycleRegistry.Companion.<init>():void type: THIS */
