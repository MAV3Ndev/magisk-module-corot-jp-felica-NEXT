...
public final class AgentPremain {
    ...
    static {
        ...
        try {
            ...
            objM613constructorimpl = Result.m613constructorimpl(property != null ? Boolean.valueOf(Boolean.parseBoolean(property)) : null);
        } catch (Throwable th) {
            Result.Companion companion2 = Result.INSTANCE;
            objM613constructorimpl = Result.m613constructorimpl(ResultKt.createFailure(th));
        }
        Boolean bool = (Boolean) (Result.m619isFailureimpl(objM613constructorimpl) ? null : objM613constructorimpl);
