...
public interface IFSCEventListener extends IInterface {
    void errorOccurred(int i, String str) throws RemoteException;

    void finished(int i) throws RemoteException;

    void operationRequested(int i, String str, byte[] bArr) throws RemoteException;
    ...
    public static abstract class Stub extends Binder implements IFSCEventListener {
        ...
        private static class Proxy implements IFSCEventListener {
            ...
            public void errorOccurred(int i, String str) throws RemoteException {
