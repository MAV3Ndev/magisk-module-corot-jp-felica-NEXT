...
public class AnimatedStateListDrawableCompat extends StateListDrawableCompat implements TintAwareDrawable {
    ...
    /* JADX DEBUG: Method merged with bridge method: cloneConstantState()Landroidx/appcompat/graphics/drawable/DrawableContainerCompat$DrawableContainerState; */
    /* JADX DEBUG: Method merged with bridge method: cloneConstantState()Landroidx/appcompat/graphics/drawable/StateListDrawableCompat$StateListState; */
    ...
    static class AnimatedStateListState extends StateListDrawableCompat.StateListState {
        ...
        void mutate() {
            this.mTransitions = this.mTransitions.m62clone();
            this.mStateIds = this.mStateIds.m63clone();
        }
