...
public class ExtNanacoBalanceReader extends ExtFelicaReader {
    ...
    public MfcAdapterExpert.Asset getBalance(Data[] data) {
        ...
        try {
            ...
            byte[] byteData = getByteData(data[1]);
            ...
            int i = ((b << 3) & 8) + ((b2 >>> 5) & 7);
            asset.date1 = simpleDateFormat.parse((((b >>> 1) & 127) + 2000) + DomExceptionUtils.SEPARATOR + String.format(Locale.US, TimeModel.ZERO_LEADING_NUMBER_FORMAT, Integer.valueOf(i)) + DomExceptionUtils.SEPARATOR + String.format(Locale.US, TimeModel.ZERO_LEADING_NUMBER_FORMAT, Integer.valueOf(b2 & Ascii.US)));
            ...
            int i2 = ((b3 << 3) & 8) + ((b4 >>> 5) & 7);
            asset.date2 = simpleDateFormat.parse((((b3 >>> 1) & 127) + 2000) + DomExceptionUtils.SEPARATOR + String.format(Locale.US, TimeModel.ZERO_LEADING_NUMBER_FORMAT, Integer.valueOf(i2)) + DomExceptionUtils.SEPARATOR + String.format(Locale.US, TimeModel.ZERO_LEADING_NUMBER_FORMAT, Integer.valueOf(b4 & Ascii.US)));
            return asset;
