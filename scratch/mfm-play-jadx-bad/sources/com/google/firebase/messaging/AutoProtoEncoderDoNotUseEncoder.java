...
public final class AutoProtoEncoderDoNotUseEncoder implements Configurator {
    ...
    private static final class MessagingClientEventEncoder implements ObjectEncoder<MessagingClientEvent> {
        ...
        private static final FieldDescriptor MESSAGETYPE_DESCRIPTOR = FieldDescriptor.builder(CloudMessagingWorker.EXT_KEY_MESSAGE_TYPE).withProperty(AtProtobuf.builder().tag(4).build()).build();
        ...
        private static final FieldDescriptor PACKAGENAME_DESCRIPTOR = FieldDescriptor.builder(NotifyClientEventWorker.EXT_KEY_PACKAGE_NAME).withProperty(AtProtobuf.builder().tag(6).build()).build();
