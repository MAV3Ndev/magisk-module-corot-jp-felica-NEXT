...
public class CognitoUser {
    ...
    public void confirmSignUpInBackground(String str, boolean z, GenericHandler genericHandler) {
        confirmSignUpInBackground(str, z, Collections.EMPTY_MAP, genericHandler);
    }

    public void confirmSignUp(String str, boolean z, GenericHandler genericHandler) {
        confirmSignUp(str, z, Collections.EMPTY_MAP, genericHandler);
    }
    ...
    public void resendConfirmationCodeInBackground(VerificationHandler verificationHandler) {
        resendConfirmationCodeInBackground(Collections.EMPTY_MAP, verificationHandler);
    }
    ...
    public void resendConfirmationCode(VerificationHandler verificationHandler) {
        resendConfirmationCode(Collections.EMPTY_MAP, verificationHandler);
    }
    ...
    public void forgotPasswordInBackground(ForgotPasswordHandler forgotPasswordHandler) {
        forgotPasswordInBackground(Collections.EMPTY_MAP, forgotPasswordHandler);
    }

    public void forgotPassword(ForgotPasswordHandler forgotPasswordHandler) {
        forgotPassword(Collections.EMPTY_MAP, forgotPasswordHandler);
    }
    ...
    public void confirmPasswordInBackground(String str, String str2, ForgotPasswordHandler forgotPasswordHandler) {
        confirmPasswordInBackground(str, str2, Collections.EMPTY_MAP, forgotPasswordHandler);
    }
    ...
    public void confirmPassword(String str, String str2, ForgotPasswordHandler forgotPasswordHandler) {
        confirmPassword(str, str2, Collections.EMPTY_MAP, forgotPasswordHandler);
    }
    ...
    public void getSession(AuthenticationHandler authenticationHandler) {
        getSession(Collections.EMPTY_MAP, authenticationHandler);
    }
    ...
    public Runnable initiateUserAuthentication(AuthenticationDetails authenticationDetails, AuthenticationHandler authenticationHandler, boolean z) {
        return initiateUserAuthentication(Collections.EMPTY_MAP, authenticationDetails, authenticationHandler, z);
    }
    ...
    public Runnable respondToMfaChallenge(String str, RespondToAuthChallengeResult respondToAuthChallengeResult, AuthenticationHandler authenticationHandler, boolean z) {
        return respondToMfaChallenge(Collections.EMPTY_MAP, str, respondToAuthChallengeResult, authenticationHandler, z);
    }
    ...
    public void getAttributeVerificationCodeInBackground(String str, VerificationHandler verificationHandler) {
        getAttributeVerificationCodeInBackground(Collections.EMPTY_MAP, str, verificationHandler);
    }
    ...
    public void getAttributeVerificationCode(String str, VerificationHandler verificationHandler) {
        getAttributeVerificationCode(Collections.EMPTY_MAP, str, verificationHandler);
    }
                ...
                try {
                    ...
                    if (z) {
                        runnable = new Runnable() { // from class: com.amazonaws.mobileconnectors.cognitoidentityprovider.CognitoUser.13.1
                            @Override // java.lang.Runnable
                            public void run() {
                                registerMfaHandler.onVerify(new VerifyMfaContinuation(CognitoUser.this.context, CognitoUser.this.clientId, this, registerMfaHandler, map, true, session, true));
                            }
                        };
                    } else {
                        runnable = new Runnable() { // from class: com.amazonaws.mobileconnectors.cognitoidentityprovider.CognitoUser.13.2
                            @Override // java.lang.Runnable
                            public void run() {
                                registerMfaHandler.onVerify(new VerifyMfaContinuation(CognitoUser.this.context, CognitoUser.this.clientId, this, registerMfaHandler, map, false, session, true));
                            }
                        };
                    }
                } catch (Exception e) {
    ...
    public void associateSoftwareToken(String str, RegisterMfaHandler registerMfaHandler) {
        RegisterMfaHandler registerMfaHandler2;
        Exception exc;
        AssociateSoftwareTokenResult associateSoftwareTokenResultAssociateTotpMfaInternalWithSession;
        boolean z;
        boolean z2;
        String session;
        HashMap map;
        ...
        try {
            ...
            if (!StringUtils.isBlank(str)) {
                try {
                    associateSoftwareTokenResultAssociateTotpMfaInternalWithSession = associateTotpMfaInternalWithSession(str);
                    z = true;
                } catch (Exception e) {
                    exc = e;
                    registerMfaHandler2 = registerMfaHandler;
                    registerMfaHandler2.onFailure(exc);
                }
            } else {
                associateSoftwareTokenResultAssociateTotpMfaInternalWithSession = associateTotpMfaInternalWithTokens(cachedSession);
                z = false;
            }
            z2 = z;
            session = associateSoftwareTokenResultAssociateTotpMfaInternalWithSession.getSession();
            map = new HashMap();
            map.put("type", CognitoServiceConstants.CHLG_TYPE_SOFTWARE_TOKEN_MFA);
            map.put("secretKey", associateSoftwareTokenResultAssociateTotpMfaInternalWithSession.getSecretCode());
            registerMfaHandler2 = registerMfaHandler;
        } catch (Exception e2) {
            e = e2;
            registerMfaHandler2 = registerMfaHandler;
        ...
        try {
            registerMfaHandler2.onVerify(new VerifyMfaContinuation(this.context, this.clientId, this, registerMfaHandler2, map, z2, session, false));
        } catch (Exception e3) {
            e = e3;
            exc = e;
            registerMfaHandler2.onFailure(exc);
    ...
    public void updateAttributesInBackground(CognitoUserAttributes cognitoUserAttributes, UpdateAttributesHandler updateAttributesHandler) {
        updateAttributesInBackground(Collections.EMPTY_MAP, cognitoUserAttributes, updateAttributesHandler);
    }
    ...
    public void updateAttributes(CognitoUserAttributes cognitoUserAttributes, UpdateAttributesHandler updateAttributesHandler) {
        updateAttributes(cognitoUserAttributes, Collections.EMPTY_MAP, updateAttributesHandler);
    }
    ...
    public Runnable respondToChallenge(RespondToAuthChallengeRequest respondToAuthChallengeRequest, AuthenticationHandler authenticationHandler, boolean z) {
        return respondToChallenge(Collections.EMPTY_MAP, respondToAuthChallengeRequest, authenticationHandler, z);
    }
    ...
    */
    public Runnable respondToChallenge(Map<String, String> map, RespondToAuthChallengeRequest respondToAuthChallengeRequest, AuthenticationHandler authenticationHandler, boolean z) {
        final Exception exc;
        final AuthenticationHandler authenticationHandler2;
        final ResourceNotFoundException resourceNotFoundException;
        CognitoUser cognitoUser;
        Map<String, String> map2;
        final AuthenticationHandler authenticationHandler3;
        final boolean z2;
        if (respondToAuthChallengeRequest != null) {
            try {
                ...
                cognitoUser = this;
                map2 = map;
                authenticationHandler3 = authenticationHandler;
                z2 = z;
                if (!resourceNotFoundException.getMessage().contains("Device")) {
                }
            } catch (Exception e2) {
                exc = e2;
                authenticationHandler2 = authenticationHandler;
                return new Runnable() { // from class: com.amazonaws.mobileconnectors.cognitoidentityprovider.CognitoUser.23
                    @Override // java.lang.Runnable
                    public void run() {
                        authenticationHandler2.onFailure(exc);
                    }
                };
            }
        }
        try {
            ...
            map2 = map;
            try {
                return cognitoUser.handleChallenge(map2, this.cognitoIdentityProviderClient.respondToAuthChallenge(respondToAuthChallengeRequest), (AuthenticationDetails) null, authenticationHandler, z);
                ...
                resourceNotFoundException = e;
                if (!resourceNotFoundException.getMessage().contains("Device")) {
                    CognitoDeviceHelper.clearCachedDevice(cognitoUser.usernameInternal, cognitoUser.pool.getUserPoolId(), cognitoUser.context);
                    ...
                    return new Runnable() { // from class: com.amazonaws.mobileconnectors.cognitoidentityprovider.CognitoUser.21
                        @Override // java.lang.Runnable
                        public void run() {
                            AuthenticationContinuation authenticationContinuation = new AuthenticationContinuation(this, CognitoUser.this.context, z2, authenticationHandler3);
                            authenticationContinuation.setClientMetaData(map3);
                            authenticationHandler3.getAuthenticationDetails(authenticationContinuation, this.getUserId());
                        }
                    };
                }
                return new Runnable() { // from class: com.amazonaws.mobileconnectors.cognitoidentityprovider.CognitoUser.22
                    @Override // java.lang.Runnable
                    public void run() {
                        authenticationHandler3.onFailure(resourceNotFoundException);
                    }
                };
            } catch (Exception e4) {
                e = e4;
            ...
            public void run() {
                ...
                try {
                    ...
                    if (!CognitoServiceConstants.CHLG_TYPE_USER_PASSWORD_VERIFIER.equals(initiateAuthResultInitiateAuth.getChallengeName())) {
                        CognitoUser.this.handleChallenge((Map<String, String>) map, initiateAuthResultInitiateAuth, authenticationDetails, authenticationHandler, z).run();
                    } else {
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public Runnable handleChallenge(Map<String, String> map, InitiateAuthResult initiateAuthResult, AuthenticationDetails authenticationDetails, AuthenticationHandler authenticationHandler, boolean z) {
        final AuthenticationHandler authenticationHandler2;
        RespondToAuthChallengeResult respondToAuthChallengeResult;
        try {
            respondToAuthChallengeResult = new RespondToAuthChallengeResult();
        ...
        try {
            return handleChallenge(map, respondToAuthChallengeResult, authenticationDetails, authenticationHandler2, z);
        } catch (Exception e2) {
            e = e2;
    ...
    public RespondToAuthChallengeRequest userSrpAuthRequest(Map<String, String> map, Map<String, String> map2, String str, String str2, String str3, AuthenticationHelper authenticationHelper) {
        ...
        try {
            ...
            mac.update(this.pool.getUserPoolId().split(CacheUtil.DELIMITER, 2)[1].getBytes(StringUtils.UTF8));
            ...
            byte[] bArrDoFinal = mac.doFinal(str9.getBytes(StringUtils.UTF8));
            HashMap map3 = new HashMap();
            map3.put(CognitoServiceConstants.CHLG_RESP_PASSWORD_CLAIM_SECRET_BLOCK, str8);
            map3.put(CognitoServiceConstants.CHLG_RESP_PASSWORD_CLAIM_SIGNATURE, new String(Base64.encode(bArrDoFinal), StringUtils.UTF8));
            map3.put(CognitoServiceConstants.CHLG_RESP_TIMESTAMP, str9);
    ...
    public RespondToAuthChallengeRequest deviceSrpAuthRequest(Map<String, String> map, RespondToAuthChallengeResult respondToAuthChallengeResult, String str, String str2, AuthenticationHelper authenticationHelper) {
        ...
        try {
            ...
            byte[] bArrDoFinal = mac.doFinal(str3.getBytes(StringUtils.UTF8));
            this.secretHash = CognitoSecretHash.getSecretHash(this.usernameInternal, this.clientId, this.clientSecret);
            HashMap map2 = new HashMap();
            ...
            map2.put(CognitoServiceConstants.CHLG_RESP_PASSWORD_CLAIM_SIGNATURE, new String(Base64.encode(bArrDoFinal), StringUtils.UTF8));
    ...
    private static class AuthenticationHelper {
        ...
        public AuthenticationHelper(String str) {
            ...
            if (str.contains(CacheUtil.DELIMITER)) {
                this.poolName = str.split(CacheUtil.DELIMITER, 2)[1];
            } else {
                this.poolName = str;
            }
        }
        ...
        public byte[] getPasswordAuthenticationKey(String str, String str2, BigInteger bigInteger, BigInteger bigInteger2) {
            ...
            byte[] bArrDigest = messageDigest.digest(str2.getBytes(StringUtils.UTF8));
            messageDigest.reset();
