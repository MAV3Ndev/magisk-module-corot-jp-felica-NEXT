...
public class HoleGroup extends ConstraintLayout {
    ...
    public HoleGroup(Context context, AttributeSet attributeSet) {
    ...
    public HoleGroup(Context context, AttributeSet attributeSet, int i) {
    ...
    public void onViewAdded(View view) {
        ...
        if (view instanceof HoleView) {
            this.views.add((HoleView) view);
        }
    }
