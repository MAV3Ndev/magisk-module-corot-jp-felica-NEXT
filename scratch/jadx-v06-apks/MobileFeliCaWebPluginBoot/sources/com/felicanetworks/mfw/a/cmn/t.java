...
public class t {
    ...
    public t(Context context, DialogInterface dialogInterface, Window window) {
        this.f176a = context;
        this.b = dialogInterface;
        this.c = window;
        this.F = new s(dialogInterface);
    }
    ...
    private void D() {
        ...
        View view = null;
        TypedArray typedArrayObtainStyledAttributes = this.f176a.obtainStyledAttributes(null, com.felicanetworks.mfw.a.boot.q.CustomAlertDialog, R.attr.alertDialogStyle, 0);
