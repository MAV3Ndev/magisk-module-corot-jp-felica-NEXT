...
final class SchemaManager extends SQLiteOpenHelper {
    ...
    static {
        $$Lambda$SchemaManager$GnoKRnczwOa6Fk7ZCPhACcfPzQ __lambda_schemamanager_gnokrnczwoa6fk7zcphaccfpzq = new Migration() { // from class: com.google.android.datatransport.runtime.scheduling.persistence.-$$Lambda$SchemaManager$GnoKRnczwOa6F-k7ZCPhACcfPzQ
            @Override // com.google.android.datatransport.runtime.scheduling.persistence.SchemaManager.Migration
            public final void upgrade(SQLiteDatabase sQLiteDatabase) {
                SchemaManager.lambda$static$3(sQLiteDatabase);
            }
        };
        MIGRATE_TO_V4 = __lambda_schemamanager_gnokrnczwoa6fk7zcphaccfpzq;
        INCREMENTAL_MIGRATIONS = Arrays.asList(MIGRATE_TO_V1, MIGRATE_TO_V2, MIGRATE_TO_V3, __lambda_schemamanager_gnokrnczwoa6fk7zcphaccfpzq);
    }
