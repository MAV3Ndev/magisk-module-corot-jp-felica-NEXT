...
public interface ILinkageDataListEventCallback extends IInterface {
    ...
    public static abstract class Stub extends Binder implements ILinkageDataListEventCallback {
        private static final String DESCRIPTOR = "com.felicanetworks.mfc.mfi.ILinkageDataListEventCallback";
        ...
        public static ILinkageDataListEventCallback asInterface(IBinder iBinder) {
            if (iBinder == null) {
                return null;
            }
        ...
        public boolean onTransact(int i, Parcel parcel, Parcel parcel2, int i2) throws RemoteException {
            if (i == 1) {
                ...
                onSuccess(parcel.createStringArray());
                return true;
            }
            if (i == 2) {
                parcel.enforceInterface(DESCRIPTOR);
