...
public class CardDialogActivity extends FragmentActivity {
    ...
    private void init(Intent intent) {
        ...
        if (intent != null && intent.getIntExtra("tis_pattern", 0) != 0) {
            ...
            boolean booleanExtra = intent.getBooleanExtra("tis_ShowOnLock", false);
            LogMgr.log(6, "001 pattern = " + intExtra + ", serviceId = " + stringExtra + ", amount = " + intExtra2 + ", balance = " + intExtra3);
            LogMgr.log(6, "002 create card dialog");
            this.mFragment.setupDialog(this.mActivity, intExtra, stringExtra, intExtra2, intExtra3, stringExtra2);
            if (booleanExtra) {
