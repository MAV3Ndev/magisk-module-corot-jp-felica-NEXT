...
public final class Profiling {
    ...
    static final class AnonymousClass1 extends SuspendLambda implements Function2<ProducerScope<? super ProfilingResult>, Continuation<? super Unit>, Object> {
        ...
        public final Object invokeSuspend(Object obj) throws Throwable {
            ...
            if (i == 0) {
                ...
                final ProfilingManager profilingManagerM107m = Profiling$$ExternalSyntheticApiModelOutline0.m107m(this.$context.getSystemService(Profiling$$ExternalSyntheticApiModelOutline0.m126m$1()));
                profilingManagerM107m.registerForAllProfilingResults(new Executor() { // from class: androidx.core.os.Profiling$registerForAllProfilingResults$1$$ExternalSyntheticLambda1
                    /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 0 */
                ...
                if (ProduceKt.awaitClose(producerScope, new Function0<Unit>() { // from class: androidx.core.os.Profiling.registerForAllProfilingResults.1.2
                    ...
                    public final void invoke2() {
                        profilingManagerM107m.unregisterForAllProfilingResults(consumer);
                    }
        ...
        public static final void invokeSuspend$lambda$0(ProducerScope producerScope, ProfilingResult result) {
            ...
            producerScope.mo2169trySendJP2dKIU(result);
        }
    }
    ...
    public static final void registerForAllProfilingResults(Context context, Executor executor, Consumer<ProfilingResult> listener) {
        ...
        Profiling$$ExternalSyntheticApiModelOutline0.m107m(context.getSystemService(Profiling$$ExternalSyntheticApiModelOutline0.m126m$1())).registerForAllProfilingResults(executor, listener);
    }

    public static final void unregisterForAllProfilingResults(Context context, Consumer<ProfilingResult> listener) {
        Intrinsics.checkNotNullParameter(context, "context");
        Intrinsics.checkNotNullParameter(listener, "listener");
        Profiling$$ExternalSyntheticApiModelOutline0.m107m(context.getSystemService(Profiling$$ExternalSyntheticApiModelOutline0.m126m$1())).unregisterForAllProfilingResults(listener);
    }
    ...
    public static final void requestProfiling(Context context, ProfilingRequest profilingRequest, Executor executor, Consumer<ProfilingResult> consumer) {
        ...
        Profiling$$ExternalSyntheticApiModelOutline0.m107m(context.getSystemService(Profiling$$ExternalSyntheticApiModelOutline0.m126m$1())).requestProfiling(profilingRequest.getProfilingType(), profilingRequest.getParams(), profilingRequest.getTag(), profilingRequest.getCancellationSignal(), executor, consumer);
    }
}
