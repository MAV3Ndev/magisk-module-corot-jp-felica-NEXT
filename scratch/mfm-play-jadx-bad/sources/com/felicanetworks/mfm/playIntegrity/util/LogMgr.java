...
public class LogMgr {
    ...
    private static final String PERFORMANCE_TAG_MODULE = "PI-Agent";
    public static final int PKG = 4;
    private static final String P_CMP = "[PI-Agent]";
            ...
            if ((obj2 instanceof byte[]) || (obj2 instanceof int[])) {
                for (int i3 = 0; i3 < j; i3++) {
                    ...
                    if (obj3 instanceof byte[]) {
                        sNew_args[i3] = ByteArray2String((byte[]) obj3);
                    } else if (obj3 instanceof int[]) {
                        sNew_args[i3] = IntegerArray2String((int[]) obj3);
                    } else {
                        sNew_args[i3] = obj3;
                    }
                }
