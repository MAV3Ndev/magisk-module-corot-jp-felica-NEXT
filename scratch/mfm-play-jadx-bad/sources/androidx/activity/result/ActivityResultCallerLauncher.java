...
public final class ActivityResultCallerLauncher<I, O> extends ActivityResultLauncher<Unit> {
    ...
    /* JADX DEBUG: Method merged with bridge method: launch(Ljava/lang/Object;Landroidx/core/app/ActivityOptionsCompat;)V */
    ...
    /* JADX DEBUG: Return type fixed from 'androidx.activity.result.contract.ActivityResultContract<kotlin.Unit, O>' to match base method */
    @Override // androidx.activity.result.ActivityResultLauncher
