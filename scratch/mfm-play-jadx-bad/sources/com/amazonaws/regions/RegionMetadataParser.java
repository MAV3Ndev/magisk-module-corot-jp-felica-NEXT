...
public class RegionMetadataParser {
    ...
    private static void addRegionEndpoint(Region region, Element element, boolean z) {
        ...
        region.getHttpSupport().put(childElementValue, Boolean.valueOf(CredentialEntry.TRUE_STRING.equals(childElementValue3)));
        region.getHttpsSupport().put(childElementValue, Boolean.valueOf(CredentialEntry.TRUE_STRING.equals(childElementValue4)));
    }
