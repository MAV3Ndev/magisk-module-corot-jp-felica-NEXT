...
public final class IntIntPair {
    ...
    /* JADX DEBUG: Can't inline method, not implemented redirect type for insn: 0x0002: CONSTRUCTOR (r1v0 long) A[MD:(long):void (m)] call: androidx.collection.IntIntPair.<init>(long):void type: CONSTRUCTOR */
    ...
    /* JADX DEBUG: Method not inlined, still used in: [androidx.collection.IntIntPair.box-impl(long):androidx.collection.IntIntPair] */
    ...
    public static long m53constructorimpl(int i, int i2) {
        return m54constructorimpl((((long) i2) & 4294967295L) | (((long) i) << 32));
    }
