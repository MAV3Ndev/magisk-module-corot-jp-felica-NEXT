    ...
    */
    public static final <T> void resumeCancellableWith(Continuation<? super T> continuation, Object obj, Function1<? super Throwable, Unit> function1) {
        ...
        if (dispatchedContinuation.dispatcher.isDispatchNeeded(dispatchedContinuation.getContext())) {
            ...
            dispatchedContinuation.dispatcher.mo2225dispatch(dispatchedContinuation.getContext(), dispatchedContinuation);
            return;
        }
        ...
        if (job != null && !job.isActive()) {
            ...
            dispatchedContinuation.resumeWith(Result.m613constructorimpl(ResultKt.createFailure(cancellationException)));
        } else {
    ...
    /* JADX DEBUG: Another duplicated slice has different insns count: {[CONST]}, finally: {[CONST, INVOKE, MOVE_EXCEPTION, INVOKE, MOVE_EXCEPTION] complete} */
