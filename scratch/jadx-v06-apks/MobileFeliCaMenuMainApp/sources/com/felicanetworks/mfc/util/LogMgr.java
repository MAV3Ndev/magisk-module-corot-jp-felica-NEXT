...
public class LogMgr {
    ...
    public static void performanceIn(String str, String str2, String str3, String str4, byte[] bArr) {
    }

    public static void performanceOut(String str, String str2, String str3, String str4) {
    }

    public static void performanceOut(String str, String str2, String str3, String str4, byte[] bArr) {
    }
    ...
    */
    static java.lang.String format(java.lang.String r12, java.lang.Object[] r13, long r14) {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: com.felicanetworks.mfc.util.LogMgr.format(java.lang.String, java.lang.Object[], long):java.lang.String");
    }
    ...
    public static void performanceIn(String str, String str2, String str3) {
        performanceIn(str, str2, str3, (String) null);
    }

    public static void performanceOut(String str, String str2, String str3) {
        performanceOut(str, str2, str3, (String) null);
    }

    public static void exLogMfiClientException(MfiClientExternalLogConst.MficApi mficApi, FelicaException felicaException) {
        exLog(5, String.format(Locale.US, MfiClientExternalLogConst.MSG_FORMAT_FELICA_EXCEPTION, mficApi.msg, MfiClientException.class.getSimpleName(), Integer.valueOf(felicaException.getID()), Integer.valueOf(felicaException.getType())));
    }

    public static void exLogMfiClientException(MfiClientExternalLogConst.MficApi mficApi, int i, int i2) {
        exLog(5, String.format(Locale.US, MfiClientExternalLogConst.MSG_FORMAT_FELICA_EXCEPTION, mficApi.msg, MfiClientException.class.getSimpleName(), Integer.valueOf(i), Integer.valueOf(i2)));
    }

    public static void exLogException(MfiClientExternalLogConst.MficApi mficApi, Exception exc) {
        exLog(5, String.format(Locale.US, MfiClientExternalLogConst.MSG_FORMAT_OTHER_EXCEPTION, mficApi.msg, exc.getClass().getSimpleName()));
    }

    public static void exLogInfo(MfiClientExternalLogConst.Keys keys, String str) {
        exLog(4, keys.getKeyHash() + str);
    }

    public static void exLogOnError(MfiClientExternalLogConst.MficApi mficApi, int i) {
        exLog(5, String.format(Locale.US, MfiClientExternalLogConst.MSG_FORMAT_ON_ERROR, mficApi.msg, Integer.valueOf(i)));
    }

    public static void exLogOnRequestActivity(MfiClientExternalLogConst.MficApi mficApi) {
        exLog(4, String.format(Locale.US, MfiClientExternalLogConst.MSG_FORMAT_ON_REQUEST_ACTIVITY, mficApi.msg));
    }

    public static void exLogOnActivityResult(int i) {
        exLog(5, String.format(Locale.US, MfiClientExternalLogConst.MSG_FORMAT_ON_ACTIVITY_RESULT, Integer.valueOf(i)));
    }

    private static void exLog(int i, String str) {
        String str2;
        if (i == 4) {
            str2 = MfiClientExternalLogConst.TAG_INFO;
        } else {
            i = 5;
            str2 = MfiClientExternalLogConst.TAG_WARN;
        }
