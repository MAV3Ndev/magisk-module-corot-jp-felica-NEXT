...
public class SchedulerCoroutineDispatcher extends ExecutorCoroutineDispatcher {
  ...
  (wrap:int:?: TERNARY null = ((wrap:int:0x0000: ARITH (r6v0 int) & (1 int) A[WRAPPED]) != (0 int)) ? (wrap:int:0x0004: SGET  A[WRAPPED] (LINE:97) kotlinx.coroutines.scheduling.TasksKt.CORE_POOL_SIZE int) : (r1v0 int))
  (wrap:int:?: TERNARY null = ((wrap:int:0x0006: ARITH (r6v0 int) & (2 int) A[WRAPPED]) != (0 int)) ? (wrap:int:0x000a: SGET  A[WRAPPED] (LINE:98) kotlinx.coroutines.scheduling.TasksKt.MAX_POOL_SIZE int) : (r2v0 int))
  (wrap:long:?: TERNARY null = ((wrap:int:0x000c: ARITH (r6v0 int) & (4 int) A[WRAPPED]) != (0 int)) ? (wrap:long:0x0010: SGET  A[WRAPPED] (LINE:99) kotlinx.coroutines.scheduling.TasksKt.IDLE_WORKER_KEEP_ALIVE_NS long) : (r3v0 long))
  (wrap:java.lang.String:?: TERNARY null = ((wrap:int:0x0012: ARITH (r6v0 int) & (8 int) A[WRAPPED]) != (0 int)) ? ("CoroutineScheduler") : (r5v0 java.lang.String))
 A[MD:(int, int, long, java.lang.String):void (m)] (LINE:96) call: kotlinx.coroutines.scheduling.SchedulerCoroutineDispatcher.<init>(int, int, long, java.lang.String):void type: THIS */
