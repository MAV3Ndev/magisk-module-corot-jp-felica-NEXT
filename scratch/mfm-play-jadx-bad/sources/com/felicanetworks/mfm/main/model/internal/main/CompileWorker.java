...
public class CompileWorker extends Thread {
    ...
    private boolean _isSimCacheUpdate;
    ...
    CompileWorker(ModelContext context, boolean isCheckNow, boolean isSimCacheUpdate, Listener listener) {
        this._context = context;
        this._isCheckNow = isCheckNow;
        this._isSimCacheUpdate = isSimCacheUpdate;
        this._listener = listener;
        this._db = context.getOpenedDatabaseExpert();
        this._pe = new PackageExpert(this._context);
    }

    CompileWorker(ModelContext context, boolean isCheckNow, Listener listener) {
        this._context = context;
        this._isCheckNow = isCheckNow;
        this._listener = listener;
        this._db = context.getOpenedDatabaseExpert();
    ...
    public void run() {
        try {
            try {
                try {
                    ...
                    while (it5.hasNext()) {
                        ...
                        mfcParallelWorker = mfcParallelWorker;
                    }
                    MfcParallelWorker mfcParallelWorker2 = mfcParallelWorker;
                    ...
                    arrayList10.addAll(areaIds);
                    arrayList10.addAll(appIds);
                    arrayList10.addAll(multiIds);
                    if (mfcParallelWorker2._useCache != packageParallelWorker._useCache) {
                        this._listener.error(new ModelErrorInfo(ModelErrorInfo.Type.DB_CACHE_ERROR, new MfmException(CompileWorker.class, 2)));
                    } else {
                        this._listener.completed(new CentralFunc.CompiledResult(listSearchArea, listSearchApp, listSearchSas, arrayList8, arrayList9, arrayList4, arrayList5, service), checkCompiledState(service, arrayList10, warnings, mfcParallelWorker2._useCache));
                    }
            ...
            if (e4.getIndex() == DatabaseExpert.ERR_INDEX_CACHE_AREA || e4.getIndex() == DatabaseExpert.ERR_INDEX_CACHE_SAS || e4.getIndex() == DatabaseExpert.ERR_INDEX_CACHE_APP || e4.getIndex() == DatabaseExpert.ERR_INDEX_CACHE_ASSET) {
                if (e4.getExtra() == DatabaseExpert.EX_ERR_INFO_CACHE) {
                    this._listener.error(new ModelErrorInfo(ModelErrorInfo.Type.DB_CACHE_ERROR, e4));
                    return;
                } else {
    ...
    protected CentralFunc.CompiledState checkCompiledState(List<Service> allServices, List<DatabaseExpert.ServiceId> allIds, Warnings warnings, boolean useCache) {
        boolean z = false;
        ...
        return new CentralFunc.CompiledState(warnings.getFelicaState(), warnings.getNetworkState(), false, z, warnings.isLackEmoneyInfo, useCache);
    }
    ...
    protected class MfcParallelWorker extends ParallelWorker {
        ...
        public void run() {
            try {
                ...
                if (!CompileWorker.this._isSimCacheUpdate) {
                    boolean cacheChipAreaListSetting = CompileWorker.this._db.getCacheChipAreaListSetting();
                    boolean cacheChipSasListSetting = CompileWorker.this._db.getCacheChipSasListSetting();
                    if (cacheChipAreaListSetting && cacheChipSasListSetting) {
                        this._areas = CompileWorker.this._db.getCacheChipAreaList();
                        this._sass = CompileWorker.this._db.getCacheChipSasList();
                        this._useCache = true;
                    } else if (cacheChipAreaListSetting || cacheChipSasListSetting) {
                        throw new DatabaseException(getClass(), 257, "Cache Inconsistency!!!");
                    }
                }
                this._mfc.mfcStart();
                this._areas = this._mfc.getAreaList();
                this._sass = this._mfc.getSasList();
                CompileWorker.this._db.setCacheChipAreaAndSasList(this._areas, this._sass);
            } finally {
    ...
    protected class PackageParallelWorker extends ParallelWorker {
        ...
        public void run() {
            try {
                try {
                    try {
                        super.checkInterrupted();
                        this._useCache = false;
                        if (!CompileWorker.this._isSimCacheUpdate && CompileWorker.this._db.getCacheInstalledAppListSetting()) {
                            this._apps = CompileWorker.this._db.getCacheInstalledAppList();
                            this._useCache = true;
                        } else {
                            this._apps = this._pkg.getInstalledApps();
                            CompileWorker.this._db.setCacheInstalledAppList(this._apps);
                        }
                    } catch (DatabaseException e) {
                        e = e;
                        this._exception = e;
            ...
            } catch (PackageExpertException e2) {
                e = e2;
                this._exception = e;
                this._apps = null;
            }
    ...
    public class MainParallelWorker extends ParallelWorker {
        ...
        @Override // com.felicanetworks.mfm.main.model.internal.main.CompileWorker.ParallelWorker
        public /* bridge */ /* synthetic */ void throwException() throws Exception {
            super.throwException();
        }

        @Override // com.felicanetworks.mfm.main.model.internal.main.CompileWorker.ParallelWorker, java.lang.Thread.UncaughtExceptionHandler
        ...
        public void run() {
            ...
            try {
                try {
                    ...
                    try {
                        super.checkInterrupted();
                        ServiceProtocol.Result resultConnectSidProtocol = arrayList3.isEmpty() ? null : connectSidProtocol(CompileWorker.this._context.getNetworkExpert(), this._acb, this._acv, arrayList3);
                        ...
                        if (this._exception == null && (!arrayList.isEmpty() || !arrayList5.isEmpty())) {
                            CompileWorker.this._db.setServices(convertServices(arrayList), arrayList5);
                        }
                    ...
                    for (Service service4 : service3) {
                        ...
                        if (serviceId.equals(FeliCaParams.SERVICE_ID_QP) && !service4.isType1()) {
                            Map<String, Object> specificColumnData = CompileWorker.this._db.getSpecificColumnData(serviceId, Collections.singletonList("ServiceType"));
                            ...
                            CompileWorker.this._db.updateSpecificColumnData(serviceId, map);
        ...
        protected UcTerms getUcTerms(DatabaseExpert.IdsSettings setting) {
            ...
            if (setting != null) {
                if (CompileWorker.INITILAL_DATE_DATA.equals(setting.lastUpdate)) {
                    ucTerms.isNeed = true;
        ...
        protected ServiceProtocol.Result connectSidProtocol(NetworkExpert net, String acb, String acv, List<BasicElement> requests) throws NetworkExpertException {
            ...
            Collections.sort(requests, new Comparator<BasicElement>() { // from class: com.felicanetworks.mfm.main.model.internal.main.CompileWorker.MainParallelWorker.1
            ...
            if (arrayList.size() > 0) {
                try {
                    return serviceProtocol.parse(net.connect(serviceProtocol.create(new ServiceProtocol.Parameter(Settings.idm(), acb, acv, arrayList)), new NetworkExpert.NetworkAccessListener() { // from class: com.felicanetworks.mfm.main.model.internal.main.CompileWorker.MainParallelWorker.2
