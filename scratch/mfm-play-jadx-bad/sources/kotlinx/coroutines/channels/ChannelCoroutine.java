...
public class ChannelCoroutine<E> extends AbstractCoroutine<Unit> implements Channel<E> {
    ...
    public Object mo2173receiveCatchingJP2dKIU(Continuation<? super ChannelResult<? extends E>> continuation) {
        Object obj = this._channel.mo2173receiveCatchingJP2dKIU(continuation);
    ...
    public Object mo2174tryReceivePtdJZtk() {
        return this._channel.mo2174tryReceivePtdJZtk();
    }

    @Override // kotlinx.coroutines.channels.SendChannel
    /* JADX INFO: renamed from: trySend-JP2dKIU */
    public Object mo2169trySendJP2dKIU(E element) {
        return this._channel.mo2169trySendJP2dKIU(element);
    }
